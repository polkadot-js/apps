...
`,lt=g.memo((function({className:e}){const n=(0,$.TH)(),{t}=Yn(),{api:i,isApiConnected:o,isApiReady:a,isDevelopment:s}=(0,R.h)(),{queueAction:l}=(0,Ln.L)(),{Component:c,display:{needsApi:d,needsApiCheck:p,needsApiInstances:u},icon:m,name:h,text:f}=(0,g.useMemo)((()=>{const e=n.pathname.slice(1)||"";return Hn(t).find((n=>n&&e.startsWith(n.name)&&(s||!n.display.isDevelopment)))||at}),[s,n,t]),x=(0,g.useMemo)((()=>d?a&&o?Gn(i,d,u,p):null:[]),[i,o,a,d,p,u]);return(0,r.jsx)(st,{className:e,children:x?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(g.Suspense,{fallback:"...",children:(0,r.jsx)(I.SV,{trigger:h,children:(0,r.jsx)(Jn.m.Provider,{value:{icon:m,text:f},children:x.length?(0,r.jsx)(Qn,{basePath:`/${h}`,location:n,missingApis:x,onStatusChange:l}):(0,r.jsx)(c,{basePath:`/${h}`,location:n,onStatusChange:l})})})}),(0,r.jsx)(ot,{})]}):(0,r.jsx)("div",{className:"connecting",children:(0,r.jsx)(I.$j,{label:t("Initializing connection")})})})}));var ct=t(41411),dt=t(38894),pt=t(12176),ut=t(95689),mt=t(68058),gt=t(10072),ht=t(70676);const ft=(0,I.zo)(I.ZD)`
  padding: 0.25rem;
  text-align: right;
...
`,xt=g.memo((function({apiUrl:e,className:n,label:t,setApiUrl:i,url:o}){const a=(0,g.useCallback)((()=>i(o)),[i,o]);return(0,r.jsx)(ft,{className:n,isRadio:!0,label:t,onChange:a,value:e===o})})),vt=I.zo.div`
...
`,yt=g.memo((function({apiUrl:e,className:n="",isFavorite:t,setApiUrl:i,toggleFavoriteChain:o,value:{isChild:a,isRelay:s,isUnreachable:l,name:c,nameRelay:d,paraId:p,providers:u,ui:m}}){const{t:h}=Yn(),f=(0,g.useMemo)((()=>u.some((({url:n})=>n===e))),[e,u]),x=(0,g.useCallback)((()=>{const e=u.filter((({url:e})=>!e.startsWith("light://")));return i(c,e[Math.floor(Math.random()*e.length)].url)}),[c,u,i]),v=(0,g.useCallback)((e=>i(c,e)),[c,i]),y=(0,g.useCallback)((e=>{e.preventDefault(),e.stopPropagation(),o({chainName:c,paraId:p,relay:d})}),[c,p,d,o]);return(0,r.jsxs)(vt,{className:`${n}${f?" isSelected highlight--border":""}${l?" isUnreachable":""}`,children:[(0,r.jsxs)("div",{className:"markFavoriteSection"+(a?" isChild":""),onClick:l?void 0:x,children:[(0,r.jsxs)("div",{className:"endpointSection",children:[(0,r.jsx)(I.Mj,{className:"endpointIcon",isInline:!0,logo:m.logo||"empty",withoutHl:!0}),(0,r.jsxs)("div",{className:"endpointValue",children:[(0,r.jsx)("div",{children:c}),f&&(s||!!p)&&(0,r.jsx)("div",{className:"endpointExtra",children:s?h("Relay chain"):h(p&&p<1e3?"{{relay}} System":p&&p<2e3?"{{relay}} Common":"{{relay}} Parachain",{replace:{relay:d}})})]})]}),(0,r.jsx)(I.JO,{className:t?"isFavorite":"",icon:"star",onClick:y})]}),f&&u.map((({name:n,url:t})=>(0,r.jsx)(xt,{apiUrl:e,label:n,setApiUrl:v,url:t},t)))]})})),kt="polkadot-app-favorite-chains",bt=()=>{try{const e=localStorage.getItem(kt);if(!e)return{};const n=JSON.parse(e);if("object"!=typeof n||null===n||Array.isArray(n))throw new Error("Invalid favorite chains format");const t={};for(const[e,r]of Object.entries(n)){if(!Array.isArray(r))throw new Error(`Invalid value for key "${e}": not an array`);if(!r.every((e=>"object"==typeof e&&null!==e&&"string"==typeof e.relay&&"number"==typeof e.paraId)))throw new Error(`Invalid entries under key "${e}"`);t[e]=r}return t}catch(e){return console.error("Failed to parse favorite chains:",e),localStorage.removeItem(kt),{}}},wt=(e,n)=>{try{const t=n.chainName,r={paraId:n.paraId??-1,relay:n.relay??"Unknown"},i=e[t];return!!Array.isArray(i)&&i.some((e=>e.relay===r.relay&&e.paraId===r.paraId))}catch(e){return console.error("Failed to check favorite chain:",e),!1}},Ct=I.zo.div`
  .groupHeader {
    border-radius: 0.25rem;
    cursor: pointer;
    line-height: 1;
...
`,At=g.memo((function({affinities:e,apiUrl:n,children:t,className:i="",favoriteChains:o,index:a,isSelected:s,setApiUrl:l,setGroup:c,toggleFavoriteChain:d,value:{header:p,isSpaced:u,networks:m}}){const h=(0,g.useCallback)((()=>c(s?-1:a)),[a,s,c]),f=(0,g.useMemo)((()=>m.filter((({isUnreachable:e})=>!e))),[m]);return p?.toString().includes("Favorite")&&0===Object.keys(o).length?(0,r.jsx)(r.Fragment,{}):(0,r.jsxs)(Ct,{className:`${i}${s?" isSelected":""}`,children:[(0,r.jsxs)("div",{className:"groupHeader"+(u?" isSpaced":""),onClick:h,children:[(0,r.jsx)(I.JO,{icon:s?"caret-up":"caret-down"}),p]}),s&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("div",{className:"groupNetworks",children:f.map(((t,i)=>(0,r.jsx)(yt,{affinity:e[t.name],apiUrl:n,isFavorite:wt(o,{chainName:t.name,paraId:t.paraId,relay:t.nameRelay}),setApiUrl:l,toggleFavoriteChain:d,value:t},i)))}),t]})]})})),jt="network:affinities";function It(e){const n=bt();let t=-1;return e.reduce(((e,r)=>{if(r.isHeader){const n="string"==typeof r.text&&r.text.includes("Favorite chains");e.push({header:r.text,isDevelopment:r.isDevelopment,isSpaced:r.isSpaced,networks:[]}),n&&(t=e.length-1)}else{const i=e[e.length-1],o={isLightClient:r.isLightClient,name:r.textBy,url:r.value};if(wt(n,{chainName:r.text?.toString()??"",paraId:r.paraId,relay:r.textRelay?.toString()})&&-1!==t&&!r.isUnreachable){const n=e[t],i=n.networks[n.networks.length-1];i&&i.name===r.text&&i.nameRelay===r.textRelay&&i.paraId===r.paraId?i.providers.push(o):n.networks.push({isChild:r.isChild,isRelay:!!r.genesisHash,name:r.text,nameRelay:r.textRelay,paraId:r.paraId,providers:[o],ui:r.ui})}i.networks[i.networks.length-1]&&r.text===i.networks[i.networks.length-1].name?i.networks[i.networks.length-1].providers.push(o):r.isUnreachable||i.networks.push({isChild:r.isChild,isRelay:!!r.genesisHash,name:r.text,nameRelay:r.textRelay,paraId:r.paraId,providers:[o],ui:r.ui})}return e}),[])}function Nt(){try{const e=localStorage.getItem(gt.ie);if(e)return JSON.parse(e)}catch(e){console.error(e)}return[]}function St(e,n){let t=n.findIndex((({networks:n})=>n.some((({providers:n})=>n.some((({url:n})=>n===e))))));return-1===t&&(t=n.findIndex((({isDevelopment:e})=>e))),{apiUrl:e,groupIndex:t,hasUrlChanged:p.X.get().apiUrl!==e,isUrlValid:(r=e,r.length>=7&&(r.startsWith("ws://")||r.startsWith("wss://")||r.startsWith("light://")))};var r}const Rt=(0,I.zo)(I.YE)`
...
`,Zt=g.memo((function({className:e="",offset:n,onClose:t}){const{t:i}=Yn(),o=(0,c.Rf)(i),{isLocalFork:a}=(0,R.h)(),[s,d]=(0,g.useState)((()=>bt())),[u,m]=(0,g.useState)((()=>It(o))),[{apiUrl:h,groupIndex:f,hasUrlChanged:x,isUrlValid:v},y]=(0,g.useState)((()=>St(p.X.get().apiUrl,u))),[k,b]=(0,g.useState)((()=>Nt())),[w,C]=(0,g.useState)((()=>function(e){return Object.entries(l().get(jt)||{}).filter((([n,t])=>e.some((({networks:e})=>e.some((({name:e,providers:r})=>e===n&&r.some((({url:e})=>e===t)))))))).reduce(((e,[n,t])=>({...e,[n]:t})),{})}(u))),A=(0,g.useRef)(null),j=(0,g.useMemo)((()=>{let e=!1;return o.some((n=>n.value===h&&(e=!0,!0))),e}),[h,o]),N=(0,g.useMemo)((()=>{let e=!1;return k.some((n=>n===h&&(e=!0,!0))),e}),[h,k]),S=(0,g.useCallback)((e=>y((n=>({...n,groupIndex:e})))),[]),Z=(0,g.useCallback)((e=>{(e=>{try{const n=e.chainName,t={paraId:e.paraId??-1,relay:e.relay??"Unknown"},r=bt(),i=r[n]??[];let o;o=i.some((e=>e.relay===t.relay&&e.paraId===t.paraId))?i.filter((e=>e.relay!==t.relay||e.paraId!==t.paraId)):[...i,t];const a={...r};0===o.length?delete a[n]:a[n]=o,localStorage.setItem(kt,JSON.stringify(a))}catch{}})(e),d(bt()),m(It((0,c.Rf)(i)))}),[i]),$=(0,g.useCallback)((()=>{if(!N)return;const e=k.filter((e=>e!==h));try{localStorage.setItem(gt.ie,JSON.stringify(e)),m(It((0,c.Rf)(i))),b(Nt())}catch(e){console.error(e)}}),[h,N,k,i]),U=(0,g.useCallback)(((e,n)=>{C((t=>{const r={...t,[e]:n};return l().set(jt,r),r})),y(St(n,u))}),[u]),T=(0,g.useCallback)((e=>{(0,ht._)(e)||(e=mt.ZP.toASCII(e)),y(St(e,u))}),[u]),q=(0,g.useCallback)((()=>{l().set("localFork",""),p.X.set({...p.X.get(),apiUrl:h}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(h)}${window.location.hash}`),x||window.location.reload(),t()}),[h,t,x]),z=(0,g.useCallback)((()=>{l().set("localFork",h),p.X.set({...p.X.get(),apiUrl:h}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(h)}${window.location.hash}`),x||window.location.reload(),t()}),[h,t,x]),F=(0,g.useCallback)((()=>{try{localStorage.setItem(gt.ie,JSON.stringify([...k,h])),q()}catch(e){console.error(e)}}),[q,h,k]),E=(0,g.useMemo)((()=>function(e,n,t,r){return e?!n.startsWith("light://")&&!t:!r}(x,h,v,a)),[x,h,v,a]),O=(0,g.useMemo)((()=>function(e,n,t,r){return e?!!n.startsWith("light://")||!t:!!r}(x,h,v,a)),[x,h,v,a]);return(0,r.jsx)(Rt,{buttons:(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(I.zx,{icon:"code-fork",isDisabled:O,label:i("Fork Locally"),onClick:z,tooltip:"fork-locally-btn"}),(0,r.jsx)(I.zx,{icon:"sync",isDisabled:E,label:i("Switch"),onClick:q})]}),className:e,offset:n,onClose:t,position:"left",sidebarRef:A,children:u.map(((e,n)=>(0,r.jsx)(At,{affinities:w,apiUrl:h,favoriteChains:s,index:n,isSelected:f===n,setApiUrl:U,setGroup:S,toggleFavoriteChain:Z,value:e,children:e.isDevelopment&&(0,r.jsxs)("div",{className:"endpointCustomWrapper",children:[(0,r.jsx)(I.II,{className:"endpointCustom",isError:!v,isFull:!0,label:i("custom endpoint"),onChange:T,value:h}),N?(0,r.jsx)(I.zx,{className:"customButton",icon:"trash-alt",onClick:$}):(0,r.jsx)(I.zx,{className:"customButton",icon:"save",isDisabled:!v||j,onClick:F})]})},n)))})})),$t=I.zo.div`
...
`,Ut=g.memo((function({className:e}){const{api:n,isApiReady:t}=(0,R.h)(),i=(0,nt.W7)(t&&n.rpc.state.subscribeRuntimeVersion),{ipnsChain:o}=(0,d.g)(),[a,s]=(0,dt.O)(),l=!o;return(0,r.jsxs)($t,{className:e,children:[(0,r.jsxs)("div",{className:`apps--SideBar-logo-inner${l?" isClickable":""} highlight--color-contrast`,onClick:s,children:[(0,r.jsx)(I.Mj,{}),(0,r.jsxs)("div",{className:"info media--1000",children:[(0,r.jsx)(pt.Z,{className:"chain"}),i&&(0,r.jsxs)("div",{className:"runtimeVersion",children:[i.specName.toString(),"/",i.specVersion.toNumber()]}),(0,r.jsx)(ut.Z,{className:"bestNumber",label:"#"})]}),l&&(0,r.jsx)(I.JO,{className:"dropdown",icon:a?"caret-right":"caret-down"})]}),a&&(0,r.jsx)(Zt,{onClose:s})]})})),Tt=()=>0,qt=I.zo.li`
  cursor: pointer;
  position: relative;
  white-space: nowrap;
...
`,zt=g.memo((function({className:e="",classNameText:n,isLink:t,isToplevel:i,route:{Modal:o,href:a,icon:s,name:l,text:c,useCounter:d=Tt}}){const[p,u]=(0,dt.O)(),m=d();return(0,r.jsxs)(qt,{className:`${e} ui--MenuItem ${m?"withCounter":""} ${t?"isLink":""} ${i?"topLevel highlight--color-contrast":""}`,children:[(0,r.jsxs)("a",{href:o?void 0:a||`#/${l}`,onClick:o?u:void 0,rel:"noopener noreferrer",target:a?"_blank":void 0,children:[(0,r.jsx)(I.JO,{icon:s}),(0,r.jsx)("span",{className:n,children:c}),!!m&&(0,r.jsx)(I.Ct,{color:"white",info:m})]}),o&&p&&(0,r.jsx)(o,{onClose:u})]})})),Ft="rgba(34, 36, 38, 0.12)",Et="5px",Ot=I.zo.li`
  ...
  .groupMenu {
    border-radius: 0.25rem;
    box-shadow: 0 ${Et} ${Et} -${Et} ${Ft}, ${Et} 0 ${Et} -${Et} ${Ft}, -${Et} 0 ${Et} -${Et} ${Ft};
    display: none;
    margin: 0;
    overflow: hidden;
    padding: 0;
...
`,Wt=g.memo((function({className:e="",isActive:n,name:t,routes:i}){return 1===i.length&&"settings"===i[0].group?(0,r.jsx)(zt,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:i[0]}):(0,r.jsxs)(Ot,{className:`${e} ${n?"isActive":""}`,children:[(0,r.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,r.jsx)("span",{className:"smallHide",children:t}),(0,r.jsx)(I.JO,{className:"smallShow",icon:i[0].icon}),(0,r.jsx)(I.JO,{icon:"caret-down"})]}),(0,r.jsx)("ul",{className:"groupMenu",children:i.map((e=>(0,r.jsx)(zt,{route:e},e.name)))})]})}));var Mt=t(54194),Pt=t(39082),Bt=t(52727);const Dt=`apps v${Mt.b.version.replace("-x","")}`,Ht=I.zo.div`
...
`,Lt=g.memo((function({className:e=""}){const{api:n,isApiReady:t}=(0,R.h)();return(0,r.jsxs)(Ht,{className:`${e} media--1400 highlight--color-contrast ui--NodeInfo`,children:[t&&(0,r.jsxs)("div",{className:"node",children:[(0,r.jsx)(Pt.Z,{})," ",(0,r.jsx)(Bt.Z,{label:"v"})]}),(0,r.jsx)("div",{children:n.libraryInfo.replace("@polkadot/","")}),(0,r.jsx)("div",{children:Dt})]})}));const Jt=I.zo.div`
  width: 100%;
  padding: 0;
  z-index: 220;
  position: relative;
...
`,Xt=g.memo((function({className:e=""}){const{t:n}=Yn(),{allAccounts:t,hasAccounts:i}=(0,et.x)(),o=(0,R.h)(),{allowTeleport:a}=(0,ct.M)(),s=(0,nt.W7)(o.isApiReady&&o.api.query.sudo?.key),l=(0,$.TH)(),c=(0,g.useRef)(function(e){return[{href:"https://github.com/polkadot-js/apps",icon:"code-branch",name:"github",text:e("nav.github","GitHub",{ns:"apps-routing"})},{href:"https://wiki.polkadot.network",icon:"book",name:"wiki",text:e("nav.wiki","Wiki",{ns:"apps-routing"})}]}(n)),d=(0,g.useRef)(Hn(n)),p=(0,g.useRef)({accounts:n("Accounts"),developer:n("Developer"),files:n("Files"),governance:n("Governance"),network:n("Network"),settings:n("Settings")}),u=(0,g.useMemo)((()=>!!s&&t.some((e=>s.eq(e)))),[t,s]),m=(0,g.useMemo)((()=>function(e,n,t,r,i,o){return Object.values(e.reduce(((e,t)=>(e[t.group]?e[t.group].routes.push(t):e[t.group]={name:n[t.group],routes:[t]},e)),{})).map((({name:e,routes:n})=>({name:e,routes:n.filter((({display:e})=>function({api:e,isApiConnected:n,isApiReady:t,isDevelopment:r},i,o,a,{isDevelopment:s,isHidden:l,needsAccounts:c,needsApi:d,needsApiCheck:p,needsApiInstances:u,needsSudo:m,needsTeleport:g}){return!(l||c&&!o||d&&(!t||!n||m&&!a||g&&!i||!r&&s||0!==Gn(e,d,u,p).length))}(t,r,i,o,e)))}))).filter((({routes:e})=>e.length))}(d.current,p.current,o,a,i,u)),[a,o,i,u]),h=(0,g.useMemo)((()=>d.current.find((({name:e})=>l.pathname.startsWith(`/${e}`)))||null),[l]);return(0,r.jsx)(Jt,{className:`${e}${o.isApiReady&&o.isApiConnected?"":" isLoading"} highlight--bg`,children:(0,r.jsxs)("div",{className:"menuContainer",children:[(0,r.jsxs)("div",{className:"menuSection",children:[(0,r.jsx)(Ut,{}),(0,r.jsx)("ul",{className:"menuItems",children:m.map((({name:e,routes:n})=>(0,r.jsx)(Wt,{isActive:!!h&&h.group===e.toLowerCase(),name:e,routes:n},e)))})]}),(0,r.jsx)("div",{className:"menuSection media--1200",children:(0,r.jsx)("ul",{className:"menuItems",children:c.current.map((e=>(0,r.jsx)(zt,{isLink:!0,isToplevel:!0,route:e},e.name)))})}),(0,r.jsx)(Lt,{className:"media--1400"})]})})})),Vt=I.zo.div`
...
`,_t=g.memo((function({children:e,className:n="",icon:t,isBottom:i=!1,isDev:o,isFull:a=!1,type:s}){const[l,c]=(0,dt.O)(),d=(0,g.useCallback)((()=>{o&&localStorage.setItem("dev:notification",(new Date).toString()),c()}),[o,c]);return(0,g.useEffect)((()=>{const e=localStorage.getItem("dev:notification");if(e){const n=new Date(e);n.setMonth(n.getMonth()+1),n.getTime()<=(new Date).getTime()?localStorage.removeItem("dev:notification"):c()}}),[c]),l?null:(0,r.jsx)(Vt,{className:`${n} ${"error"===s?"isError":"isInfo"} ${i?"isBottom":"isTop"} ${a?"isFull":"isPartial"}`,children:(0,r.jsxs)("div",{className:"content",children:[(0,r.jsx)(I.JO,{className:"contentIcon",icon:t,size:"2x"}),(0,r.jsx)("div",{className:"contentItem",children:e}),(0,r.jsx)(I.zx,{className:"closeIcon",icon:"times",isBasic:!0,isCircular:!0,onClick:d})]})})})),Gt=window.location.host.startsWith("polkadot.js.org"),Kt=(0,c.Rf)((()=>"")).map((e=>e.dnslink)).reduce(((e,n)=>(n&&!e.includes(n)&&e.push(n),e)),[]),Yt=g.memo((function({className:e}){const{t:n}=Yn(),{systemChain:t}=(0,R.h)(),i=(0,g.useMemo)((()=>{const e=t?.toLowerCase();return e&&Kt.includes(e)?`https://${e}.dotapps.io`:"https://dotapps.io"}),[t]);return Gt?(0,r.jsx)(_t,{className:e,icon:"link",isBottom:!0,isDev:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("You are connected to the development instance of the UI. For a fully decentralized experience, you are encouraged to use the IPFS deployed version as the canonical URL: "),(0,r.jsx)("a",{href:i,rel:"noreferrer",target:"_blank",children:i.replace("https://","")})]})}):null})),Qt=g.memo((function({className:e}){const{t:n}=Yn(),{isLocalFork:t}=(0,R.h)();return t?(0,r.jsx)(_t,{className:e,icon:"link",isBottom:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("Local fork powered by "),(0,r.jsx)("a",{href:"https://github.com/AcalaNetwork/chopsticks",rel:"noreferrer",target:"_blank",children:"Chopsticks"}),"."]})}):null})),er=I.zo.div`
  position: fixed;
  bottom: 0.75rem;
  right: 0.75rem;
  left: 0.75rem;
...
`,nr=g.memo((function({className:e}){return(0,r.jsxs)(er,{className:e,children:[(0,r.jsx)(Qt,{}),(0,r.jsx)(Yt,{})]})})),tr=p.X.apiType.param,rr="json-rpc"===p.X.apiType.type&&"string"==typeof tr&&tr.startsWith("ws://"),ir="string"==typeof tr&&tr.includes("127.0.0.1"),or=window.location.protocol.startsWith("https:"),ar=g.memo((function({className:e}){const{t:n}=Yn(),{apiError:t,isApiConnected:i,isApiReady:o,isWaitingInjected:a}=(0,R.h)();return t?(0,r.jsx)(_t,{className:e,icon:"globe",type:"error",children:(0,r.jsx)("div",{children:t})}):o?a?(0,r.jsx)(_t,{className:e,icon:"puzzle-piece",type:"info",children:(0,r.jsx)("div",{children:n("Waiting for authorization from the extension. Please open the installed extension and approve or reject access.")})}):i?null:(0,r.jsxs)(_t,{className:e,icon:"globe",type:"error",children:[(0,r.jsx)("div",{children:n("You are not connected to a node. Ensure that your node is running and that the Websocket endpoint is reachable.")}),rr&&!ir&&or?(0,r.jsx)("div",{children:n("You are connecting from a secure location to an insecure WebSocket ({{wsUrl}}). Due to browser mixed-content security policies this connection type is not allowed. Change the RPC service to a secure 'wss' endpoint.",{replace:{wsUrl:tr}})}):void 0]}):(0,r.jsx)(_t,{className:e,icon:"globe",type:"info",children:(0,r.jsx)("div",{children:n(i?"Waiting to complete metadata retrieval from remote endpoint.":"Waiting to establish a connection with the remote endpoint.")})})})),sr=g.memo((function(){const{api:e,apiIdentity:n,isApiReady:t}=(0,R.h)(),i=(0,nt.W7)(t&&e.derive.accounts?.indexes),o=(0,nt.W7)(t&&n.query.identity?.registrars),a=(0,nt.W7)(t&&e.query.balances?.totalIssuance),[s,l]=(0,g.useState)(!1);return(0,g.useEffect)((()=>{l(!!i||!!a||!!o)}),[]),(0,r.jsx)("div",{className:`apps--api-warm ${s.toString()}`})})),lr=I.zo.div`
  background: var(--bg-page);
  box-sizing: border-box;
  display: flex;
  flex-direction: column;

...
`,Cs=s.memo((function({children:e,className:t="",is60:n,is100:s,isPadded:i=!0,isReverse:r,size:o="default"}){return(0,a.jsx)(js,{className:`${t} ui--Columar ${s?"is100":n?"is60":"is50"} ${i?"isPadded":""} ${r?"isReverse":""} ${o}Size`,children:e})}));Cs.Column=function({children:e,className:t=""}){return(0,a.jsx)("div",{className:`${t} ui--Column`,children:e})};const ks=Cs;var Ns=n(56360),Es=n(97794);const Ss=[1,2,4,8,16,32].map(((e,t)=>[t+1,e,new(je())(e)])),Is=s.memo((function({className:e="",label:t,onChange:n,value:i,voteLockingPeriod:r}){const{t:o}=(0,z.$)(),l=(0,Ns.n)(),c=(0,s.useRef)(function(e,t,n){return[{text:n("0.1x voting balance, no lockup period"),value:0},...Ss.map((([a,s,i])=>({text:n("{{value}}x voting balance, locked for {{duration}}x duration{{period}}",{replace:{duration:s,period:t&&t.gt(ae.nw)?` (${(0,Es.A)(e,i.mul(t),n)[1]})`:"",value:a}}),value:a})))]}(l,r,o));return(0,a.jsx)(Xt.Z,{className:e,label:t,onChange:n,options:c.current,value:i})}));n(79472);var Bs=n(92890);const Ds=A.z.div`
  .codeflask {
...
`,Ls=s.memo((function({className:e="",code:t,isValid:n,onEdit:i}){const[r]=(0,s.useState)((()=>`flask-${Date.now()}`)),o=(0,s.useRef)(null);return(0,s.useEffect)((()=>{const e=new Bs.Z(`#${r}`,{language:"js",lineNumbers:!0});e.updateCode(t),e.editorRoot.addEventListener("keydown",(()=>{e.onUpdate(i)})),o.current=e}),[]),(0,s.useEffect)((()=>{o.current&&o.current.updateCode(t)}),[t]),(0,a.jsx)(Ds,{className:`${e} ui-Editor ${!1===n?"invalid":""}`,id:r})})),Vs=A.z.div`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 1.7rem;
...
`,Zs=s.memo((function({className:e="",colSpan:t,isExpanded:n,rowSpan:s,toggle:i}){return(0,a.jsx)(zs,{className:`${e} ui--Table-Column-Expand`,colSpan:t,onClick:i,rowSpan:s,children:(0,a.jsx)("div",{children:(0,a.jsx)(x.Z,{icon:n?"caret-up":"caret-down"})})})})),Rs=A.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1rem;
...
`,$s=s.memo((function({address:e,className:t="",colSpan:n,isFavorite:i,rowSpan:r,toggle:o}){const l=(0,s.useCallback)((()=>o(e)),[e,o]);return(0,a.jsx)(Rs,{className:`${t} ui--Table-Column-Favorite`,colSpan:n,onClick:l,rowSpan:r,children:(0,a.jsx)(x.Z,{color:i?"orange":"gray",icon:"star"})})})),qs=`${7.15.toFixed(3)}ch`,Us=A.z.td`
  && {
    box-sizing: content-box;
    min-width: ${qs};
    text-align: right;
...
`,Ks=s.memo((function({className:e="",footer:t,isEmpty:n}){return!t||n?null:(0,a.jsx)(Js,{className:`${e} ui--Table-Foot`,children:t})})),Ys=A.z.thead`
  z-index: 1;
...
`,Xs=s.memo((function({children:e,className:t="",filter:n,header:s,isEmpty:i}){return s?.length?(0,a.jsxs)(Ys,{className:`${t} ui--Table-Head`,children:[n&&(0,a.jsx)("tr",{className:"filter",children:(0,a.jsx)("th",{colSpan:100,children:n})}),(0,a.jsx)("tr",{children:s.filter((e=>!!e)).map((([e,t="default",n=1,s],r)=>(0,a.jsx)("th",{className:t,colSpan:n,onClick:s,children:0===r?(0,a.jsx)("h1",{children:e}):!i&&e&&(0,a.jsx)("label",{children:e})},r)))}),e]}):null})),_s={2:[0,1],3:[0,1,2]},ei="0.125rem solid var(--bg-page)",ti="0.25rem solid var(--bg-page)",ni="0.5rem",ai=A.z.div`
  max-width: 100%;
  width: 100%;
    ...
    tr {
      &:not(.isExpanded) {
        td {
          ...
          &:first-child {
            border-top-left-radius: ${ni};
            border-bottom-left-radius: ${ni};
          }

          &:last-child {
            border-top-right-radius: ${ni};
            border-bottom-right-radius: ${ni};
          }
        }
      }
...
`,si=s.memo((function({children:e,className:t="",empty:n,emptySpinner:s,filter:i,footer:r,header:o,headerChildren:l,isFixed:c,isInline:d,isSplit:u,legend:m,maxColumns:h,noBodyTag:p}){const g=Ms(h),f=Array.isArray(e),b=!e||f&&0===e.length,x=(0,a.jsx)(Xs,{filter:i,header:o,isEmpty:b,children:l});return u&&f&&!b&&1!==g?(0,a.jsxs)(ai,{className:`${t} ui--Table isSplit`,children:[m,(0,a.jsx)("table",{className:"noMargin",children:x}),(0,a.jsx)("div",{className:"ui--Table-Split",children:_s[g].map((t=>(0,a.jsx)("div",{className:`ui--Table-Split-${g}`,children:(0,a.jsx)("table",{className:"noMargin",children:(0,a.jsx)("tbody",{className:"ui--Table-Body",children:e.filter(((e,n)=>n%g===t))})})},t)))})]}):(0,a.jsxs)(ai,{className:`${t} ui--Table`,children:[m,(0,a.jsxs)("table",{className:`${c&&!b?"isFixed":"isNotFixed"} ${d?"isInline":""}`,children:[x,(0,a.jsx)(Gs,{empty:n,emptySpinner:s,isEmpty:b,noBodyTag:p,children:e}),(0,a.jsx)(Ks,{footer:r,isEmpty:b})]})]})}));si.Column=Os,si.Row=Ws;const ii=si;function ri(e,t){return(0,a.jsx)("tr",{children:(0,a.jsx)("td",{children:e})},t)}const oi=(0,A.z)(me)`
  .tableContainer {
    overflow-y: scroll;
    display: block;
    margin: 0 0 0 auto;
...
`,li=s.memo((function({children:e,className:t,empty:n,renderChildren:i,summary:r}){const o=(0,s.useMemo)((()=>!(!i&&!e)),[e,i]),l=(0,s.useCallback)((()=>(i||e)&&(0,a.jsx)("div",{className:"tableContainer",children:(0,a.jsx)(ii,{empty:n,isInline:!0,children:i?i()?.map(ri):Array.isArray(e)?e.map(ri):(0,a.jsx)("tr",{children:(0,a.jsx)("td",{children:e})})})})),[e,n,i]);return(0,a.jsx)(oi,{className:t,renderChildren:o?l:void 0,summary:r})})),ci=A.z.div`
  width: 29.5rem;
...
`,di=s.memo((function({className:e="",filterOn:t,label:n,setFilter:s}){return(0,a.jsx)(ci,{className:e,children:(0,a.jsx)(_t.ZP,{autoFocus:!0,isFull:!0,label:n,onChange:s,value:t})})})),ui=A.z.div`
  display: none;
...
`;s.memo((function({className:e="",md:t}){const[n,s]=(0,de.O)();return(0,a.jsxs)(Ai,{className:`${e} ui--HelpOverlay`,children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(x.Z,{icon:"question-circle",onClick:s})}),(0,a.jsxs)("div",{className:"help-slideout "+(n?"open":"closed"),children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(x.Z,{icon:"times",onClick:s})}),(0,a.jsx)(bi.D,{className:"help-content",rehypePlugins:xi,children:t})]})]})}));const vi=(0,A.z)(pn.Z)`
  background: white;
...
`,wi=s.memo((function({children:e,className:t="",type:n="info"}){return(0,a.jsx)(vi,{children:(0,a.jsx)("div",{className:`${t} ${n}`,children:e})})}));var yi=n(47623);const ji=s.memo((function({address:e,filter:t,isHidden:n,onSelect:i}){const r=(0,s.useCallback)((()=>i(e)),[e,i]);return n?null:(0,a.jsx)(La,{address:e,filter:t,noToggle:!0,onChange:r})})),Ci=s.memo((function({address:e,filter:t,isHidden:n,onDeselect:i}){const r=(0,s.useCallback)((()=>i(e)),[e,i]);return n?null:(0,a.jsx)(La,{address:e,filter:t,noToggle:!0,onChange:r})})),ki=A.z.div`
...
`,Ni=s.memo((function({available:e,availableLabel:t,className:n="",defaultValue:i,maxCount:r,onChange:o,valueLabel:l}){const{t:c}=(0,z.$)(),[d,u]=(0,s.useState)(""),[m,h]=(0,s.useState)([]),p=(0,Ts.N)(d),g=(0,yi.q)();(0,s.useEffect)((()=>{i&&h(i)}),[i]),(0,s.useEffect)((()=>{m&&o(m)}),[o,m]);const f=(0,s.useCallback)((e=>h((t=>function(e,t,n){return!e.includes(t)&&e.length<n?e.concat(t):e}(t,e,r)))),[r]),b=(0,s.useCallback)((e=>h((t=>function(e,t){return e.includes(t)?e.filter((e=>e!==t)):e}(t,e)))),[]);return(0,a.jsxs)(ki,{className:`${n} ui--InputAddressMulti`,children:[(0,a.jsx)(_t.ZP,{autoFocus:!0,className:"ui--InputAddressMulti-Input",isSmall:!0,onChange:u,placeholder:c("filter by name, address, or account index"),value:d,withLabel:!1}),(0,a.jsxs)("div",{className:"ui--InputAddressMulti-columns",children:[(0,a.jsxs)("div",{className:"ui--InputAddressMulti-column",children:[(0,a.jsx)("label",{children:l}),(0,a.jsx)("div",{className:"ui--InputAddressMulti-items",children:m.map((e=>(0,a.jsx)(Ci,{address:e,onDeselect:b},e)))})]}),(0,a.jsxs)("div",{className:"ui--InputAddressMulti-column",children:[(0,a.jsx)("label",{children:t}),(0,a.jsx)("div",{className:"ui--InputAddressMulti-items",children:g?e.map((e=>(0,a.jsx)(ji,{address:e,filter:p,isHidden:m?.includes(e),onSelect:f},e))):(0,a.jsx)(U,{})})]})]})]})})),Ei=A.z.div`
  position: relative;
...
`,Bi=s.memo((function({children:e,className:t="",label:n,withLabel:s}){return(0,a.jsx)(Ii,{className:t,children:(0,a.jsx)(pn.Z,{label:n,withLabel:s,children:(0,a.jsx)("div",{className:"ui--DropdownLinked ui--row",children:e})})})}));function Di(e,t){if(!t)return[];const n=e[t];return n&&0!==Object.keys(e[t]).length?Object.keys(e[t]).filter((e=>!e.startsWith("$"))).sort().map((e=>n[e])).map((({description:e,method:n,params:s})=>{const i=s.map((({name:e})=>e)).join(", ");return{className:"ui--DropdownLinked-Item",key:`${t}_${n}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[n,"(",i,")"]},`${t}_${n}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:e||n},`${t}_${n}:text`)],value:n}})):[]}const Li=s.memo((function({className:e="",defs:t,isError:n,onChange:i,options:r,value:o}){const l=(0,s.useCallback)((e=>t[o.section][e]),[t,o]);return r.length?(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Items`,isError:n,onChange:i,options:r,transform:l,value:o.method,withLabel:!1}):null})),Vi=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:r}){return(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,options:i,value:r.section,withLabel:!1})}));function Pi(e){return Object.entries(e).sort((([e],[t])=>e.localeCompare(t)))}const Ti=(0,Re.e)("useRuntime",(function(){const{api:e}=(0,F.h)();return(0,s.useMemo)((()=>function(e){const t={};let n=null;const a=Pi(e.call);for(let e=0,s=a.length;e<s;e++){const[s,i]=a[e],r=Pi(i);for(let e=0,a=r.length;e<a;e++){const[a,{meta:i}]=r[e];i&&(t[s]||(t[s]={},null===n&&(n=i)),t[s][a]=i)}}return[t,n]}(e)),[e])})),Mi=s.memo((function({className:e,label:t,onChange:n,withLabel:i}){const[r,o]=Ti(),[l]=(0,s.useState)((()=>{return e=r,Object.keys(e).filter((e=>!e.startsWith("$"))).sort().filter((t=>0!==Object.keys(e[t]).length)).map((e=>({text:e,value:e})));var e})),[c,d]=(0,s.useState)((()=>Di(r,o?.section))),[u,m]=(0,s.useState)((()=>o));(0,s.useEffect)((()=>{u&&n&&n(u)}),[n,u]);const h=(0,s.useCallback)((e=>{u!==e&&m((()=>e))}),[u]),p=(0,s.useCallback)((e=>{if(u&&e!==u.section){const t=Di(r,e);d(t),h(r[e][t[0].value])}}),[h,r,u]);return u?(0,a.jsxs)(Bi,{className:e,label:t,withLabel:i,children:[(0,a.jsx)(Vi,{className:"small",onChange:p,options:l,value:u}),(0,a.jsx)(Li,{className:"large",defs:r,onChange:h,options:c,value:u})]}):null}));var Fi=n(44055);function zi(e,t){const n=e.consts[t];return n&&0!==Object.keys(n).length?Object.keys(n).filter((e=>!e.startsWith("$"))).sort().map((s=>{const i=n[s];return{className:"ui--DropdownLinked-Item",key:`${t}_${s}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[s,": ",(0,Fi.I)(e.registry.lookup,i.meta.type)]},`${t}_${s}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(i.meta.docs[0]||i.meta.name).toString()},`${t}_${s}:text`)],value:s}})):[]}function Zi({value:e}){return t=>({method:t,section:e.section})}const Ri=s.memo((function(e){const{className:t="",isError:n,onChange:s,options:i,value:r}=e;return i.length?(0,a.jsx)(Xt.Z,{className:`${t} ui--DropdownLinked-Items`,isError:n,onChange:s,options:i,transform:Zi(e),value:r.method,withLabel:!1}):null})),$i=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:{section:r}}){return(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,options:i,value:r,withLabel:!1})})),qi=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,F.h)(),[l,c]=(0,s.useState)((()=>zi(o,t.section))),[d]=(0,s.useState)((()=>function(e){return Object.keys(e.consts).filter((e=>!e.startsWith("$"))).sort().filter((t=>Object.keys(e.consts[t]).length)).map((e=>({text:e,value:e})))}(o))),[u,m]=(0,s.useState)((()=>function(e,{method:t,section:n}){const a=Object.keys(e.consts)[0],s=Object.keys(e.consts[a])[0],i=e.consts[n]?.[t]?{method:t,section:n}:{method:s,section:a};return{...i,meta:e.consts[i.section][i.method].meta}}(o,t))),h=(0,s.useCallback)((e=>{if(u.section!==e.section||u.method!==e.method){const{method:t,section:n}=e,a={meta:o.consts[n][t].meta,method:t,section:n};m(a),i&&i(a)}}),[o,i,u]),p=(0,s.useCallback)((e=>{if(e!==u.section){const t=zi(o,e);c(t),h({method:t[0].value,section:e})}}),[h,o,u]);return(0,a.jsxs)(Bi,{className:e,label:n,withLabel:r,children:[(0,a.jsx)($i,{className:"small",onChange:p,options:d,value:u}),(0,a.jsx)(Ri,{className:"large",onChange:h,options:l,value:u})]})}));function Ui(e,t,n){const s=e.tx[t],i=!n||n(t);return s&&0!==Object.keys(s).length&&i?Object.keys(s).filter((e=>!e.startsWith("$")&&(!n||n(t,e)))).sort().map((e=>{const n=s[e],i=n.meta.args.map((e=>e.name.toString())).join(", ");return{className:"ui--DropdownLinked-Item",key:`${t}_${e}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[e,"(",i,")"]},`${t}_${e}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(n.meta.docs[0]||e).toString()},`${t}_${e}:text`)],value:e}})):[]}const Hi=s.memo((function({api:e,className:t="",defaultValue:n,isDisabled:i,isError:r,onChange:o,options:l,value:c}){const d=(0,s.useCallback)((t=>e.tx[c.section][t]),[e,c]);return l.length?(0,a.jsx)(Xt.Z,{className:`${t} ui--DropdownLinked-Items`,defaultValue:n,isDisabled:i,isError:r,onChange:o,options:l,transform:d,value:c.method,withLabel:!1}):null})),Qi=s.memo((function({className:e="",defaultValue:t,isDisabled:n,isError:s,onChange:i,options:r,value:o}){return(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isDisabled:n,isError:s,onChange:i,options:r,value:o.section,withLabel:!1})})),Oi=s.memo((function({className:e="",defaultValue:t,filter:n,isDisabled:i,label:r,onChange:o,withLabel:l}){const{api:c}=(0,F.h)(),[d,u]=(0,s.useState)((()=>Ui(c,t.section,n))),[m]=(0,s.useState)((()=>function(e,t){return Object.keys(e.tx).filter((e=>!e.startsWith("$")&&(!t||t(e)))).sort().filter((t=>Object.keys(e.tx[t]).length)).map((e=>({text:e,value:e})))}(c,n))),[h,p]=(0,s.useState)((()=>t)),[{defaultMethod:g,defaultSection:f}]=(0,s.useState)((()=>({defaultMethod:t.method,defaultSection:t.section}))),b=(0,s.useCallback)((e=>{h!==e&&(p((()=>e)),o&&o(e))}),[o,h]),x=(0,s.useCallback)((e=>{if(e!==h.section){const t=Ui(c,e,n);u(t),b(c.tx[e][t[0].value])}}),[b,c,n,h]);return(0,a.jsxs)(Bi,{className:e,label:r,withLabel:l,children:[(0,a.jsx)(Qi,{className:"small",defaultValue:f,isDisabled:i,onChange:i?void 0:x,options:m,value:h}),(0,a.jsx)(Hi,{api:c,className:"large",defaultValue:g,isDisabled:i,onChange:i?void 0:b,options:d,value:h})]})}));var Wi=n(6574),Gi=n(56623),Ji=n(48533);const Ki="0".charCodeAt(0),Yi="x".charCodeAt(0),Xi=()=>{},_i=A.z.div`
  background: var(--bg-input);
  border: 1px solid var(--border-input);
...
`,er=s.memo((function({accept:e,className:t="",clearContent:n,isDisabled:i,isError:r=!1,isFull:o,label:l,labelExtra:c,onChange:d,placeholder:u,withEllipsis:m,withLabel:p}){const{t:g}=(0,z.$)(),f=(0,s.createRef)(),[b,x]=(0,s.useState)(),A=(0,s.useCallback)((e=>{e.forEach((e=>{const t=new FileReader;t.onabort=Xi,t.onerror=Xi,t.onload=({target:t})=>{if(t?.result){const n=e.name,a=function(e){const t=new Uint8Array(e);if(t[0]===Ki&&t[1]===Yi){let e=(0,Gi.z)(t);for(;e.endsWith("\n");)e=e.substring(0,e.length-1);if((0,He.vq)(e))return(0,Ji.G)(e)}return t}(t.result);d&&d(a,n),f&&x({name:n,size:a.length})}},t.readAsArrayBuffer(e)}))}),[f,d]),{getInputProps:v,getRootProps:w}=(0,Wi.uI)({accept:e?.reduce(((e,t)=>({...e,[t]:[]})),{}),disabled:i,onDrop:A}),y=(0,a.jsxs)(_i,{...w({className:`${t} ui--InputFile ${r?"error":""}`}),children:[(0,a.jsx)("input",{...v()}),(0,a.jsx)("em",{className:"label",children:!b||n?u||g("click to select or drag and drop the file here"):u||g("{{name}} ({{size}} bytes)",{replace:{name:b.name,size:(0,h.u)(b.size)}})})]});return l?(0,a.jsx)(pn.Z,{isFull:o,label:l,labelExtra:c,withEllipsis:m,withLabel:p,children:y}):y}));var tr=n(39764);function nr(e,t,n){const s=t[n];return s&&0!==Object.keys(e.rpc[n]).length?Object.keys(e.rpc[n]).filter((e=>!e.startsWith("$"))).sort().map((e=>s[e])).filter((e=>!!e)).filter((({isSubscription:e})=>!e)).map((({description:e,method:t,params:s})=>{const i=s.map((({name:e})=>e)).join(", ");return{className:"ui--DropdownLinked-Item",key:`${n}_${t}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[t,"(",i,")"]},`${n}_${t}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:e||t},`${n}_${t}:text`)],value:t}})):[]}var ar=n(13529),sr=n(91783);const ir=(0,Re.e)("useRpcs",(function(){const{api:e}=(0,F.h)();return(0,s.useMemo)((()=>function(e,t,{specName:n}){return Object.entries((0,sr.KM)(e,t,n)).reduce(((e,[t,n])=>(e[t]??=function(e,t){return Object.entries(t).reduce(((t,[n,a])=>(t[n]={isSubscription:!1,jsonrpc:`${e}_${n}`,method:n,section:e,...a},t)),{})}(t,n),e)),{...ar.Z})}(e.registry,e.runtimeChain,e.runtimeVersion)),[e])})),rr=s.memo((function({className:e="",isError:t,onChange:n,options:i,value:r}){const o=ir(),l=(0,s.useCallback)((e=>o[r.section][e]),[o,r]);return i.length?(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Items`,isError:t,onChange:n,options:i,transform:l,value:r.method,withLabel:!1}):null})),or=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:r}){return(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,options:i,value:r.section,withLabel:!1})})),lr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,F.h)(),l=ir(),[c,d]=(0,s.useState)((()=>nr(o,l,t.section))),[u]=(0,s.useState)((()=>function(e){return Object.keys(e.rpc).filter((e=>!e.startsWith("$"))).sort().filter((t=>0!==Object.keys(e.rpc[t]).length)).map((e=>({text:e,value:e})))}(o))),[m,h]=(0,s.useState)((()=>t));(0,s.useEffect)((()=>{i&&i(m)}),[i,m]);const p=(0,s.useCallback)((e=>{m!==e&&h((()=>e))}),[m]),g=(0,s.useCallback)((e=>{if(e!==m.section){const t=nr(o,l,e);d(t),p(l[e][t[0].value])}}),[p,o,l,m]);return(0,a.jsxs)(Bi,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(or,{className:"small",onChange:g,options:u,value:m}),(0,a.jsx)(rr,{className:"large",onChange:p,options:c,value:m})]})}));var cr=n(19729);function dr(e,t){const n=e.query[t];return n&&0!==Object.keys(n).length?Object.keys(n).filter((e=>!e.startsWith("$"))).sort().map((s=>{const{meta:{docs:i,modifier:r,name:o,type:l}}=n[s],c=(0,cr.P)(e.registry,l,r.isOptional);let d="";if(l.isMap){const{hashers:t,key:n}=l.asMap;if(1===t.length)d=(0,Fi.I)(e.registry.lookup,n);else{const t=e.registry.lookup.getSiType(n).def;d=t.isTuple?t.asTuple.map((t=>(0,Fi.I)(e.registry.lookup,t))).join(", "):t.asHistoricMetaCompat.toString()}}return{className:"ui--DropdownLinked-Item",key:`${t}_${s}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[s,"(",d,"): ",c]},`${t}_${s}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(i[0]||o).toString()},`${t}_${s}:text`)],value:s}})):[]}function ur(e,{value:t}){return function(n){return e.query[t.creator.section]?e.query[t.creator.section][n]:t}}const mr=s.memo((function(e){const{api:t}=(0,F.h)(),{className:n="",isError:s,onChange:i,options:r,value:o}=e;return r.length?(0,a.jsx)(Xt.Z,{className:`${n} ui--DropdownLinked-Items`,isError:s,onChange:i,options:r,transform:ur(t,e),value:o.creator.method,withLabel:!1}):null})),hr=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:{creator:{section:r}}}){return(0,a.jsx)(Xt.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,options:i,value:r,withLabel:!1})})),pr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,F.h)(),[l,c]=(0,s.useState)((()=>dr(o,t.creator.section))),[d]=(0,s.useState)((()=>function(e){return Object.keys(e.query).filter((e=>!e.startsWith("$"))).sort().filter((t=>Object.keys(e.query[t]).length)).map((e=>({text:e,value:e})))}(o))),[u,m]=(0,s.useState)((()=>t)),h=(0,s.useCallback)((e=>{u!==e&&(m((()=>e)),i&&i(e))}),[i,u]),p=(0,s.useCallback)((e=>{if(e!==u.creator.section){const t=dr(o,e);c(t),h(o.query[e][t[0].value])}}),[h,o,u]);return(0,a.jsxs)(Bi,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(hr,{className:"small",onChange:p,options:d,value:u}),(0,a.jsx)(mr,{className:"large",onChange:h,options:l,value:u},u.creator.section)]})}));n(35220);var gr=n(6226),fr=n(88311);const br=["application/wasm"],xr=s.memo((function({onChange:e,...t}){const n=(0,s.useCallback)(((t,n)=>{const a=(0,gr.F)(t);e((0,fr.N)(t),a,n)}),[e]);return(0,a.jsx)(er,{...t,accept:br,onChange:n})}));var Ar=n(55858);const vr=(0,A.z)(pn.Z)`
...
`,wr=s.memo((function({children:e,className:t="",isDisabled:n,isError:s,isFull:i,isHidden:r,isMonospace:o,isSmall:l,isTrimmed:c,label:d,labelExtra:u,value:m,withCopy:h=!1,withLabel:p}){return(0,a.jsxs)(vr,{className:`${t} ui--Output`,isFull:i,isHidden:r,isSmall:l,label:d,labelExtra:u,withLabel:p,children:[(0,a.jsxs)("div",{className:`ui--output ui dropdown selection ${s?" error":""}${o?" monospace":""}${n?"isDisabled":""}`,children:[c&&(0,dn.H)(m)&&m.length>512?`${m.slice(0,256)}…${m.slice(-256)}`:m,e]}),h&&(0,a.jsx)(hn,{value:m})]})}));function yr({inner:e=[],name:t="",outer:n=[]},a=[]){if(n.length){const e=new Array(n.length);for(let t=0;t<n.length;t++)e[t]=(0,Ar.c)(n[t],void 0,!1);a.push({name:t,value:e.join(" ")})}for(let t=0,n=e.length;t<n;t++)yr(e[t],a);return a}const jr=(0,A.z)(wr)`
  table {
    width: 100%;
...
`,Lr=s.memo((function({className:e,id:t}){const n=(0,Br.jC)(t),i=(0,s.useMemo)((()=>n.filter((({isDisabled:e,isUnreachable:t})=>!e&&!t))),[n]);if(!n.length)return null;const{text:r,ui:o,value:l}=i.length?i[i.length-1]:n[0];return(0,a.jsxs)(Dr,{className:e,children:[(0,a.jsx)(Ka,{isInline:!0,logo:o.logo||"empty",withoutHl:!0}),i.length?(0,a.jsx)("a",{className:"chainAlign",href:`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(l)}`,children:r}):r]})})),Vr=s.memo((function({autoFocus:e,children:t,className:n="",defaultValue:s,isDisabled:i,isError:r,isFull:o,label:l,labelExtra:c,name:d,onChange:u,onEnter:m,onEscape:h,tabIndex:p,value:g,withLabel:f}){return(0,a.jsx)(_t.ZP,{autoFocus:e,className:`${n} ui--Password`,defaultValue:s,isDisabled:i,isError:r,isFull:o,label:l,labelExtra:c,name:d,onChange:u,onEnter:m,onEscape:h,tabIndex:p,type:"password",value:g,withLabel:f,children:t})}));var Pr=n(81679),Tr=n.n(Pr);Tr().config({allowPassphrases:!0,maxLength:128,minLength:8,minPhraseLength:20});const Mr=A.z.div`
  align-items: center;
  margin-top: 0.5rem;
  margin-left: 2rem;
  font-size: var(--font-size-base);
...
`,Fr=s.memo((function({className:e="",value:t}){const{t:n}=(0,z.$)(),s={width:100*function(e){const t=Tr().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Mr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})})),zr=A.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
`,Zr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:s,onClick:i,options:r,sortDirection:o}){return(0,a.jsxs)(zr,{className:`${e} ui--Sort`,children:[(0,a.jsx)(Xt.Z,{defaultValue:t,label:n,onChange:s,options:r}),(0,a.jsxs)("button",{onClick:i,children:[(0,a.jsx)(x.Z,{className:"arrow up"+("ascending"===o?" isActive":""),color:"gray",icon:"sort-up"}),(0,a.jsx)(x.Z,{className:"arrow down"+("descending"===o?" isActive":""),color:"gray",icon:"sort-down"})]})]})})),Rr=s.memo((function({className:e="",stakingInfo:t}){const n=t?.stakingLedger?.active?.unwrap();return n?.gtn(0)?(0,a.jsx)(ee.Z,{className:e,value:n}):null}));var $r=n(56245);function qr(e){switch(e){case"error":return"ban";case"event":case"eventWarn":return"assistive-listening-systems";case"received":return"telegram-plane";default:return"check"}}function Ur({account:e,action:t,id:n,message:s,removeItem:i,status:r}){return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[(0,a.jsx)(x.Z,{icon:"times",onClick:i}),(0,a.jsx)("div",{className:"short",children:(0,a.jsx)(x.Z,{icon:qr(r)})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsx)("div",{className:"header",children:Array.isArray(t)?t.map(((e,t)=>(0,a.jsx)("div",{children:e},t))):t}),e&&(0,a.jsx)(ot,{value:e}),(0,a.jsx)("div",{className:"status",children:s})]})]})})},n)}function Hr({error:e,extrinsic:t,id:n,removeItem:s,rpc:i,status:r}){let{method:o,section:l}=i;if(t){const e=t.registry.findMetaCall(t.callIndex);"unknown"!==e.section&&(o=e.method,l=e.section)}const c=function(e){switch(e){case"cancelled":return"ban";case"completed":case"inblock":case"finalized":case"sent":return"check";case"dropped":case"invalid":case"usurped":return"arrow-down";case"error":case"finalitytimeout":return"exclamation-triangle";case"queued":return"random";default:return"spinner"}}(r);return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[$r.z.includes(r)&&(0,a.jsx)(x.Z,{icon:"times",onClick:s}),(0,a.jsx)("div",{className:"short",children:"spinner"===c?(0,a.jsx)(U,{variant:"push"}):(0,a.jsx)(x.Z,{icon:c})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsxs)("div",{className:"header",children:[l,".",o]}),(0,a.jsx)("div",{className:"status",children:e?e.message||e.toString():r})]})]})})},n)}const Qr=A.z.div`
  display: inline-block;
  overflow: hidden;
  position: fixed;
  right: 0.75rem;
...
`,Gr=s.memo((function({children:e,className:t="",isSmall:n}){return(0,a.jsx)(Wr,{className:`${t}${n?" isSmall":""}`,children:e})}));var Jr=n(73557),Kr=n(59149);const Yr=A.z.div`
...
`,Xr=s.memo((function({className:e="",icon:t,text:n}){return(0,a.jsxs)(Yr,{className:`${e} active-tab`,children:[(0,a.jsx)(x.Z,{icon:t}),(0,a.jsx)("span",{children:n})]})}));var _r=n(39857);const eo=(0,A.z)(_r.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,to=s.memo((function({basePath:e,className:t="",count:n,hasParams:s,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!s||0===i;return(0,a.jsxs)(eo,{className:`${t} ui--Tab`,end:u,to:d,children:[(0,a.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,a.jsx)(j,{className:"tabCounter",color:"counter",info:n})]})})),no=A.z.div`
  height: 100%;
  width: auto;
`,ao=s.memo((function({className:e=""}){return(0,a.jsx)(no,{className:e,children:(0,a.jsx)("svg",{fill:"none",height:"47",viewBox:"0 0 17 65",width:"17",xmlns:"http://www.w3.org/2000/svg",children:(0,a.jsx)("path",{className:"highlight--stroke",d:"M1 1L16 32.5L1 64",stroke:"#D1D1D1"})})})})),so=A.z.header`
  background: var(--bg-tabs);
...
`,io=s.memo((function({basePath:e,className:t="",hidden:n,items:i}){const r=(0,Jr.TH)(),{icon:o,text:l}=s.useContext(Kr.m),c=(0,s.useMemo)((()=>i.filter((e=>!(!e||n&&n.includes(e.name))))),[n,i]);return(0,s.useEffect)((()=>function(e,t,n,a){if(t.pathname!==e){const[,,s]=t.pathname.split("/"),i=n.find((e=>e&&e.alias===s));i?window.location.hash=i.isRoot?e:`${e}/${i.name}`:!a||!a.includes(s)&&n.some((e=>e&&!e.isRoot&&e.name===s))||(window.location.hash=e)}}(e,r,i,n)),[e,n,i,r]),(0,a.jsx)(so,{className:`${t} ui--Tabs`,children:(0,a.jsxs)("div",{className:"tabs-container",children:[l&&o&&(0,a.jsx)(Xr,{icon:o,text:l}),(0,a.jsx)(ao,{}),(0,a.jsx)("ul",{className:"ui--TabsList",children:c.map(((t,n)=>(0,a.jsx)("li",{className:t.isHidden?"--hidden":"",children:(0,s.createElement)(to,{...t,basePath:e,index:n,key:t.name})},n)))})]})})})),ro=(0,A.z)(pn.Z)`

...
`;i.memo((function({children:e,className:t="",header:n,href:a,isCollapsible:r,isError:o,isSuccess:l,withBottomMargin:c,withTopMargin:d}){const u=(0,ji.k6)(),[m,h]=(0,G.O)(),p=(0,i.useCallback)((()=>{a&&u.push(a)}),[u,a]);return e?(0,s.jsxs)(ki,{className:`${t} ui--Inset ${a?"as-link":""} ${r?"collapsible":""} ${o&&!l?"error":""} ${!o&&l?"success":""} ${c?"bottom-margin":""} ${d?"top-margin":""}`,children:[r&&(0,s.jsxs)("div",{className:"header",onClick:h,children:[(0,s.jsx)("h2",{children:n}),(0,s.jsx)(v.Z,{className:m?"collapsed":"",icon:"angle-up"})]}),(0,s.jsx)("div",{className:"children"+(r&&m?" collapsed":""),onClick:p,children:e})]}):null}));let Ni=0;const Ci=A.z.div`
  cursor: help;
  display: inline-block;
  line-height: 1rem;
...
`,kr=i.memo((function({children:e,className:t="",isSmall:n}){return(0,s.jsx)(jr,{className:`${t}${n?" isSmall":""}`,children:e})})),Nr=A.z.div`
...
`,Cr=i.memo((function({className:e="",icon:t,text:n}){return(0,s.jsxs)(Nr,{className:`${e} active-tab`,children:[(0,s.jsx)(v.Z,{icon:t}),(0,s.jsx)("span",{children:n})]})}));var Er=n(26643);const Sr=(0,A.z)(Er.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,Ir=i.memo((function({basePath:e,className:t="",count:n,hasParams:a,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!a||0===i;return(0,s.jsxs)(Sr,{activeClassName:"tabLinkActive",className:`${t} ui--Tab`,exact:u,strict:u,to:d,children:[(0,s.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,s.jsx)(k,{className:"tabCounter",color:"counter",info:n})]})})),Dr=A.z.div`
  height: 100%;
  width: auto;
`,Br=i.memo((function({className:e=""}){return(0,s.jsx)(Dr,{className:e,children:(0,s.jsx)("svg",{fill:"none",height:"47",viewBox:"0 0 17 65",width:"17",xmlns:"http://www.w3.org/2000/svg",children:(0,s.jsx)("path",{className:"highlight--stroke",d:"M1 1L16 32.5L1 64",stroke:"#D1D1D1"})})})})),Lr=i.createContext({}),$r=A.z.header`
...
`,Vr=i.memo((function({basePath:e,className:t="",hidden:n,items:a}){const r=(0,ji.TH)(),{icon:o,text:l}=i.useContext(Lr),c=(0,i.useMemo)((()=>a.filter((e=>!(!e||n&&n.includes(e.name))))),[n,a]);return(0,i.useEffect)((()=>function(e,t,n,a){if(t.pathname!==e){const[,,s]=t.pathname.split("/"),i=n.find((e=>e&&e.alias===s));i?window.location.hash=i.isRoot?e:`${e}/${i.name}`:!a||!a.includes(s)&&n.some((e=>e&&!e.isRoot&&e.name===s))||(window.location.hash=e)}}(e,r,a,n)),[e,n,a,r]),(0,s.jsx)($r,{className:`${t} ui--Tabs`,children:(0,s.jsxs)("div",{className:"tabs-container",children:[l&&o&&(0,s.jsx)(Cr,{icon:o,text:l}),(0,s.jsx)(Br,{}),(0,s.jsx)("ul",{className:"ui--TabsList",children:c.map(((t,n)=>(0,s.jsx)("li",{className:t.isHidden?"--hidden":"",children:(0,i.createElement)(Ir,{...t,basePath:e,index:n,key:t.name})},n)))})]})})}));var Pr=n(53657);const Zr=i.memo((function({index:e,isDisabled:t,isSelected:n,onChange:a,text:r,value:o}){const l=(0,i.useCallback)((()=>{!t&&a(e,o)}),[t,e,a,o]);return(0,s.jsx)(ie.Z,{icon:n?"check":"circle",isBasic:!0,isDisabled:t,isSelected:n,label:r,onClick:l},r)})),Tr=A.z.div`
  display: inline-block;
  margin-right: 1.5rem;
...
`,qr=i.memo((function({children:e,className:t,isError:n,isReadOnly:a,label:r,onChange:o,seed:l,withLabel:c}){const d=(0,i.useCallback)((({target:{value:e}})=>{o&&o(e)}),[o]);return(0,s.jsx)(Ur,{className:t,label:r,withLabel:c,children:(0,s.jsxs)("div",{className:"TextAreaWithDropdown",children:[(0,s.jsx)("textarea",{autoCapitalize:"off",autoCorrect:"off",autoFocus:!1,className:n?"ui-textArea-withError":"",onChange:d,readOnly:a,rows:2,spellCheck:!1,value:l}),e]})})})),Or=A.z.div`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 1.7rem;
  ...
  border-radius: 4px;
  cursor: pointer;
`,Wr=i.memo((function({className:e="",expanded:t,onClick:n}){return(0,s.jsx)(Or,{className:`${e} ui--ExpandButton`,"data-testid":"row-toggle",onClick:n,children:(0,s.jsx)(v.Z,{icon:t?"caret-up":"caret-down"})})})),Qr=A.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;

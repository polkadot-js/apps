...
`,pa=s.memo((function({className:e="",onClose:t,recipientId:n,senderId:i}){const{t:r}=(0,z.$)(),{api:o}=(0,l.h)(),[c,d]=(0,s.useState)(ae.nw),[u]=(0,s.useState)(!0),[m,h]=(0,s.useState)(!0),[p,g]=(0,s.useState)(!1),[[b,x],A]=(0,s.useState)([null,!1]),[v,w]=(0,s.useState)(null),[y,j]=(0,s.useState)(null),[[,k],C]=(0,s.useState)([null,null]),N=(0,ge.W7)(o.derive.balances?.all,[i||y]),E=(0,ge.W7)(o.query.system.account,[i||y]);(0,s.useEffect)((()=>{const e=i||y,t=n||v;N&&N.accountId?.eq(e)&&e&&t&&o.call.transactionPaymentApi&&o.tx.balances?(0,oa.Y)((async()=>{try{const n=(o.tx.balances.transferAllowDeath||o.tx.balances.transfer)(t,N.availableBalance),{partialFee:a}=await n.paymentInfo(e),s=a.muln(110).div(ae.S8),i=N.availableBalance.sub(s);A(o.consts.balances&&i.gt(o.consts.balances.existentialDeposit)?[i,!1]:[null,!0])}catch(e){console.error(e)}})):A([null,!1])}),[o,N,n,i,v,y]),(0,s.useEffect)((()=>{(async function(e,t){return[null,t?await(0,ia.fF)(t):null]})(0,n||v).then(C).catch(console.error)}),[n,i,v,y]);const S=!E||(function(e){return!!e.refcount}(E)?E.refcount.isZero():E.consumers.isZero()),I=!m&&N&&N.accountId?.eq(i||y)&&b&&S;return(0,a.jsxs)(ha,{className:"app--accounts-Modal",header:r("Send funds"),onClose:t,size:"large",children:[(0,a.jsx)(Yn.Content,{children:(0,a.jsxs)("div",{className:e,children:[(0,a.jsx)(Yn.Columns,{hint:r("The transferred balance will be subtracted (along with fees) from the sender account."),children:(0,a.jsx)(Pn,{defaultValue:i,isDisabled:!!i,label:r("send from account"),labelExtra:(0,a.jsx)(ra.Z,{label:r("transferrable"),params:i||y}),onChange:j,type:"account"})}),(0,a.jsxs)(Yn.Columns,{hint:r("The beneficiary will have access to the transferred fees when the transaction is included in a block."),children:[(0,a.jsx)(Pn,{defaultValue:n,isDisabled:!!n,label:r("send to address"),labelExtra:(0,a.jsx)(ra.Z,{label:r("transferrable"),params:n||v}),onChange:w,type:"allPlus"}),k&&(0,a.jsx)(Tn,{content:r("The recipient is associated with a known phishing site on {{url}}",{replace:{url:k}})})]}),(0,a.jsx)(Yn.Columns,{hint:r("If the recipient account is new, the balance needs to be more than the existential deposit. Likewise if the sending account balance drops below the same value, the account will be removed from the state."),children:I&&p?(0,a.jsx)(la.Z,{autoFocus:!0,defaultValue:b,isDisabled:!0,label:r("transferrable minus fees")},b?.toString()):(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(la.Z,{autoFocus:!0,isError:!u,isZeroable:!0,label:r("amount"),maxValue:b,onChange:d}),(0,a.jsx)(la.Z,{defaultValue:o.consts.balances?.existentialDeposit,isDisabled:!0,label:r("existential deposit")})]})}),(0,a.jsxs)(Yn.Columns,{hint:r("With the keep-alive option set, the account is protected against removal due to low balances."),children:[(0,f.m)(o.tx.balances?.transferKeepAlive)&&(0,a.jsx)(ma,{className:"typeToggle",label:r(m?"Transfer with account keep-alive checks":"Normal transfer without keep-alive checks"),onChange:h,value:m}),I&&(0,a.jsx)(ma,{className:"typeToggle",label:r("Transfer the full account balance, reap the sender"),onChange:g,value:p}),!m&&!S&&(0,a.jsx)(da,{content:r("There is an existing reference count on the sender account. As such the account cannot be reaped from the state.")}),x&&(0,a.jsx)(da,{content:r("The transaction, after application of the transfer fees, will drop the available balance below the existential deposit. As such the transfer will fail. The account needs more free funds to cover the transaction fees.")})]})]})}),(0,a.jsx)(Yn.Actions,{children:(0,a.jsx)(Ae,{accountId:i||y,icon:"paper-plane",isDisabled:!((p||u&&c)&&(n||v)&&!k),label:r("Make Transfer"),onStart:t,params:I&&p?(0,f.m)(o.tx.balances?.transferAll)?[n||v,!1]:[n||v,b]:[n||v,c],tx:I&&p&&(0,f.m)(o.tx.balances?.transferAll)?o.tx.balances?.transferAll:m?o.tx.balances?.transferKeepAlive:o.tx.balances?.transferAllowDeath||o.tx.balances?.transfer})})]})})),ga=v.z.div`
  width: 100%;
...
`,Aa=s.memo((function({className:e="",color:t,label:n}){return(0,a.jsx)(xa,{className:`${e} ${"theme"===t?" highlight--color-bg highlight--bg":""}`,color:t,label:n,size:"tiny"})})),va=v.z.div`
  .ui--Tag {
...
`,Ba=s.memo((function({buttons:e,children:t,className:n,defaultName:s,fullLength:i=!1,isContract:r=!1,isDisabled:o,isEditableName:l,isInline:c,isValid:d,overlay:u,value:m,withTags:h=!1}){const{accountIndex:p,isNull:g,name:f,onSaveName:b,onSaveTags:x,setName:A,setTags:v,tags:w}=(0,M.B)(m?m.toString():null,r),y=!g&&(d||m||p),j=m?Ke:Oe.ZP,k=m&&y?m:Sa;return(0,a.jsxs)(Ia,{address:k,buttons:e,className:n,defaultName:s,icon:(0,a.jsx)(j,{size:32,value:m?m.toString():null}),isDisabled:o,isEditableName:l,isEditableTags:!0,isInline:c,isShortAddr:!i,name:f,onChangeName:A,onChangeTags:v,onSaveName:b,onSaveTags:x,tags:h?w:void 0,children:[t,u]})})),Da=v.z.div`
  align-items: flex-start;
...
`,As=s.memo((function({className:e="",isDisabled:t,label:n,onChange:i,value:r}){const o=(0,s.useCallback)((()=>{!t&&i&&i(!r)}),[t,i,r]);return(0,a.jsxs)(xs,{className:`${e} ui--Checkbox ${t?"isDisabled":""}`,onClick:o,children:[(0,a.jsx)(A.Z,{color:r?"normal":"transparent",icon:"check"}),n&&(0,a.jsx)("label",{children:n})]})})),vs="750px",ws="550px",ys="\n  display: flex;\n  flex-wrap: wrap;\n\n  &.is50 {\n    > .ui--Column {\n      max-width: 50%;\n      min-width: 50%;\n    }\n  }\n\n  &.is60 {\n    > .ui--Column:first-child {\n      max-width: 60%;\n      min-width: 60%;\n    }\n\n    > .ui--Column:last-child {\n      max-width: 40%;\n      min-width: 40%;\n    }\n  }\n\n  &.is100 {\n    > .ui--Column {\n      max-width: 100%;\n      min-width: 100%;\n    }\n  }\n",js=v.z.div`
  &.isReverse {
...
`,Ms=s.memo((function({className:e="",colSpan:t,isExpanded:n,rowSpan:s,toggle:i}){return(0,a.jsx)(Ts,{className:`${e} ui--Table-Column-Expand`,colSpan:t,onClick:i,rowSpan:s,children:(0,a.jsx)("div",{children:(0,a.jsx)(A.Z,{icon:n?"caret-up":"caret-down"})})})})),Fs=v.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1rem;
...
`,zs=s.memo((function({address:e,className:t="",colSpan:n,isFavorite:i,rowSpan:r,toggle:o}){const l=(0,s.useCallback)((()=>o(e)),[e,o]);return(0,a.jsx)(Fs,{className:`${t} ui--Table-Column-Favorite`,colSpan:n,onClick:l,rowSpan:r,children:(0,a.jsx)(A.Z,{color:i?"orange":"gray",icon:"star"})})})),Zs=`${7.15.toFixed(3)}ch`,Rs=v.z.td`
  && {
    box-sizing: content-box;
    min-width: ${Zs};
    text-align: right;
...
`,Ws=s.memo((function({className:e="",footer:t,isEmpty:n}){return!t||n?null:(0,a.jsx)(Os,{className:`${e} ui--Table-Foot`,children:t})})),Gs=v.z.thead`
  z-index: 1;
...
`,oi=s.memo((function({className:e="",filterOn:t,label:n,setFilter:s}){return(0,a.jsx)(ri,{className:e,children:(0,a.jsx)(_t.ZP,{autoFocus:!0,isFull:!0,label:n,onChange:s,value:t})})})),li=v.z.div`
  display: none;
...
`;s.memo((function({className:e="",md:t}){const[n,s]=(0,de.O)();return(0,a.jsxs)(fi,{className:`${e} ui--HelpOverlay`,children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(A.Z,{icon:"question-circle",onClick:s})}),(0,a.jsxs)("div",{className:"help-slideout "+(n?"open":"closed"),children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(A.Z,{icon:"times",onClick:s})}),(0,a.jsx)(pi.U,{className:"help-content",rehypePlugins:gi,children:t})]})]})}));const bi=(0,v.z)(pn.Z)`
  background: white;
...
`,Vr=s.memo((function({className:e="",value:t}){const{t:n}=(0,z.$)(),s={width:100*function(e){const t=Lr().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Pr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})})),Tr=v.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
`,Mr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:s,onClick:i,options:r,sortDirection:o}){return(0,a.jsxs)(Tr,{className:`${e} ui--Sort`,children:[(0,a.jsx)(Xt.Z,{defaultValue:t,label:n,onChange:s,options:r}),(0,a.jsxs)("button",{onClick:i,children:[(0,a.jsx)(A.Z,{className:"arrow up"+("ascending"===o?" isActive":""),color:"gray",icon:"sort-up"}),(0,a.jsx)(A.Z,{className:"arrow down"+("descending"===o?" isActive":""),color:"gray",icon:"sort-down"})]})]})})),Fr=s.memo((function({className:e="",stakingInfo:t}){const n=t?.stakingLedger?.active?.unwrap();return n?.gtn(0)?(0,a.jsx)(ee.Z,{className:e,value:n}):null}));var zr=n(56245);function Zr(e){switch(e){case"error":return"ban";case"event":case"eventWarn":return"assistive-listening-systems";case"received":return"telegram-plane";default:return"check"}}function Rr({account:e,action:t,id:n,message:s,removeItem:i,status:r}){return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[(0,a.jsx)(A.Z,{icon:"times",onClick:i}),(0,a.jsx)("div",{className:"short",children:(0,a.jsx)(A.Z,{icon:Zr(r)})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsx)("div",{className:"header",children:Array.isArray(t)?t.map(((e,t)=>(0,a.jsx)("div",{children:e},t))):t}),e&&(0,a.jsx)(ot,{value:e}),(0,a.jsx)("div",{className:"status",children:s})]})]})})},n)}function $r({error:e,extrinsic:t,id:n,removeItem:s,rpc:i,status:r}){let{method:o,section:l}=i;if(t){const e=t.registry.findMetaCall(t.callIndex);"unknown"!==e.section&&(o=e.method,l=e.section)}const c=function(e){switch(e){case"cancelled":return"ban";case"completed":case"inblock":case"finalized":case"sent":return"check";case"dropped":case"invalid":case"usurped":return"arrow-down";case"error":case"finalitytimeout":return"exclamation-triangle";case"queued":return"random";default:return"spinner"}}(r);return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[zr.z.includes(r)&&(0,a.jsx)(A.Z,{icon:"times",onClick:s}),(0,a.jsx)("div",{className:"short",children:"spinner"===c?(0,a.jsx)(q,{variant:"push"}):(0,a.jsx)(A.Z,{icon:c})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsxs)("div",{className:"header",children:[l,".",o]}),(0,a.jsx)("div",{className:"status",children:e?e.message||e.toString():r})]})]})})},n)}const Hr=v.z.div`
  display: inline-block;
  overflow: hidden;
  position: fixed;
  right: 0.75rem;
...
`,Qr=s.memo((function({children:e,className:t="",isSmall:n}){return(0,a.jsx)(Ur,{className:`${t}${n?" isSmall":""}`,children:e})}));var Or=n(73557),Wr=n(59149);const Gr=v.z.div`
...
`,Jr=s.memo((function({className:e="",icon:t,text:n}){return(0,a.jsxs)(Gr,{className:`${e} active-tab`,children:[(0,a.jsx)(A.Z,{icon:t}),(0,a.jsx)("span",{children:n})]})}));var Kr=n(39857);const Yr=(0,v.z)(Kr.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,Xr=s.memo((function({basePath:e,className:t="",count:n,hasParams:s,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!s||0===i;return(0,a.jsxs)(Yr,{className:`${t} ui--Tab`,end:u,to:d,children:[(0,a.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,a.jsx)(k,{className:"tabCounter",color:"counter",info:n})]})})),_r=v.z.div`
  height: 100%;
  width: auto;
`,eo=s.memo((function({className:e=""}){return(0,a.jsx)(_r,{className:e,children:(0,a.jsx)("svg",{fill:"none",height:"47",viewBox:"0 0 17 65",width:"17",xmlns:"http://www.w3.org/2000/svg",children:(0,a.jsx)("path",{className:"highlight--stroke",d:"M1 1L16 32.5L1 64",stroke:"#D1D1D1"})})})})),to=v.z.header`
  background: var(--bg-tabs);
...
`,no=s.memo((function({basePath:e,className:t="",hidden:n,items:i}){const r=(0,Or.TH)(),{icon:o,text:l}=s.useContext(Wr.m),c=(0,s.useMemo)((()=>i.filter((e=>!(!e||n&&n.includes(e.name))))),[n,i]);return(0,s.useEffect)((()=>function(e,t,n,a){if(t.pathname!==e){const[,,s]=t.pathname.split("/"),i=n.find((e=>e&&e.alias===s));i?window.location.hash=i.isRoot?e:`${e}/${i.name}`:!a||!a.includes(s)&&n.some((e=>e&&!e.isRoot&&e.name===s))||(window.location.hash=e)}}(e,r,i,n)),[e,n,i,r]),(0,a.jsx)(to,{className:`${t} ui--Tabs`,children:(0,a.jsxs)("div",{className:"tabs-container",children:[l&&o&&(0,a.jsx)(Jr,{icon:o,text:l}),(0,a.jsx)(eo,{}),(0,a.jsx)("ul",{className:"ui--TabsList",children:c.map(((t,n)=>(0,a.jsx)("li",{className:t.isHidden?"--hidden":"",children:(0,s.createElement)(Xr,{...t,basePath:e,index:n,key:t.name})},n)))})]})})})),ao=(0,v.z)(pn.Z)`

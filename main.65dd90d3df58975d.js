...
`,Hn=u.memo((function({className:e}){const n=(0,Z.TH)(),{t}=zn(),{api:r,isApiConnected:o,isApiReady:s,isDevelopment:a}=(0,S.h)(),{queueAction:l}=(0,Nn.L)(),{Component:c,display:{needsApi:p,needsApiCheck:d,needsApiInstances:m},icon:g,name:h,text:x}=(0,u.useMemo)((()=>{const e=n.pathname.slice(1)||"";return jn(t).find((n=>n&&e.startsWith(n.name)&&(a||!n.display.isDevelopment)))||Pn}),[a,n,t]),v=(0,u.useMemo)((()=>p?s&&o?$n(r,p,m,d):null:[]),[r,o,s,p,d,m]);return(0,i.jsx)(Dn,{className:e,children:v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(u.Suspense,{fallback:"...",children:(0,i.jsx)(An.SV,{trigger:h,children:(0,i.jsx)(An.mO.Provider,{value:{icon:g,text:x},children:v.length?(0,i.jsx)(Rn,{basePath:`/${h}`,location:n,missingApis:v,onStatusChange:l}):(0,i.jsx)(c,{basePath:`/${h}`,location:n,onStatusChange:l})})})}),(0,i.jsx)(Mn,{})]}):(0,i.jsx)("div",{className:"connecting",children:(0,i.jsx)(An.$j,{label:t("Initializing connection")})})})}));var Ln=t(41411),Bn=t(38894),Xn=t(12176),Fn=t(95689),_n=t(68058),Jn=t(10072),Vn=t(70676);const Gn=(0,An.zo)(An.ZD)`
  padding: 0.25rem;
  text-align: right;
...
`,Kn=u.memo((function({apiUrl:e,className:n,label:t,setApiUrl:r,url:o}){const s=(0,u.useCallback)((()=>r(o)),[r,o]);return(0,i.jsx)(Gn,{className:n,isRadio:!0,label:t,onChange:s,value:e===o})})),Yn=An.zo.div`
...
`,nt=u.memo((function({affinities:e,apiUrl:n,children:t,className:r="",index:o,isSelected:s,setApiUrl:a,setGroup:l,value:{header:c,isSpaced:p,networks:d}}){const m=(0,u.useCallback)((()=>l(s?-1:o)),[o,s,l]),g=(0,u.useMemo)((()=>d.filter((({isUnreachable:e})=>!e))),[d]);return(0,i.jsxs)(et,{className:`${r}${s?" isSelected":""}`,children:[(0,i.jsxs)("div",{className:"groupHeader"+(p?" isSpaced":""),onClick:m,children:[(0,i.jsx)(An.JO,{icon:s?"caret-up":"caret-down"}),c]}),s&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("div",{className:"groupNetworks",children:g.map(((t,r)=>(0,i.jsx)(Qn,{affinity:e[t.name],apiUrl:n,setApiUrl:a,value:t},r)))}),t]})]})})),tt="network:affinities";function it(e){return e.reduce(((e,n)=>{if(n.isHeader)e.push({header:n.text,isDevelopment:n.isDevelopment,isSpaced:n.isSpaced,networks:[]});else{const t=e[e.length-1],i={isLightClient:n.isLightClient,name:n.textBy,url:n.value};t.networks[t.networks.length-1]&&n.text===t.networks[t.networks.length-1].name?t.networks[t.networks.length-1].providers.push(i):n.isUnreachable||t.networks.push({isChild:n.isChild,isRelay:!!n.genesisHash,name:n.text,nameRelay:n.textRelay,paraId:n.paraId,providers:[i],ui:n.ui})}return e}),[])}function rt(){try{const e=localStorage.getItem(Jn.ie);if(e)return JSON.parse(e)}catch(e){console.error(e)}return[]}function ot(e,n){let t=n.findIndex((({networks:n})=>n.some((({providers:n})=>n.some((({url:n})=>n===e))))));return-1===t&&(t=n.findIndex((({isDevelopment:e})=>e))),{apiUrl:e,groupIndex:t,hasUrlChanged:c.X.get().apiUrl!==e,isUrlValid:(i=e,i.length>=7&&(i.startsWith("ws://")||i.startsWith("wss://")||i.startsWith("light://")))};var i}const st=(0,An.zo)(An.YE)`
...
`,at=u.memo((function({className:e="",offset:n,onClose:t}){const{t:r}=zn(),o=(0,a.Rf)(r),[l,p]=(0,u.useState)((()=>it(o))),[{apiUrl:d,groupIndex:m,hasUrlChanged:g,isUrlValid:h},x]=(0,u.useState)((()=>ot(c.X.get().apiUrl,l))),[v,f]=(0,u.useState)((()=>rt())),[y,b]=(0,u.useState)((()=>function(e){return Object.entries(s().get(tt)||{}).filter((([n,t])=>e.some((({networks:e})=>e.some((({name:e,providers:i})=>e===n&&i.some((({url:e})=>e===t)))))))).reduce(((e,[n,t])=>({...e,[n]:t})),{})}(l))),k=(0,u.useRef)(null),w=(0,u.useMemo)((()=>{let e=!1;return o.some((n=>n.value===d&&(e=!0,!0))),e}),[d,o]),C=(0,u.useMemo)((()=>{let e=!1;return v.some((n=>n===d&&(e=!0,!0))),e}),[d,v]),j=(0,u.useCallback)((e=>x((n=>({...n,groupIndex:e})))),[]),A=(0,u.useCallback)((()=>{if(!C)return;const e=v.filter((e=>e!==d));try{localStorage.setItem(Jn.ie,JSON.stringify(e)),p(it((0,a.Rf)(r))),f(rt())}catch(e){console.error(e)}}),[d,C,v,r]),N=(0,u.useCallback)(((e,n)=>{b((t=>{const i={...t,[e]:n};return s().set(tt,i),i})),x(ot(n,l))}),[l]),S=(0,u.useCallback)((e=>{(0,Vn._)(e)||(e=_n.ZP.toASCII(e)),x(ot(e,l))}),[l]),I=(0,u.useCallback)((()=>{c.X.set({...c.X.get(),apiUrl:d}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(d)}${window.location.hash}`),t()}),[d,t]),Z=(0,u.useCallback)((()=>{try{localStorage.setItem(Jn.ie,JSON.stringify([...v,d])),I()}catch(e){console.error(e)}}),[I,d,v]),$=(0,u.useMemo)((()=>function(e,n,t){return!e||!n.startsWith("light://")&&!t}(g,d,h)),[g,d,h]);return(0,i.jsx)(st,{button:(0,i.jsx)(An.zx,{icon:"sync",isDisabled:$,label:r("Switch"),onClick:I}),className:e,offset:n,onClose:t,position:"left",sidebarRef:k,children:l.map(((e,n)=>(0,i.jsx)(nt,{affinities:y,apiUrl:d,index:n,isSelected:m===n,setApiUrl:N,setGroup:j,value:e,children:e.isDevelopment&&(0,i.jsxs)("div",{className:"endpointCustomWrapper",children:[(0,i.jsx)(An.II,{className:"endpointCustom",isError:!h,isFull:!0,label:r("custom endpoint"),onChange:S,value:d}),C?(0,i.jsx)(An.zx,{className:"customButton",icon:"trash-alt",onClick:A}):(0,i.jsx)(An.zx,{className:"customButton",icon:"save",isDisabled:!h||w,onClick:Z})]})},n)))})})),lt=An.zo.div`
...
`,ct=u.memo((function({className:e}){const{api:n,isApiReady:t}=(0,S.h)(),r=(0,Wn.W7)(t&&n.rpc.state.subscribeRuntimeVersion),{ipnsChain:o}=(0,l.g)(),[s,a]=(0,Bn.O)(),c=!o;return(0,i.jsxs)(lt,{className:e,children:[(0,i.jsxs)("div",{className:`apps--SideBar-logo-inner${c?" isClickable":""} highlight--color-contrast`,onClick:a,children:[(0,i.jsx)(An.Mj,{}),(0,i.jsxs)("div",{className:"info media--1000",children:[(0,i.jsx)(Xn.Z,{className:"chain"}),r&&(0,i.jsxs)("div",{className:"runtimeVersion",children:[r.specName.toString(),"/",r.specVersion.toNumber()]}),(0,i.jsx)(Fn.Z,{className:"bestNumber",label:"#"})]}),c&&(0,i.jsx)(An.JO,{className:"dropdown",icon:s?"caret-right":"caret-down"})]}),s&&(0,i.jsx)(at,{onClose:a})]})})),pt=()=>0,dt=An.zo.li`
  cursor: pointer;
  position: relative;
  white-space: nowrap;
...
`,ut=u.memo((function({className:e="",classNameText:n,isLink:t,isToplevel:r,route:{Modal:o,href:s,icon:a,name:l,text:c,useCounter:p=pt}}){const[d,u]=(0,Bn.O)(),m=p();return(0,i.jsxs)(dt,{className:`${e} ui--MenuItem ${m?"withCounter":""} ${t?"isLink":""} ${r?"topLevel highlight--color-contrast":""}`,children:[(0,i.jsxs)("a",{href:o?void 0:s||`#/${l}`,onClick:o?u:void 0,rel:"noopener noreferrer",target:s?"_blank":void 0,children:[(0,i.jsx)(An.JO,{icon:a}),(0,i.jsx)("span",{className:n,children:c}),!!m&&(0,i.jsx)(An.Ct,{color:"white",info:m})]}),o&&d&&(0,i.jsx)(o,{onClose:u})]})})),mt="rgba(34, 36, 38, 0.12)",gt="5px",ht=An.zo.li`
  cursor: pointer;
  position: relative;
...
`,xt=u.memo((function({className:e="",isActive:n,name:t,routes:r}){return 1===r.length&&"settings"===r[0].group?(0,i.jsx)(ut,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:r[0]}):(0,i.jsxs)(ht,{className:`${e} ${n?"isActive":""}`,children:[(0,i.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,i.jsx)("span",{className:"smallHide",children:t}),(0,i.jsx)(An.JO,{className:"smallShow",icon:r[0].icon}),(0,i.jsx)(An.JO,{icon:"caret-down"})]}),(0,i.jsx)("ul",{className:"groupMenu",children:r.map((e=>(0,i.jsx)(ut,{route:e},e.name)))})]})}));var vt=t(39082),ft=t(52727);const yt=`apps v${"0.124.2-131-x".replace("-x","")}`,bt=An.zo.div`
...
`,At=u.memo((function({children:e,className:n="",icon:t,type:r}){const[o,s]=(0,Bn.O)();return o?null:(0,i.jsx)(jt,{className:`${n} ${"error"===r?"isError":"isInfo"}`,children:(0,i.jsxs)("div",{className:"content",children:[(0,i.jsx)(An.JO,{className:"contentIcon",icon:t,size:"2x"}),(0,i.jsx)("div",{className:"contentItem",children:e}),(0,i.jsx)(An.zx,{className:"closeIcon",icon:"times",isBasic:!0,isCircular:!0,onClick:s})]})})})),Nt=c.X.apiType.param,St="json-rpc"===c.X.apiType.type&&"string"==typeof Nt&&Nt.startsWith("ws://"),It="string"==typeof Nt&&Nt.includes("127.0.0.1"),Zt=window.location.protocol.startsWith("https:"),$t=u.memo((function({className:e}){const{t:n}=zn(),{apiError:t,isApiConnected:r,isApiReady:o,isWaitingInjected:s}=(0,S.h)();return t?(0,i.jsx)(At,{className:e,icon:"globe",type:"error",children:(0,i.jsx)("div",{children:t})}):o?s?(0,i.jsx)(At,{className:e,icon:"puzzle-piece",type:"info",children:(0,i.jsx)("div",{children:n("Waiting for authorization from the extension. Please open the installed extension and approve or reject access.")})}):r?null:(0,i.jsxs)(At,{className:e,icon:"globe",type:"error",children:[(0,i.jsx)("div",{children:n("You are not connected to a node. Ensure that your node is running and that the Websocket endpoint is reachable.")}),St&&!It&&Zt?(0,i.jsx)("div",{children:n("You are connecting from a secure location to an insecure WebSocket ({{wsUrl}}). Due to browser mixed-content security policies this connection type is not allowed. Change the RPC service to a secure 'wss' endpoint.",{replace:{wsUrl:Nt}})}):void 0]}):(0,i.jsx)(At,{className:e,icon:"globe",type:"info",children:(0,i.jsx)("div",{children:n(r?"Waiting to complete metadata retrieval from remote endpoint.":"Waiting to establish a connection with the remote endpoint.")})})})),Ut=u.memo((function(){const{api:e,isApiReady:n}=(0,S.h)(),t=(0,Wn.W7)(n&&e.derive.accounts?.indexes),r=(0,Wn.W7)(n&&e.query.identity?.registrars),o=(0,Wn.W7)(n&&e.query.balances?.totalIssuance),[s,a]=(0,u.useState)(!1);return(0,u.useEffect)((()=>{a(!!t||!!o||!!r)}),[]),(0,i.jsx)("div",{className:`apps--api-warm ${s.toString()}`})})),zt=j.z.div`
  background: var(--bg-page);
  box-sizing: border-box;
  display: flex;

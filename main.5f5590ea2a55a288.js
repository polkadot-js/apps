...
`,wt=g.memo((function({className:e="",isActive:n,name:t,routes:r}){return 1===r.length&&"settings"===r[0].group?(0,i.jsx)(vt,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:r[0]}):(0,i.jsxs)(kt,{className:`${e} ${n?"isActive":""}`,children:[(0,i.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,i.jsx)("span",{className:"smallHide",children:t}),(0,i.jsx)(A.JO,{className:"smallShow",icon:r[0].icon}),(0,i.jsx)(A.JO,{icon:"caret-down"})]}),(0,i.jsx)("ul",{className:"groupMenu",children:r.map((e=>(0,i.jsx)(vt,{route:e},e.name)))})]})}));var Ct=t(39082),jt=t(52727);const At=`apps v${"0.135.2-7-x".replace("-x","")}`,Nt=A.zo.div`

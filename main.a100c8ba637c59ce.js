...
`,Kn=u.memo((function({apiUrl:e,className:n,label:t,setApiUrl:o,url:r}){const s=(0,u.useCallback)((()=>o(r)),[o,r]);return(0,i.jsx)(Gn,{className:n,isRadio:!0,label:t,onChange:s,value:e===r})})),Yn=C.zo.div`
...
`,nt=u.memo((function({affinities:e,apiUrl:n,children:t,className:o="",index:r,isSelected:s,setApiUrl:a,setGroup:l,value:{header:c,isSpaced:p,networks:d}}){const m=(0,u.useCallback)((()=>l(s?-1:r)),[r,s,l]),g=(0,u.useMemo)((()=>d.filter((({isUnreachable:e})=>!e))),[d]);return(0,i.jsxs)(et,{className:`${o}${s?" isSelected":""}`,children:[(0,i.jsxs)("div",{className:"groupHeader"+(p?" isSpaced":""),onClick:m,children:[(0,i.jsx)(C.JO,{icon:s?"caret-up":"caret-down"}),c]}),s&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("div",{className:"groupNetworks",children:g.map(((t,o)=>(0,i.jsx)(Qn,{affinity:e[t.name],apiUrl:n,setApiUrl:a,value:t},o)))}),t]})]})})),tt="network:affinities";function it(e){return e.reduce(((e,n)=>{if(n.isHeader)e.push({header:n.text,isDevelopment:n.isDevelopment,isSpaced:n.isSpaced,networks:[]});else{const t=e[e.length-1],i={isLightClient:n.isLightClient,name:n.textBy,url:n.value};t.networks[t.networks.length-1]&&n.text===t.networks[t.networks.length-1].name?t.networks[t.networks.length-1].providers.push(i):n.isUnreachable||t.networks.push({isChild:n.isChild,isRelay:!!n.genesisHash,name:n.text,nameRelay:n.textRelay,paraId:n.paraId,providers:[i],ui:n.ui})}return e}),[])}function ot(){try{const e=localStorage.getItem(Vn.ie);if(e)return JSON.parse(e)}catch(e){console.error(e)}return[]}function rt(e,n){let t=n.findIndex((({networks:n})=>n.some((({providers:n})=>n.some((({url:n})=>n===e))))));return-1===t&&(t=n.findIndex((({isDevelopment:e})=>e))),{apiUrl:e,groupIndex:t,hasUrlChanged:c.X.get().apiUrl!==e,isUrlValid:(i=e,i.length>=7&&(i.startsWith("ws://")||i.startsWith("wss://")||i.startsWith("light://")))};var i}const st=(0,C.zo)(C.YE)`
...
`,ct=u.memo((function({className:e}){const{api:n,isApiReady:t}=(0,N.h)(),o=(0,Wn.W7)(t&&n.rpc.state.subscribeRuntimeVersion),{ipnsChain:r}=(0,l.g)(),[s,a]=(0,Fn.O)(),c=!r;return(0,i.jsxs)(lt,{className:e,children:[(0,i.jsxs)("div",{className:`apps--SideBar-logo-inner${c?" isClickable":""} highlight--color-contrast`,onClick:a,children:[(0,i.jsx)(C.Mj,{}),(0,i.jsxs)("div",{className:"info media--1000",children:[(0,i.jsx)(Ln.Z,{className:"chain"}),o&&(0,i.jsxs)("div",{className:"runtimeVersion",children:[o.specName.toString(),"/",o.specVersion.toNumber()]}),(0,i.jsx)(Xn.Z,{className:"bestNumber",label:"#"})]}),c&&(0,i.jsx)(C.JO,{className:"dropdown",icon:s?"caret-right":"caret-down"})]}),s&&(0,i.jsx)(at,{onClose:a})]})})),pt=()=>0,dt=C.zo.li`
  cursor: pointer;
  position: relative;
  white-space: nowrap;
...
`,ut=u.memo((function({className:e="",classNameText:n,isLink:t,isToplevel:o,route:{Modal:r,href:s,icon:a,name:l,text:c,useCounter:p=pt}}){const[d,u]=(0,Fn.O)(),m=p();return(0,i.jsxs)(dt,{className:`${e} ui--MenuItem ${m?"withCounter":""} ${t?"isLink":""} ${o?"topLevel highlight--color-contrast":""}`,children:[(0,i.jsxs)("a",{href:r?void 0:s||`#/${l}`,onClick:r?u:void 0,rel:"noopener noreferrer",target:s?"_blank":void 0,children:[(0,i.jsx)(C.JO,{icon:a}),(0,i.jsx)("span",{className:n,children:c}),!!m&&(0,i.jsx)(C.Ct,{color:"white",info:m})]}),r&&d&&(0,i.jsx)(r,{onClose:u})]})})),mt="rgba(34, 36, 38, 0.12)",gt="5px",ht=C.zo.li`
  cursor: pointer;
  position: relative;
...
`,xt=u.memo((function({className:e="",isActive:n,name:t,routes:o}){return 1===o.length&&"settings"===o[0].group?(0,i.jsx)(ut,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:o[0]}):(0,i.jsxs)(ht,{className:`${e} ${n?"isActive":""}`,children:[(0,i.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,i.jsx)("span",{className:"smallHide",children:t}),(0,i.jsx)(C.JO,{className:"smallShow",icon:o[0].icon}),(0,i.jsx)(C.JO,{icon:"caret-down"})]}),(0,i.jsx)("ul",{className:"groupMenu",children:o.map((e=>(0,i.jsx)(ut,{route:e},e.name)))})]})}));var vt=t(39082),ft=t(52727);const yt=`apps v${"0.132.2-129-x".replace("-x","")}`,bt=C.zo.div`

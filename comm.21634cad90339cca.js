...
`,mn=i.memo((function({className:e="",isDisabled:t,label:n,onChange:a,value:r}){const o=(0,i.useCallback)((()=>{!t&&a&&a(!r)}),[t,a,r]);return(0,s.jsxs)(un,{className:`${e} ui--Checkbox ${t?"isDisabled":""}`,onClick:o,children:[(0,s.jsx)(v.Z,{color:r?"normal":"transparent",icon:"check"}),n&&(0,s.jsx)("label",{children:n})]})})),hn="750px",pn="550px",gn="\n  display: flex;\n  flex-wrap: wrap;\n\n  &.is50 {\n    > .ui--Column {\n      max-width: 50%;\n      min-width: 50%;\n    }\n  }\n\n  &.is60 {\n    > .ui--Column:first-child {\n      max-width: 60%;\n      min-width: 60%;\n    }\n\n    > .ui--Column:last-child {\n      max-width: 40%;\n      min-width: 40%;\n    }\n  }\n\n  &.is100 {\n    > .ui--Column {\n      max-width: 100%;\n      min-width: 100%;\n    }\n  }\n",fn=A.z.div`
  &.isReverse {
...
`,Zn=i.memo((function({className:e="",colSpan:t,isExpanded:n,rowSpan:a,toggle:i}){return(0,s.jsx)(Pn,{className:`${e} ui--Table-Column-Expand`,colSpan:t,onClick:i,rowSpan:a,children:(0,s.jsx)("div",{children:(0,s.jsx)(v.Z,{icon:n?"caret-up":"caret-down"})})})})),Tn=A.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1rem;
...
`,zn=i.memo((function({address:e,className:t="",colSpan:n,isFavorite:a,rowSpan:r,toggle:o}){const l=(0,i.useCallback)((()=>o(e)),[e,o]);return(0,s.jsx)(Tn,{className:`${t} ui--Table-Column-Favorite`,colSpan:n,onClick:l,rowSpan:r,children:(0,s.jsx)(v.Z,{color:a?"orange":"gray",icon:"star"})})})),Mn=`${7.15.toFixed(3)}ch`,Fn=A.z.td`
  && {
    box-sizing: content-box;
    min-width: ${Mn};
    text-align: right;
    white-space: nowrap;
    width: ${Mn};
`,Hn=i.memo((function({children:e,className:t="",colSpan:n,rowSpan:a,value:i}){return(0,s.jsxs)(Fn,{className:`${t} ui--Table-Column-Id`,colSpan:n,rowSpan:a,children:[(0,s.jsx)("h2",{className:"--digits",children:(0,p.u)(i)}),e]})})),Rn=i.memo((function({children:e,className:t=""}){return(0,s.jsx)("td",{className:`${t} ui--Table-Column`,children:e})}));Rn.Balance=Vn,Rn.Expand=Zn,Rn.Favorite=zn,Rn.Id=Hn;const Un=Rn,qn=i.memo((function({children:e,className:t=""}){return(0,s.jsx)("tr",{className:`${t} ui--Table-Row`,children:e})}));var On=n(48166);const Wn=i.memo((function({children:e,className:t="",empty:n,emptySpinner:a,isEmpty:i,noBodyTag:r}){const o=`${t} ui--Table-Body`;return i?(0,s.jsx)("tbody",{className:o,children:(0,s.jsx)("tr",{children:(0,s.jsx)("td",{colSpan:100,children:(0,xt.H)(n)?(0,s.jsx)("div",{className:"empty",children:n}):n||(0,s.jsx)(On.Z,{label:a})})})}):r?(0,s.jsx)(s.Fragment,{children:e}):(0,s.jsx)("tbody",{className:o,children:e})})),Qn=A.z.tfoot`
  td {
...
`,Kn=i.memo((function({className:e="",footer:t,isEmpty:n}){return!t||n?null:(0,s.jsx)(Qn,{className:`${e} ui--Table-Foot`,children:t})})),Gn=A.z.thead`
  z-index: 1;
...
`,Jn=i.memo((function({children:e,className:t="",filter:n,header:a,isEmpty:i}){return a?.length?(0,s.jsxs)(Gn,{className:`${t} ui--Table-Head`,children:[n&&(0,s.jsx)("tr",{className:"filter",children:(0,s.jsx)("th",{colSpan:100,children:n})}),(0,s.jsx)("tr",{children:a.filter((e=>!!e)).map((([e,t="default",n=1,a],r)=>(0,s.jsx)("th",{className:t,colSpan:n,onClick:a,children:0===r?(0,s.jsx)("h1",{children:e}):!i&&e&&(0,s.jsx)("label",{children:e})},r)))}),e]}):null})),Yn={2:[0,1],3:[0,1,2]},Xn="0.125rem solid var(--bg-page)",_n="0.25rem solid var(--bg-page)",ea="0.5rem",ta=A.z.div`
  max-width: 100%;
  width: 100%;
...
`,na=i.memo((function({children:e,className:t="",empty:n,emptySpinner:a,filter:i,footer:r,header:o,headerChildren:l,isFixed:c,isInline:d,isSplit:u,legend:m,maxColumns:h,noBodyTag:p}){const g=$n(h),f=Array.isArray(e),b=!e||f&&0===e.length,x=(0,s.jsx)(Jn,{filter:i,header:o,isEmpty:b,children:l});return u&&f&&!b&&1!==g?(0,s.jsxs)(ta,{className:`${t} ui--Table isSplit`,children:[m,(0,s.jsx)("table",{className:"noMargin",children:x}),(0,s.jsx)("div",{className:"ui--Table-Split",children:Yn[g].map((t=>(0,s.jsx)("div",{className:`ui--Table-Split-${g}`,children:(0,s.jsx)("table",{className:"noMargin",children:(0,s.jsx)("tbody",{className:"ui--Table-Body",children:e.filter(((e,n)=>n%g===t))})})},t)))})]}):(0,s.jsxs)(ta,{className:`${t} ui--Table`,children:[m,(0,s.jsxs)("table",{className:`${c&&!b?"isFixed":"isNotFixed"} ${d?"isInline":""}`,children:[x,(0,s.jsx)(Wn,{empty:n,emptySpinner:a,isEmpty:b,noBodyTag:p,children:e}),(0,s.jsx)(Kn,{footer:r,isEmpty:b})]})]})}));na.Column=Un,na.Row=qn;const aa=na;function sa(e,t){return(0,s.jsx)("tr",{children:(0,s.jsx)("td",{children:e})},t)}const ia=(0,A.z)(Y)`
  .tableContainer {
    overflow-y: scroll;
    display: block;
    margin: 0 0 0 auto;
...
`,ja=i.memo((function({children:e,className:t}){return(0,s.jsx)(ya,{className:t,children:e})}));var ka=n(17608);const Na=(0,A.z)(ka.Z)`
...
`;i.memo((function({className:e="",md:t}){const[n,a]=(0,G.O)();return(0,s.jsxs)(Va,{className:`${e} ui--HelpOverlay`,children:[(0,s.jsx)("div",{className:"help-button",children:(0,s.jsx)(v.Z,{icon:"question-circle",onClick:a})}),(0,s.jsxs)("div",{className:"help-slideout "+(n?"open":"closed"),children:[(0,s.jsx)("div",{className:"help-button",children:(0,s.jsx)(v.Z,{icon:"times",onClick:a})}),(0,s.jsx)(La.D,{className:"help-content",rehypePlugins:$a,children:t})]})]})}));const Pa=A.z.a`
  .ui--Icon {
    margin-right: 0.5em;
  }
`,Za=i.memo((function({className:e="",href:t,icon:n,label:a,onClick:i,rel:r,target:o}){return(0,s.jsxs)(Pa,{className:e,href:t,onClick:i,rel:r,target:o,children:[n&&(0,s.jsx)(v.Z,{icon:n}),a]})})),Ta=(0,A.z)(yt.Z)`
  background: white;
...
`,za=i.memo((function({children:e,className:t="",type:n="info"}){return(0,s.jsx)(Ta,{children:(0,s.jsx)("div",{className:`${t} ${n}`,children:e})})}));var Ma=n(55858);const Fa=(0,A.z)(yt.Z)`
...
`;i.memo((function({children:e,className:t="",header:n,href:a,isCollapsible:r,isError:o,isSuccess:l,withBottomMargin:c,withTopMargin:d}){const u=(0,oi.k6)(),[m,h]=(0,G.O)(),p=(0,i.useCallback)((()=>{a&&u.push(a)}),[u,a]);return e?(0,s.jsxs)(li,{className:`${t} ui--Inset ${a?"as-link":""} ${r?"collapsible":""} ${o&&!l?"error":""} ${!o&&l?"success":""} ${c?"bottom-margin":""} ${d?"top-margin":""}`,children:[r&&(0,s.jsxs)("div",{className:"header",onClick:h,children:[(0,s.jsx)("h2",{children:n}),(0,s.jsx)(v.Z,{className:m?"collapsed":"",icon:"angle-up"})]}),(0,s.jsx)("div",{className:"children"+(r&&m?" collapsed":""),onClick:p,children:e})]}):null}));let ci=0;const di=A.z.div`
  cursor: help;
  display: inline-block;
  line-height: 1rem;
  margin: 0 0 0 0.25rem;
`,ui=i.memo((function({className:e="",help:t,icon:n="question-circle"}){const[a]=(0,i.useState)((()=>"label-help-"+ ++ci));return(0,s.jsxs)(di,{className:`${e} ui--LabelHelp`,tabIndex:-1,children:[(0,s.jsx)(v.Z,{icon:n,tooltip:a}),(0,s.jsx)(w.Z,{text:t,trigger:a})]})}));var mi=n(31530);function hi(e,{data:t,hash:n,isText:a,type:i}){return Object.entries(mi.N).map((([r,{chains:o,create:l,homepage:c,isActive:d,paths:u,ui:m}])=>{const h=o[e],p=u[i];return d&&h&&p?(0,s.jsx)("a",{href:l(h,p,t,n),rel:"noopener noreferrer",target:"_blank",title:`${r}, ${c}`,children:a?r:(0,s.jsx)("img",{src:m.logo})},r):null})).filter((e=>!!e))}const pi=A.z.div`
  text-align: right;
...
`,vi=i.memo((function({className:e=""}){return(0,s.jsx)(xi,{className:`${e} ui--Menu__Divider`})})),Ai=A.z.div`
  color: var(--color-label);
  font-size: var(--font-size-tiny);
  line-height: 0.857rem;
  margin-bottom: 0.3rem;
`,wi=i.memo((function({children:e,className:t}){return(0,s.jsx)(Ai,{className:t,children:e})})),yi=A.z.div`
  align-items: center;
  cursor: pointer;
  display: flex;
  flex-direction: row;
...
`,ji=i.memo((function({children:e,className:t="",icon:n,isDisabled:a,label:r,onClick:o}){const l=(0,i.useCallback)((()=>{!a&&o&&Promise.resolve(o()).catch(console.error)}),[a,o]);return(0,s.jsxs)(yi,{className:`${t} ui--Menu__Item ${n?"hasIcon":""} ${a?"isDisabled":""}`,onClick:l,children:[n&&(0,s.jsx)(v.Z,{color:"darkGray",icon:n}),r,e]})})),ki=A.z.div`
  display: flex;
  flex-direction: column;
  min-width: 14.286rem;
  margin: 1rem 0;
...
`,Vi=i.memo((function({className:e="",value:t}){const{t:n}=(0,O.$)(),a={width:100*function(e){const t=Li().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,s.jsxs)($i,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,s.jsx)("div",{className:"ui--Strength-bar",children:(0,s.jsx)("div",{className:"ui--Strength-bar-highlighted",style:a})}),n("strong")]})}));var Pi=n(84450);const Zi=A.z.div`
  vertical-align: middle;
  white-space: nowrap;
...
`,cr=i.memo((function({children:e,className:t="",isSmall:n}){return(0,s.jsx)(lr,{className:`${t}${n?" isSmall":""}`,children:e})})),dr=A.z.div`
...
`,ur=i.memo((function({className:e="",icon:t,text:n}){return(0,s.jsxs)(dr,{className:`${e} active-tab`,children:[(0,s.jsx)(v.Z,{icon:t}),(0,s.jsx)("span",{children:n})]})}));var mr=n(26643);const hr=(0,A.z)(mr.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,pr=i.memo((function({basePath:e,className:t="",count:n,hasParams:a,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!a||0===i;return(0,s.jsxs)(hr,{activeClassName:"tabLinkActive",className:`${t} ui--Tab`,exact:u,strict:u,to:d,children:[(0,s.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,s.jsx)(k,{className:"tabCounter",color:"counter",info:n})]})})),gr=A.z.div`
  height: 100%;
  width: auto;
`,fr=i.memo((function({className:e=""}){return(0,s.jsx)(gr,{className:e,children:(0,s.jsx)("svg",{fill:"none",height:"47",viewBox:"0 0 17 65",width:"17",xmlns:"http://www.w3.org/2000/svg",children:(0,s.jsx)("path",{className:"highlight--stroke",d:"M1 1L16 32.5L1 64",stroke:"#D1D1D1"})})})})),br=i.createContext({}),xr=A.z.header`
...
`,Ir=i.memo((function({children:e,className:t,isError:n,isReadOnly:a,label:r,onChange:o,seed:l,withLabel:c}){const d=(0,i.useCallback)((({target:{value:e}})=>{o&&o(e)}),[o]);return(0,s.jsx)(Sr,{className:t,label:r,withLabel:c,children:(0,s.jsxs)("div",{className:"TextAreaWithDropdown",children:[(0,s.jsx)("textarea",{autoCapitalize:"off",autoCorrect:"off",autoFocus:!1,className:n?"ui-textArea-withError":"",onChange:d,readOnly:a,rows:2,spellCheck:!1,value:l}),e]})})})),Dr=A.z.div`
  ...
  border-radius: 4px;
  cursor: pointer;
`,Br=i.memo((function({className:e="",expanded:t,onClick:n}){return(0,s.jsx)(Dr,{className:`${e} ui--ExpandButton`,"data-testid":"row-toggle",onClick:n,children:(0,s.jsx)(v.Z,{icon:t?"caret-up":"caret-down"})})})),Lr=A.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;

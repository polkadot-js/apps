...
`,Tt=g.memo((function({className:e="",isActive:n,name:t,routes:i}){return 1===i.length&&"settings"===i[0].group?(0,r.jsx)(Zt,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:i[0]}):(0,r.jsxs)(Ut,{className:`${e} ${n?"isActive":""}`,children:[(0,r.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,r.jsx)("span",{className:"smallHide",children:t}),(0,r.jsx)(N.JO,{className:"smallShow",icon:i[0].icon}),(0,r.jsx)(N.JO,{icon:"caret-down"})]}),(0,r.jsx)("ul",{className:"groupMenu",children:i.map((e=>(0,r.jsx)(Zt,{route:e},e.name)))})]})}));var qt=t(66617),zt=t(39082),Wt=t(52727);const Et=(0,qt.v)(),Ot=N.zo.div`
...
`,Mt=g.memo((function({className:e=""}){const{api:n,isApiReady:t}=(0,Z.h)();return(0,r.jsxs)(Ot,{className:`${e} media--1400 highlight--color-contrast ui--NodeInfo`,children:[t&&(0,r.jsxs)("div",{className:"node",children:[(0,r.jsx)(zt.Z,{})," ",(0,r.jsx)(Wt.Z,{label:"v"})]}),(0,r.jsx)("div",{children:n.libraryInfo.replace("@polkadot/","")}),(0,r.jsx)("div",{children:Et})]})}));const Pt=N.zo.div`
  width: 100%;
  padding: 0;
  z-index: 220;
  position: relative;
...
`,Ft=g.memo((function({children:e,className:n="",icon:t,isBottom:i=!1,isDev:o,isFull:s=!1,type:a}){const[l,c]=(0,at.O)(),d=(0,g.useCallback)((()=>{o&&localStorage.setItem("dev:notification",(new Date).toString()),c()}),[o,c]);return(0,g.useEffect)((()=>{const e=localStorage.getItem("dev:notification");if(e){const n=new Date(e);n.setMonth(n.getMonth()+1),n.getTime()<=(new Date).getTime()?localStorage.removeItem("dev:notification"):c()}}),[c]),l?null:(0,r.jsx)(Dt,{className:`${n} ${"error"===a?"isError":"isInfo"} ${i?"isBottom":"isTop"} ${s?"isFull":"isPartial"}`,children:(0,r.jsxs)("div",{className:"content",children:[(0,r.jsx)(N.JO,{className:"contentIcon",icon:t,size:"2x"}),(0,r.jsx)("div",{className:"contentItem",children:e}),(0,r.jsx)(N.zx,{className:"closeIcon",icon:"times",isBasic:!0,isCircular:!0,onClick:d})]})})})),Ht=window.location.host.startsWith("polkadot.js.org"),Lt=(0,c.Rf)((()=>"")).map((e=>e.dnslink)).reduce(((e,n)=>(n&&!e.includes(n)&&e.push(n),e)),[]),Xt=g.memo((function({className:e}){const{t:n}=_n(),{systemChain:t}=(0,Z.h)(),i=(0,g.useMemo)((()=>{const e=t?.toLowerCase();return e&&Lt.includes(e)?`https://${e}.dotapps.io`:"https://dotapps.io"}),[t]);return Ht?(0,r.jsx)(Ft,{className:e,icon:"link",isBottom:!0,isDev:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("You are connected to the development instance of the UI. For a fully decentralized experience, you are encouraged to use the IPFS deployed version as the canonical URL: "),(0,r.jsx)("a",{href:i,rel:"noreferrer",target:"_blank",children:i.replace("https://","")})]})}):null})),Jt=g.memo((function({className:e}){const{t:n}=_n(),{isLocalFork:t}=(0,Z.h)();return t?(0,r.jsx)(Ft,{className:e,icon:"link",isBottom:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("Local fork powered by "),(0,r.jsx)("a",{href:"https://github.com/AcalaNetwork/chopsticks",rel:"noreferrer",target:"_blank",children:"Chopsticks"}),"."]})}):null})),Vt=N.zo.div`
  position: fixed;
  bottom: 0.75rem;
  right: 0.75rem;
  left: 0.75rem;
...
`,_t=g.memo((function({className:e}){return(0,r.jsxs)(Vt,{className:e,children:[(0,r.jsx)(Jt,{}),(0,r.jsx)(Xt,{})]})})),Gt=p.X.apiType.param,Kt="json-rpc"===p.X.apiType.type&&"string"==typeof Gt&&Gt.startsWith("ws://"),Yt="string"==typeof Gt&&Gt.includes("127.0.0.1"),Qt=window.location.protocol.startsWith("https:"),er=g.memo((function({className:e}){const{t:n}=_n(),{apiError:t,isApiConnected:i,isApiReady:o,isWaitingInjected:s}=(0,Z.h)();return t?(0,r.jsx)(Ft,{className:e,icon:"globe",type:"error",children:(0,r.jsx)("div",{children:t})}):o?s?(0,r.jsx)(Ft,{className:e,icon:"puzzle-piece",type:"info",children:(0,r.jsx)("div",{children:n("Waiting for authorization from the extension. Please open the installed extension and approve or reject access.")})}):i?null:(0,r.jsxs)(Ft,{className:e,icon:"globe",type:"error",children:[(0,r.jsx)("div",{children:n("You are not connected to a node. Ensure that your node is running and that the Websocket endpoint is reachable.")}),Kt&&!Yt&&Qt?(0,r.jsx)("div",{children:n("You are connecting from a secure location to an insecure WebSocket ({{wsUrl}}). Due to browser mixed-content security policies this connection type is not allowed. Change the RPC service to a secure 'wss' endpoint.",{replace:{wsUrl:Gt}})}):void 0]}):(0,r.jsx)(Ft,{className:e,icon:"globe",type:"info",children:(0,r.jsx)("div",{children:n(i?"Waiting to complete metadata retrieval from remote endpoint.":"Waiting to establish a connection with the remote endpoint.")})})})),nr=g.memo((function(){const{api:e,apiIdentity:n,isApiReady:t}=(0,Z.h)(),i=(0,Yn.W7)(t&&e.derive.accounts?.indexes),o=(0,Yn.W7)(t&&n.query.identity?.registrars),s=(0,Yn.W7)(t&&e.query.balances?.totalIssuance),[a,l]=(0,g.useState)(!1);return(0,g.useEffect)((()=>{l(!!i||!!s||!!o)}),[]),(0,r.jsx)("div",{className:`apps--api-warm ${a.toString()}`})})),tr=N.zo.div`
  background: var(--bg-page);
  box-sizing: border-box;
  display: flex;
  flex-direction: column;

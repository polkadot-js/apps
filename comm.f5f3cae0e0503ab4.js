...
`,Q=s.memo((function({children:e,className:t="",isCentered:n}){return(0,a.jsxs)(U,{className:`${t} ui--Button-Group ${n?"isCentered":""}`,children:[e,(0,a.jsx)("div",{className:"clear"})]})})),W=v.z.button`
  background: transparent;
  border: none;
  color: inherit;
  cursor: pointer;
...
`,O=s.memo((function({activeOnEnter:e,children:t,className:n="",dataTestId:i="",icon:r,isBasic:o,isBusy:l,isCircular:c,isDisabled:d,isFull:u,isIcon:m,isSelected:h,isToplevel:p,label:g,onClick:f,isReadOnly:b=!f,onMouseEnter:x,onMouseLeave:v,tabIndex:w,withoutLink:y}){const j=(0,s.useCallback)((()=>{!l&&!d&&f&&Promise.resolve(f()).catch(console.error)}),[l,d,f]),k=(0,s.useCallback)((()=>{x&&Promise.resolve(x()).catch(console.error)}),[x]),N=(0,s.useCallback)((()=>{v&&Promise.resolve(v()).catch(console.error)}),[v]),C=(0,s.useCallback)((e=>{l||d||"Enter"!==e.key||f&&Promise.resolve(f()).catch(console.error)}),[l,d,f]);return(0,s.useEffect)((()=>(e&&window.addEventListener("keydown",C,!0),()=>{e&&window.removeEventListener("keydown",C,!0)})),[e,C]),(0,a.jsxs)(W,{className:`${n} ui--Button ${g?"hasLabel":""} ${o?"isBasic":""} ${c?"isCircular":""} ${u?"isFull":""} ${m?"isIcon":""} ${l||d?"isDisabled":""} ${l?"isBusy":""} ${b?"isReadOnly":""}${h?"isSelected":""} ${p?"isToplevel":""} ${y?"withoutLink":""}`,"data-testid":i,onClick:j,onMouseEnter:k,onMouseLeave:N,tabIndex:w,children:[r&&(0,a.jsx)(A.Z,{icon:r}),g,t,l&&(0,a.jsx)(H,{className:"ui--Button-spinner",variant:"cover"})]})}));O.Group=Q;const G=O,J=v.z.div`
...
`,vt=s.memo((function({address:e,className:t}){return(0,a.jsxs)(At,{className:t,"data-testid":"parent",children:[(0,a.jsx)(A.Z,{className:"parent-icon",icon:"code-branch"}),(0,a.jsx)(V,{value:e,withSidebar:!0})]})})),wt=v.z.div`
  overflow-x: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
`,kt=s.memo((function({className:e=""}){return(0,a.jsx)(jt,{className:`${e} ui--Menu__Divider`})})),Nt=v.z.div`
  color: var(--color-label);
  font-size: var(--font-size-tiny);
  line-height: 0.857rem;
  margin-bottom: 0.3rem;
`,Ct=s.memo((function({children:e,className:t}){return(0,a.jsx)(Nt,{className:t,children:e})})),Et=v.z.div`
  align-items: center;
  cursor: pointer;
  display: flex;
  flex-direction: row;
...
`,$n=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Rn,{className:`${t} ui--Modal-Actions`,children:(0,a.jsx)(G.Group,{children:e})})})),qn=v.z.div`
  align-items: center;
  display: flex;
  justify-content: space-between;
...
`,Hn=s.memo((function({align:e="left",children:t,className:n="",hint:s}){return(0,a.jsxs)(qn,{className:`${n} ui--Modal-Columns ${e}Align`,children:[(0,a.jsx)("div",{className:"ui--Modal-Columns-content",children:t}),s&&(0,a.jsx)("div",{className:"ui--Modal-Columns-hint",children:s})]})})),Un=v.z.div`
  padding: 1.5rem;
`,Qn=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Un,{className:`${t} ui--Modal-Content`,children:e})})),Wn=v.z.div`
  display: flex;
  justify-content: space-between;
  padding: 0.75rem 1.5rem 0;
`,On=s.memo((function({className:e="",header:t,onClose:n}){return(0,a.jsxs)(Wn,{className:`${e} ui--Modal-Header`,children:[t&&(0,a.jsx)("h1",{children:t}),(0,a.jsx)(G,{dataTestId:"close-modal",icon:"times",onClick:n})]})})),Gn=Mn.vJ`
  body {
    overflow: hidden;
  }
`,Jn=v.z.div`
...
`,Ns=s.memo((function({children:e,className:t="",is60:n,is100:s,isPadded:i=!0,isReverse:r,size:o="default"}){return(0,a.jsx)(ks,{className:`${t} ui--Columar ${s?"is100":n?"is60":"is50"} ${i?"isPadded":""} ${r?"isReverse":""} ${o}Size`,children:e})}));Ns.Column=function({children:e,className:t=""}){return(0,a.jsx)("div",{className:`${t} ui--Column`,children:e})};const Cs=Ns;var Es=n(13731),Ss=(n(79472),n(92890));const Is=v.z.div`
  .codeflask {
...
`,Gs=s.memo((function({className:e="",footer:t,isEmpty:n}){return!t||n?null:(0,a.jsx)(Os,{className:`${e} ui--Table-Foot`,children:t})})),Js=v.z.thead`
  z-index: 1;
...
`,ni=s.memo((function({children:e,className:t="",empty:n,emptySpinner:s,filter:i,footer:r,header:o,headerChildren:l,isFixed:c,isInline:d,isSplit:u,legend:m,maxColumns:h,noBodyTag:p}){const g=Ts(h),f=Array.isArray(e),b=!e||f&&0===e.length,x=(0,a.jsx)(Ks,{filter:i,header:o,isEmpty:b,children:l});return u&&f&&!b&&1!==g?(0,a.jsxs)(ti,{className:`${t} ui--Table isSplit`,children:[m,(0,a.jsx)("table",{className:"noMargin",children:x}),(0,a.jsx)("div",{className:"ui--Table-Split",children:Ys[g].map((t=>(0,a.jsx)("div",{className:`ui--Table-Split-${g}`,children:(0,a.jsx)("table",{className:"noMargin",children:(0,a.jsx)("tbody",{className:"ui--Table-Body",children:e.filter(((e,n)=>n%g===t))})})},t)))})]}):(0,a.jsxs)(ti,{className:`${t} ui--Table`,children:[m,(0,a.jsxs)("table",{className:`${c&&!b?"isFixed":"isNotFixed"} ${d?"isInline":""}`,children:[x,(0,a.jsx)(Ws,{empty:n,emptySpinner:s,isEmpty:b,noBodyTag:p,children:e}),(0,a.jsx)(Gs,{footer:r,isEmpty:b})]})]})}));ni.Column=Us,ni.Row=Qs;const ai=ni;function si(e,t){return(0,a.jsx)("tr",{children:(0,a.jsx)("td",{children:e})},t)}const ii=(0,v.z)(me)`
  .tableContainer {
    overflow-y: scroll;
    display: block;
    margin: 0 0 0 auto;
...
`,Vr=s.memo((function({className:e="",value:t}){const{t:n}=(0,z.$)(),s={width:100*function(e){const t=Pr().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Tr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})})),Mr=v.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
`,Wr=s.memo((function({children:e,className:t="",isSmall:n}){return(0,a.jsx)(Qr,{className:`${t}${n?" isSmall":""}`,children:e})}));var Or=n(73557),Gr=n(59149);const Jr=v.z.div`
...
`,lo=s.memo((function({className:e="",onChange:t,options:n,value:i}){const r=(0,s.useMemo)((()=>n.filter((e=>!!e))),[n]);return r.length&&r[0].value?(0,a.jsx)(oo,{className:`${e} ui--ToggleGroup`,children:r.map((({isDisabled:e,text:n,value:s},r)=>(0,a.jsx)(ro,{index:r,isDisabled:e,isSelected:i===r,onChange:t,text:n,value:s},r)))}):null})),co=v.z.div`
  display: flex;
  align-items: center;
`,uo=v.z.div`
  position: relative;

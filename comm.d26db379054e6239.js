...
`,re=s.memo((function({className:e="",iconPosition:t="left",stakingInfo:n}){const{api:i}=(0,u.h)(),{isStakingAsync:r,rcApi:o}=(0,B._)(),l=(0,s.useMemo)((()=>r?o:i),[i,r,o]),c=(0,J.W7)(l?.derive.session.progress),{t:d}=(0,h.$)(),[m,p,g]=(0,s.useMemo)((()=>function(e,t){if(!e?.unlocking||!t)return[[],T.nw,!1];const n=t.eraProgress.gt(T.nw)&&t.eraProgress.gt(t.eraLength),a=e.unlocking.filter((({remainingEras:e,value:t})=>t.gt(T.nw)&&e.gt(T.nw))).map((e=>[e,e.remainingEras,e.remainingEras.sub(T.If).imul(t.eraLength).iadd(t.eraLength).isub(n?t.eraProgress.mod(t.eraLength):t.eraProgress)])),s=a.reduce(((e,[{value:t}])=>e.iadd(t)),new(se())(0));return[a,s,n]}(n,c)),[c,n]);if(!n||!m.length)return null;const f=`${n.accountId.toString()}-unlocking-trigger`;return(0,a.jsxs)(ie,{className:e,children:["left"===t&&(0,a.jsx)(b.Z,{className:"left",icon:"clock",tooltip:f}),(0,a.jsx)(D.Z,{value:p}),(0,a.jsx)(R.Z,{trigger:f,children:m.map((([{value:e},t,n],s)=>(0,a.jsxs)("div",{className:"row",children:[(0,a.jsx)("div",{children:d("Unbonding {{value}}",{replace:{value:(0,V.a)(e,{forceUnit:"-"})}})}),(0,a.jsx)("div",{className:"faded",children:l?.consts.babe?.epochDuration?(0,a.jsx)(P.Z,{api:l,label:`${d("{{blocks}} blocks",{replace:{blocks:(0,M.u)(n)}})}, `,value:n}):d("{{eras}} eras remaining",{replace:{eras:(0,M.u)(t)}})}),g&&(0,a.jsx)("div",{className:"faded",children:d("Era is overdue for completion due to current network operating conditions")})]},s)))}),"right"===t&&(0,a.jsx)(b.Z,{className:"right",icon:"clock",tooltip:f})]})})),oe={available:!0,bonded:!0,locked:!0,redeemable:!0,reserved:!0,total:!0,unlocking:!0,vested:!0},le={crypto:!0,nonce:!0},ce={unstakeThreshold:!0,validatorPayment:!0};function de(){return(0,a.jsx)("span",{className:"icon-void",children:" "})}function ue(e,t){const n=t.toHuman();try{return e[n]||n}catch{return n}}function me({stakingInfo:e,withBalance:t=!0,withValidatorPrefs:n=!1}){if(e)return!0;if(!0===t||n)return!1;if((0,L.K)(t)){if(t.unlocking||t.redeemable)return!1;if(t.bonded)return Array.isArray(t.bonded)}return!0}function he({address:e,balancesAll:t,withExtended:n},s){const i=!0===n?le:n||void 0;return i?(0,a.jsxs)("div",{className:"column",children:[t&&i.nonce&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(Q,{label:s("transactions")}),(0,a.jsx)("div",{className:"result",children:(0,M.u)(t.accountNonce)})]}),i.crypto&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(Q,{label:s("type")}),(0,a.jsx)(Z,{accountId:e,className:"result"})]})]}):null}function pe({stakingInfo:e,withValidatorPrefs:t=!1},n){const s=!0===t?ce:t;return s&&e?.validatorPrefs?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{}),s.unstakeThreshold&&e.validatorPrefs.unstakeThreshold&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(Q,{label:n("unstake threshold")}),(0,a.jsx)("div",{className:"result",children:e.validatorPrefs.unstakeThreshold.toString()})]}),s.validatorPayment&&(e.validatorPrefs.commission||e.validatorPrefs.validatorPayment)&&(e.validatorPrefs.validatorPayment?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(Q,{label:n("commission")}),(0,a.jsx)(D.Z,{className:"result",value:e.validatorPrefs.validatorPayment})]}):(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(Q,{label:n("commission")}),(0,a.jsxs)("span",{children:[(e.validatorPrefs.commission.unwrap().toNumber()/1e7).toFixed(2),"%"]})]}))]}):null}function ge(e,t,n,{address:i,apiOverride:r,balanceDisplay:o,balancesAll:l,bestNumber:c,convictionLocks:d,democracyLocks:u,isAllLocked:m,otherBonded:h,ownBonded:p,stakingInfo:g,votingOf:f,withBalanceToggle:x,withLabel:v}){const A=[],w=l;if(!x&&o.total&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:v?n("total"):""}),(0,a.jsx)(D.Z,{className:"result "+(l?"":"--tmp"),formatIndex:e,labelPost:(0,a.jsx)(de,{}),value:l?l.freeBalance.add(l.reservedBalance):1})]},0)),l&&o.available&&(w.transferable||w.availableBalance)&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("transferable")}),(0,a.jsx)(D.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(de,{}),value:w.transferable||w.availableBalance})]},1)),c&&o.vested&&w?.isVesting){const t=w.vesting.filter((({endBlock:e})=>c.lt(e)));A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("vested")}),(0,a.jsx)(D.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(b.Z,{icon:"info-circle",tooltip:`${i}-vested-trigger`}),value:w.vestedBalance,children:(0,a.jsxs)(be,{trigger:`${i}-vested-trigger`,children:[(0,a.jsxs)("div",{className:"tooltip-header",children:[(0,V.a)(w.vestedClaimable.abs(),{forceUnit:"-"}),(0,a.jsx)("div",{className:"faded",children:n("available to be unlocked")})]}),t.map((({endBlock:e,locked:t,perBlock:s,vested:i},o)=>(0,a.jsxs)("div",{className:"inner",children:[(0,a.jsxs)("div",{children:[(0,a.jsxs)("p",{children:[(0,V.a)(t,{forceUnit:"-"})," ",n("fully vested in")]}),(0,a.jsx)(P.Z,{api:r,value:e.sub(c)})]}),(0,a.jsxs)("div",{className:"middle",children:["(Block ",(0,M.u)(e)," @ ",(0,V.a)(s),"/block)"]}),(0,a.jsxs)("div",{children:[(0,V.a)(i,{forceUnit:"-"}),(0,a.jsx)("div",{children:n("already vested")})]})]},`item:${o}`)))]})})]},2))}const y=(w?.namedReserves||[]).reduce(((e,t)=>e.concat(...t)),[]),k=!!y&&0!==y.length;if(o.locked&&l&&(m||w.lockedBalance?.gtn(0))&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("locked")}),(0,a.jsx)(D.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(b.Z,{icon:"info-circle",tooltip:`${i}-locks-trigger`}),(0,a.jsx)(R.Z,{trigger:`${i}-locks-trigger`,children:w.lockedBreakdown.map((({amount:e,id:s,reasons:i},r)=>(0,a.jsxs)("div",{className:"row",children:[e?.isMax()?n("everything"):(0,V.a)(e,{forceUnit:"-"}),s&&(0,a.jsx)("div",{className:"faded",children:ue(t,s)}),(0,a.jsx)("div",{className:"faded",children:i.toString()})]},r)))})]}),value:m?"all":w.lockedBalance})]},3)),o.reserved&&l?.reservedBalance?.gtn(0)&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("reserved")}),(0,a.jsx)(D.Z,{className:"result",formatIndex:e,labelPost:k?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(b.Z,{icon:"info-circle",tooltip:`${i}-named-reserves-trigger`}),(0,a.jsx)(R.Z,{trigger:`${i}-named-reserves-trigger`,children:y.map((({amount:e,id:n},s)=>(0,a.jsxs)("div",{children:[(0,V.a)(e,{forceUnit:"-"}),n&&(0,a.jsx)("div",{className:"faded",children:ue(t,n)})]},s)))})]}):(0,a.jsx)(de,{}),value:l.reservedBalance})]},4)),o.bonded&&(p.gtn(0)||0!==h.length)&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("bonded")}),(0,a.jsx)(D.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(de,{}),value:p,children:0!==h.length&&(0,a.jsxs)(a.Fragment,{children:[" (+",h.map(((t,n)=>(0,a.jsx)(D.Z,{formatIndex:e,labelPost:(0,a.jsx)(de,{}),value:t},n))),")"]})})]},5)),o.redeemable&&g?.redeemable?.gtn(0)&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("redeemable")}),(0,a.jsx)(ne,{className:"result",stakingInfo:g})]},6)),o.unlocking){if(g?.unlocking&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("unbonding")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(re,{iconPosition:"right",stakingInfo:g})})]},7)),u&&0!==u.length)A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("democracy")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(H,{value:u})})]},8));else if(c&&f&&f.isDirect){const{prior:[e,t]}=f.asDirect;t.gt(T.nw)&&e.gt(T.nw)&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("democracy")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(H,{value:[{balance:t,isFinished:c.gt(e),unlockAt:e}]})})]},8))}if(c&&d?.length){const e=d.reduce(((e,{total:t})=>(0,F.x)(e,t)),T.nw);A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("referenda")}),(0,a.jsx)(D.Z,{className:"result",labelPost:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(b.Z,{icon:"clock",tooltip:`${i}-conviction-locks-trigger`}),(0,a.jsx)(R.Z,{trigger:`${i}-conviction-locks-trigger`,children:d.map((({endBlock:e,locked:t,refId:s,total:i},r)=>(0,a.jsxs)("div",{className:"row",children:[(0,a.jsxs)("div",{className:"nowrap",children:["#",s.toString()," ",(0,V.a)(i,{forceUnit:"-"})," ",t]}),(0,a.jsx)("div",{className:"faded nowrap",children:e.eq(T.Ew)?n("ongoing referendum"):c.gte(e)?n("lock expired"):(0,a.jsxs)(a.Fragment,{children:[(0,M.u)(e.sub(c))," ",n("blocks"),", ",(0,a.jsx)(P.Z,{isInline:!0,value:e.sub(c)})]})})]},r)))})]}),value:e})]},9))}}return l&&l.accountNonce&&o.nonce&&A.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(Q,{label:n("transactions")}),(0,a.jsxs)("div",{className:"result",children:[(0,M.u)(l.accountNonce),(0,a.jsx)(de,{})]})]},10)),x?(0,a.jsx)(s.Fragment,{children:(0,a.jsx)(W,{className:l?"":"isBlurred",summary:(0,a.jsx)(D.Z,{formatIndex:e,value:l?.freeBalance.add(l.reservedBalance)}),children:0!==A.length&&(0,a.jsx)("div",{className:"body column",children:A})})},e):(0,a.jsx)(s.Fragment,{children:A},e)}function fe(e,t,n,a,s){const{address:i,balancesAll:r,convictionLocks:o,democracyLocks:l,stakingInfo:c,votingOf:d,withBalance:u=!0,withBalanceToggle:m=!1,withLabel:h=!1}=e,p=!0===u?oe:u||!1;if(!p)return[null];const[g,f]=function(e,t){let n=[],a=T.nw;return Array.isArray(t)?(n=t.filter(((e,t)=>0!==t)).filter((e=>e.gt(T.nw))),a=t[0]):e?.stakingLedger?.active&&e.accountId.eq(e.stashId)&&(a=e.stakingLedger.active.unwrap()),[a,n]}(c,p.bonded),b={address:i,apiOverride:a,balanceDisplay:p,bestNumber:n,convictionLocks:o,democracyLocks:l,isAllLocked:!!r&&r.lockedBreakdown.some((({amount:e})=>e?.isMax())),otherBonded:f,ownBonded:g,votingOf:d,withBalanceToggle:m,withLabel:h},x=[ge(0,t,s,{...b,balancesAll:r,stakingInfo:c})];return m&&r?.additional.length&&r.additional.forEach(((e,n)=>{x.push(ge(n+1,t,s,{...b,balancesAll:e}))})),x}const be=(0,m.z)(R.Z)`
  min-width: 26rem;
  text-align: left;

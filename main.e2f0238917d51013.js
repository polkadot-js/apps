...
`,At=g.memo((function({className:e="",isActive:n,name:t,routes:i}){return 1===i.length&&"settings"===i[0].group?(0,r.jsx)(kt,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:i[0]}):(0,r.jsxs)(jt,{className:`${e} ${n?"isActive":""}`,children:[(0,r.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,r.jsx)("span",{className:"smallHide",children:t}),(0,r.jsx)(A.JO,{className:"smallShow",icon:i[0].icon}),(0,r.jsx)(A.JO,{icon:"caret-down"})]}),(0,r.jsx)("ul",{className:"groupMenu",children:i.map((e=>(0,r.jsx)(kt,{route:e},e.name)))})]})}));var Nt=t(39082),It=t(52727);const St=`apps v${"0.137.2-15-x".replace("-x","")}`,Zt=A.zo.div`

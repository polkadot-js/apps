...
`,vt=s.memo((function({address:e,className:t}){return(0,a.jsxs)(At,{className:t,"data-testid":"parent",children:[(0,a.jsx)(x.Z,{className:"parent-icon",icon:"code-branch"}),(0,a.jsx)(V,{value:e,withSidebar:!0})]})})),wt=A.z.div`
  overflow-x: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
`,Ms=s.memo((function({className:e="",colSpan:t,isExpanded:n,rowSpan:s,toggle:i}){return(0,a.jsx)(Ts,{className:`${e} ui--Table-Column-Expand`,colSpan:t,onClick:i,rowSpan:s,children:(0,a.jsx)("div",{children:(0,a.jsx)(x.Z,{icon:n?"caret-up":"caret-down"})})})})),Fs=A.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1rem;
...
`,zs=s.memo((function({address:e,className:t="",colSpan:n,isFavorite:i,rowSpan:r,toggle:o}){const l=(0,s.useCallback)((()=>o(e)),[e,o]);return(0,a.jsx)(Fs,{className:`${t} ui--Table-Column-Favorite`,colSpan:n,onClick:l,rowSpan:r,children:(0,a.jsx)(x.Z,{color:i?"orange":"gray",icon:"star"})})})),Zs=`${7.15.toFixed(3)}ch`,Rs=A.z.td`
  && {
    box-sizing: content-box;
    min-width: ${Zs};
    text-align: right;
...
`,Vr=s.memo((function({className:e="",value:t}){const{t:n}=(0,z.$)(),s={width:100*function(e){const t=Lr().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Pr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})})),Tr=A.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;

...
`,r=s.memo((function({sections:e}){const t=e?.reduce(((e,t)=>e+t.total),0);return(0,a.jsxs)(i,{children:[(0,a.jsx)("div",{className:"progress-container",children:e?.map(((e,n)=>{const s=e.total/t*100,i=e.value/e.total*100;return(0,a.jsxs)("div",{className:"progress-segment",style:{width:`${s}%`},children:[(0,a.jsx)("div",{className:"progress-bar",style:{width:`${i}%`}}),(0,a.jsx)("div",{className:"marker"})]},n)}))}),(0,a.jsx)("div",{className:"labels",children:e.map(((t,n)=>(0,a.jsx)("div",{className:"label",style:{width:100/e.length+"%"},children:t.label},n)))})]})}))},16613:(e,t,n)=>{n.d(t,{Z:()=>u});var a=n(52322),s=n(2784),i=n(38894),r=n(79472),o=n(33749),l=n(21779),c=n(53657);const d=l.z.div`
  text-align: left;
...
`,Mr=s.memo((function({className:e="",value:t}){const{t:n}=(0,R.$)(),s={width:100*function(e){const t=Tr().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Vr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})}));n(79169);const Fr=y.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
`,Qr=s.memo((function({children:e,className:t="",isSmall:n}){return(0,a.jsx)(Or,{className:`${t}${n?" isSmall":""}`,children:e})}));var Gr=n(73557),Jr=n(59149);const Kr=y.z.div`

...
`,d=s.memo((function({allowAdd:e=!1,children:t,className:n="",defaultValue:l,dropdownClassName:d,isButton:u,isDisabled:m,isError:h,isFull:p,isMultiple:g,label:f,labelExtra:b,onAdd:x,onBlur:A,onChange:v,onClose:w,onSearch:y,options:j,placeholder:C,renderLabel:k,searchInput:N,tabIndex:E,transform:S,value:I,withEllipsis:B,withLabel:D}){const L=(0,s.useRef)(""),[V,P]=(0,s.useState)(),T=(0,s.useCallback)((e=>{const t=JSON.stringify({v:e});L.current!==t&&(L.current=t,P(e),v&&v(S?S(e):e))}),[v,S]);(0,s.useEffect)((()=>{T((0,o.o)(I)?l:I)}),[T,l,I]);const F=(0,s.useCallback)(((e,{value:t})=>x&&x(t)),[x]),M=(0,s.useCallback)(((e,{value:t})=>T(t)),[T]),z=(0,a.jsx)(i.Z,{allowAdditions:e,button:u,className:d,compact:u,disabled:m,error:h,floating:u,multiple:g,onAddItem:F,onBlur:A,onChange:M,onClose:w,options:j,placeholder:C,renderLabel:k,search:y||e,searchInput:N,selection:!0,tabIndex:E,value:V});return u?(0,a.jsxs)(r.Z.Group,{children:[z,t]}):(0,a.jsxs)(c,{className:`${n} ui--Dropdown`,isFull:p,label:f,labelExtra:b,withEllipsis:B,withLabel:D,children:[z,t]})}));d.Header=i.Z.Header;const u=d},79472:(e,t,n)=>{n.d(t,{Z:()=>l});var a=n(52322),s=n(2784),i=n(69316),r=n(15445);const o=n(21779).z.div`
  cursor: pointer;
...
`,$n=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Rn,{className:`${t} ui--Modal-Actions`,children:(0,a.jsx)(G.Group,{children:e})})})),Un=A.z.div`
  align-items: center;
  display: flex;
  justify-content: space-between;
...
`,qn=s.memo((function({align:e="left",children:t,className:n="",hint:s}){return(0,a.jsxs)(Un,{className:`${n} ui--Modal-Columns ${e}Align`,children:[(0,a.jsx)("div",{className:"ui--Modal-Columns-content",children:t}),s&&(0,a.jsx)("div",{className:"ui--Modal-Columns-hint",children:s})]})})),Hn=A.z.div`
  padding: 1.5rem;

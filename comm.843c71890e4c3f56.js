...
`,Q=s.memo((function({children:e,className:t="",isCentered:n}){return(0,a.jsxs)(W,{className:`${t} ui--Button-Group ${n?"isCentered":""}`,children:[e,(0,a.jsx)("div",{className:"clear"})]})})),G=y.z.button`
  background: transparent;
  border: none;
  color: inherit;
  cursor: pointer;
...
`,pe=s.memo((function({children:e,className:t="",isHeader:n,isLeft:i,isOpen:r,isPadded:o,onClick:l,renderChildren:c,summary:d,summaryHead:u,summaryMeta:m,summarySub:h,withBreaks:p,withHidden:g}){const[f,b]=(0,me.O)(r,l),x=(0,s.useMemo)((()=>f&&c&&c()),[f,c]),[v,A]=(0,s.useMemo)((()=>function(e){if(!e?.docs.length)return null;const t=e.docs.map((e=>e.toString().trim())),n=t.findIndex((e=>!e.length)),s=(i=(-1===n?t:t.slice(0,n)).join(" ").replace(/#(<weight>| <weight>).*<\/weight>/,"").replace(/\\/g,"").replace(/`/g,""),["[","]"].reduce(((e,t)=>function(e,t){return e.reduce(((e,n)=>n.split(t).reduce(((e,t)=>e.concat(t)),e)),[])}(e,t)),[i]));var i;return[s[0].split(/[.(]/)[0],(0,a.jsxs)(a.Fragment,{children:[s.map(((e,t)=>t%2?(0,a.jsxs)("em",{children:["[",e,"]"]},t):(0,a.jsx)("span",{children:e},t)))," "]})]}(m)||[h,h]),[m,h]),y=(0,s.useMemo)((()=>!!c||!!e&&(!Array.isArray(e)||0!==e.length)),[e,c]),k=(0,s.useMemo)((()=>(0,a.jsx)(w.Z,{color:y?void 0:"transparent",icon:f?"caret-up":"caret-down"})),[y,f]);return(0,a.jsxs)(he,{className:`${t} ui--Expander ${f?"isExpanded":""} ${n?"isHeader":""} ${o?"isPadded":""} ${y?"hasContent":""} ${p?"withBreaks":""}`,children:[(0,a.jsxs)("div",{className:"ui--Expander-summary"+(i?" isLeft":""),onClick:b,children:[i&&k,(0,a.jsxs)("div",{className:"ui--Expander-summary-header",children:[(0,a.jsx)("div",{className:"ui--Expander-summary-title",children:u}),d,A&&(0,a.jsx)("div",{className:"ui--Expander-summary-header-sub",children:f?A:v})]}),!i&&k]}),y&&(f||g)&&(0,a.jsx)("div",{className:"ui--Expander-content",children:e||x})]})})),ge=s.memo((function({className:e="",label:t,withEllipsis:n}){return(0,a.jsx)("label",{className:e,children:n?(0,a.jsx)("div",{className:"withEllipsis",children:t}):t})}));var fe=n(34814),be=n(9118),xe=n(74065),ve=n(86135),Ae=n(13105),we=n(11677);const ye=(0,we.e)("usePayWithAsset",(function(){return(0,s.useContext)(Ae.n)})),ke=(e,t)=>{if(t?.id)return{interior:{X2:[{PalletInstance:e.registry.metadata.pallets.filter((e=>"Assets"===e.name.toString()))[0].index.toString()},{GeneralIndex:t.id}]},parents:0}};var je=n(48731);const Ne=s.memo((function({accountId:e,className:t="",extrinsic:n,icon:i,isBasic:r,isBusy:o,isDisabled:c,isIcon:d,isToplevel:u,isUnsigned:m,label:h,onClick:p,onFailed:g,onSendRef:f,onStart:x,onSuccess:v,onUpdate:A,params:w,tooltip:y,tx:k,withSpinner:j,withoutLink:N}){const{t:C}=(0,R.$)(),{api:S}=(0,l.h)(),E=(0,xe.X)(),{queueExtrinsic:I}=(0,ve.L)(),{selectedFeeAsset:B}=ye(),[D,L]=(0,s.useState)(!1),[P,T]=(0,s.useState)(!1);(0,s.useEffect)((()=>{P&&x&&x()}),[P,x]);const V=(0,s.useCallback)((e=>{E.current&&L(!1),g&&g(e)}),[g,L,E]),M=(0,s.useCallback)((e=>{E.current&&L(!1),v&&v(e)}),[v,L,E]),F=(0,s.useCallback)((()=>{E.current&&T(!0)}),[T,E]),z=(0,s.useCallback)((()=>{let t;n?t=Array.isArray(n)?n:[n]:k&&(t=[k(...(0,b.m)(w)?w():w||[])]),(0,je.hu)(t?.length,"Expected generated extrinsic passed to TxButton"),E.current&&j&&L(!0),t.forEach((t=>{I({accountId:e?.toString(),extrinsic:t,isUnsigned:m,signerOptions:{assetId:ke(S,B),feeAsset:B},txFailedCb:j?V:g,txStartCb:F,txSuccessCb:j?M:v,txUpdateCb:A})})),p&&p()}),[V,F,M,e,S,m,E,p,g,v,A,w,n,I,B,k,j]);return f&&(f.current=z),(0,a.jsx)(K,{className:t,icon:i||"check",isBasic:r,isBusy:o,isDisabled:D||c||!m&&!e||!k&&(Array.isArray(n)?0===n.length:!n),isIcon:d,isToplevel:u,label:h||(d?"":C("Submit")),onClick:z,tooltip:y,withoutLink:N})})),Ce={transform:e=>e.isNone?0:e.unwrap().prior.length+1},Se=s.memo((function({className:e="",isPool:t,stakingInfo:n}){const{api:s}=(0,l.h)(),{allAccounts:i}=(0,fe.x)(),{t:r}=(0,R.$)(),o=(0,be.W7)(s.query.staking.slashingSpans,[n?.stashId],Ce);return n?.redeemable?.gtn(0)?(0,a.jsx)("div",{className:e,children:(0,a.jsx)(ne.Z,{value:n.redeemable,children:i.includes((n.controllerId||"").toString())?(0,a.jsx)(Ne,{accountId:n.controllerId,icon:"lock",isIcon:!0,params:t?[n.controllerId,o]:1===s.tx.staking.withdrawUnbonded.meta.args.length?[o]:[],tooltip:r("Withdraw these unbonded funds"),tx:t?s.tx.nominationPools.withdrawUnbonded:s.tx.staking.withdrawUnbonded},"unlock"):(0,a.jsx)("span",{className:"icon-void",children:" "})})}):null}));var Ee=n(48801),Ie=n.n(Ee);const Be=y.z.div`
  white-space: nowrap;
...
`,De=s.memo((function({className:e="",iconPosition:t="left",stakingInfo:n}){const{api:i}=(0,l.h)(),r=(0,be.W7)(i.derive.session.progress),{t:o}=(0,R.$)(),[c,d,u]=(0,s.useMemo)((()=>function(e,t){if(!e?.unlocking||!t)return[[],ie.nw,!1];const n=t.eraProgress.gt(ie.nw)&&t.eraProgress.gt(t.eraLength),a=e.unlocking.filter((({remainingEras:e,value:t})=>t.gt(ie.nw)&&e.gt(ie.nw))).map((e=>[e,e.remainingEras,e.remainingEras.sub(ie.If).imul(t.eraLength).iadd(t.eraLength).isub(n?t.eraProgress.mod(t.eraLength):t.eraProgress)])),s=a.reduce(((e,[{value:t}])=>e.iadd(t)),new(Ie())(0));return[a,s,n]}(n,r)),[r,n]);if(!n||!c.length)return null;const m=`${n.accountId.toString()}-unlocking-trigger`;return(0,a.jsxs)(Be,{className:e,children:["left"===t&&(0,a.jsx)(w.Z,{className:"left",icon:"clock",tooltip:m}),(0,a.jsx)(ne.Z,{value:d}),(0,a.jsx)(k.Z,{trigger:m,children:c.map((([{value:e},t,n],s)=>(0,a.jsxs)("div",{className:"row",children:[(0,a.jsx)("div",{children:o("Unbonding {{value}}",{replace:{value:(0,re.a)(e,{forceUnit:"-"})}})}),(0,a.jsx)("div",{className:"faded",children:i.consts.babe?.epochDuration?(0,a.jsx)(ae.Z,{label:`${o("{{blocks}} blocks",{replace:{blocks:(0,g.u)(n)}})}, `,value:n}):o("{{eras}} eras remaining",{replace:{eras:(0,g.u)(t)}})}),u&&(0,a.jsx)("div",{className:"faded",children:o("Era is overdue for completion due to current network operating conditions")})]},s)))}),"right"===t&&(0,a.jsx)(w.Z,{className:"right",icon:"clock",tooltip:m})]})})),Le={available:!0,bonded:!0,locked:!0,redeemable:!0,reserved:!0,total:!0,unlocking:!0,vested:!0},Pe={crypto:!0,nonce:!0},Te={unstakeThreshold:!0,validatorPayment:!0};function Ve(){return(0,a.jsx)("span",{className:"icon-void",children:" "})}function Me(e,t){const n=t.toHuman();try{return e[n]||n}catch{return n}}function Fe({stakingInfo:e,withBalance:t=!0,withValidatorPrefs:n=!1}){if(e)return!0;if(!0===t||n)return!1;if((0,se.K)(t)){if(t.unlocking||t.redeemable)return!1;if(t.bonded)return Array.isArray(t.bonded)}return!0}function ze({address:e,balancesAll:t,withExtended:n},s){const i=!0===n?Pe:n||void 0;return i?(0,a.jsxs)("div",{className:"column",children:[t&&i.nonce&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:s("transactions")}),(0,a.jsx)("div",{className:"result",children:(0,g.u)(t.accountNonce)})]}),i.crypto&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:s("type")}),(0,a.jsx)(le,{accountId:e,className:"result"})]})]}):null}function Ze({stakingInfo:e,withValidatorPrefs:t=!1},n){const s=!0===t?Te:t;return s&&e?.validatorPrefs?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{}),s.unstakeThreshold&&e.validatorPrefs.unstakeThreshold&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:n("unstake threshold")}),(0,a.jsx)("div",{className:"result",children:e.validatorPrefs.unstakeThreshold.toString()})]}),s.validatorPayment&&(e.validatorPrefs.commission||e.validatorPrefs.validatorPayment)&&(e.validatorPrefs.validatorPayment?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:n("commission")}),(0,a.jsx)(ne.Z,{className:"result",value:e.validatorPrefs.validatorPayment})]}):(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:n("commission")}),(0,a.jsxs)("span",{children:[(e.validatorPrefs.commission.unwrap().toNumber()/1e7).toFixed(2),"%"]})]}))]}):null}function Re(e,t,n,{address:i,balanceDisplay:r,balancesAll:o,bestNumber:l,convictionLocks:c,democracyLocks:d,isAllLocked:u,otherBonded:m,ownBonded:h,stakingInfo:p,votingOf:f,withBalanceToggle:b,withLabel:x}){const v=[],A=o;if(!b&&r.total&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:x?n("total"):""}),(0,a.jsx)(ne.Z,{className:"result "+(o?"":"--tmp"),formatIndex:e,labelPost:(0,a.jsx)(Ve,{}),value:o?o.freeBalance.add(o.reservedBalance):1})]},0)),o&&r.available&&(A.transferable||A.availableBalance)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("transferable")}),(0,a.jsx)(ne.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(Ve,{}),value:A.transferable||A.availableBalance})]},1)),l&&r.vested&&A?.isVesting){const t=A.vesting.filter((({endBlock:e})=>l.lt(e)));v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("vested")}),(0,a.jsx)(ne.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(w.Z,{icon:"info-circle",tooltip:`${i}-vested-trigger`}),value:A.vestedBalance,children:(0,a.jsxs)(k.Z,{trigger:`${i}-vested-trigger`,children:[(0,a.jsxs)("div",{children:[(0,re.a)(A.vestedClaimable,{forceUnit:"-"}),(0,a.jsx)("div",{className:"faded",children:n("available to be unlocked")})]}),t.map((({endBlock:e,locked:t,perBlock:s,vested:i},r)=>(0,a.jsxs)("div",{className:"inner",children:[(0,a.jsxs)("div",{children:[(0,re.a)(i,{forceUnit:"-"}),(0,a.jsx)("div",{className:"faded",children:n("of {{locked}} vested",{replace:{locked:(0,re.a)(t,{forceUnit:"-"})}})})]}),(0,a.jsxs)("div",{children:[(0,a.jsx)(ae.Z,{value:e.sub(l)}),(0,a.jsxs)("div",{className:"faded",children:[n("until block")," ",(0,g.u)(e)]})]}),(0,a.jsxs)("div",{children:[(0,re.a)(s),(0,a.jsx)("div",{className:"faded",children:n("per block")})]})]},`item:${r}`)))]})})]},2))}const y=(A?.namedReserves||[]).reduce(((e,t)=>e.concat(...t)),[]),j=!!y&&0!==y.length;if(r.locked&&o&&(u||A.lockedBalance?.gtn(0))&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("locked")}),(0,a.jsx)(ne.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(w.Z,{icon:"info-circle",tooltip:`${i}-locks-trigger`}),(0,a.jsx)(k.Z,{trigger:`${i}-locks-trigger`,children:A.lockedBreakdown.map((({amount:e,id:s,reasons:i},r)=>(0,a.jsxs)("div",{className:"row",children:[e?.isMax()?n("everything"):(0,re.a)(e,{forceUnit:"-"}),s&&(0,a.jsx)("div",{className:"faded",children:Me(t,s)}),(0,a.jsx)("div",{className:"faded",children:i.toString()})]},r)))})]}),value:u?"all":A.lockedBalance})]},3)),r.reserved&&o?.reservedBalance?.gtn(0)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("reserved")}),(0,a.jsx)(ne.Z,{className:"result",formatIndex:e,labelPost:j?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(w.Z,{icon:"info-circle",tooltip:`${i}-named-reserves-trigger`}),(0,a.jsx)(k.Z,{trigger:`${i}-named-reserves-trigger`,children:y.map((({amount:e,id:n},s)=>(0,a.jsxs)("div",{children:[(0,re.a)(e,{forceUnit:"-"}),n&&(0,a.jsx)("div",{className:"faded",children:Me(t,n)})]},s)))})]}):(0,a.jsx)(Ve,{}),value:o.reservedBalance})]},4)),r.bonded&&(h.gtn(0)||0!==m.length)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("bonded")}),(0,a.jsx)(ne.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(Ve,{}),value:h,children:0!==m.length&&(0,a.jsxs)(a.Fragment,{children:[" (+",m.map(((t,n)=>(0,a.jsx)(ne.Z,{formatIndex:e,labelPost:(0,a.jsx)(Ve,{}),value:t},n))),")"]})})]},5)),r.redeemable&&p?.redeemable?.gtn(0)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("redeemable")}),(0,a.jsx)(Se,{className:"result",stakingInfo:p})]},6)),r.unlocking){if(p?.unlocking&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("unbonding")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(De,{iconPosition:"right",stakingInfo:p})})]},7)),d&&0!==d.length)v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("democracy")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(ue,{value:d})})]},8));else if(l&&f&&f.isDirect){const{prior:[e,t]}=f.asDirect;t.gt(ie.nw)&&e.gt(ie.nw)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("democracy")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(ue,{value:[{balance:t,isFinished:l.gt(e),unlockAt:e}]})})]},8))}if(l&&c?.length){const e=c.reduce(((e,{total:t})=>(0,oe.x)(e,t)),ie.nw);v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("referenda")}),(0,a.jsx)(ne.Z,{className:"result",labelPost:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(w.Z,{icon:"clock",tooltip:`${i}-conviction-locks-trigger`}),(0,a.jsx)(k.Z,{trigger:`${i}-conviction-locks-trigger`,children:c.map((({endBlock:e,locked:t,refId:s,total:i},r)=>(0,a.jsxs)("div",{className:"row",children:[(0,a.jsxs)("div",{className:"nowrap",children:["#",s.toString()," ",(0,re.a)(i,{forceUnit:"-"})," ",t]}),(0,a.jsx)("div",{className:"faded nowrap",children:e.eq(ie.Ew)?n("ongoing referendum"):l.gte(e)?n("lock expired"):(0,a.jsxs)(a.Fragment,{children:[(0,g.u)(e.sub(l))," ",n("blocks"),", ",(0,a.jsx)(ae.Z,{isInline:!0,value:e.sub(l)})]})})]},r)))})]}),value:e})]},9))}}return o&&o.accountNonce&&r.nonce&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:n("transactions")}),(0,a.jsxs)("div",{className:"result",children:[(0,g.u)(o.accountNonce),(0,a.jsx)(Ve,{})]})]},10)),b?(0,a.jsx)(s.Fragment,{children:(0,a.jsx)(pe,{className:o?"":"isBlurred",summary:(0,a.jsx)(ne.Z,{formatIndex:e,value:o?.freeBalance.add(o.reservedBalance)}),children:0!==v.length&&(0,a.jsx)("div",{className:"body column",children:v})})},e):(0,a.jsx)(s.Fragment,{children:v},e)}function $e(e,t,n,a){const{address:s,balancesAll:i,convictionLocks:r,democracyLocks:o,stakingInfo:l,votingOf:c,withBalance:d=!0,withBalanceToggle:u=!1,withLabel:m=!1}=e,h=!0===d?Le:d||!1;if(!h)return[null];const[p,g]=function(e,t){let n=[],a=ie.nw;return Array.isArray(t)?(n=t.filter(((e,t)=>0!==t)).filter((e=>e.gt(ie.nw))),a=t[0]):e?.stakingLedger?.active&&e.accountId.eq(e.stashId)&&(a=e.stakingLedger.active.unwrap()),[a,n]}(l,h.bonded),f={address:s,balanceDisplay:h,bestNumber:n,convictionLocks:r,democracyLocks:o,isAllLocked:!!i&&i.lockedBreakdown.some((({amount:e})=>e?.isMax())),otherBonded:g,ownBonded:p,votingOf:c,withBalanceToggle:u,withLabel:m},b=[Re(0,t,a,{...f,balancesAll:i,stakingInfo:l})];return u&&i?.additional.length&&i.additional.forEach(((e,n)=>{b.push(Re(n+1,t,a,{...f,balancesAll:e}))})),b}const qe=(0,ee.withMulti)((0,y.z)((function(e){const{t}=(0,R.$)(),n=(0,te.C)(),{children:i,className:r="",extraInfo:o,withBalanceToggle:l,withHexSessionId:c}=e,d=(0,s.useRef)({democrac:t("via Democracy/Vote"),phrelect:t("via Council/Vote"),pyconvot:t("via Referenda/Vote"),"staking ":t("via Staking/Bond"),"vesting ":t("via Vesting")});return(0,a.jsxs)("div",{className:`${r} ui--AddressInfo ${l?"ui--AddressInfo-expander":""}`,children:[(0,a.jsxs)("div",{className:"column"+(l?" column--expander":""),children:[$e(e,d.current,n,t),c?.[0]&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:t("session keys")}),(0,a.jsx)("div",{className:"result",children:c[0]})]}),c&&c[0]!==c[1]&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ge,{label:t("session next")}),(0,a.jsx)("div",{className:"result",children:c[1]})]}),Ze(e,t),o&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{}),o.map((([e,t],n)=>(0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(ge,{label:e}),(0,a.jsx)("div",{className:"result",children:t})]},`label:${n}`)))]})]}),ze(e,t),i&&(0,a.jsx)("div",{className:"column",children:i})]})}))`
  ...
  `,(0,ee.withCalls)(["derive.balances.all",{paramName:"address",propName:"balancesAll",skipIf:function({withBalance:e=!0,withExtended:t=!1}){if(!0===e||!0===t)return!1;if((0,se.K)(e)){if(e.available||e.locked||e.reserved||e.total||e.vested)return!1}else if((0,se.K)(t)&&t.nonce)return!1;return!0}}],["derive.staking.account",{paramName:"address",propName:"stakingInfo",skipIf:Fe}],["derive.democracy.locks",{paramName:"address",propName:"democracyLocks",skipIf:Fe}],["query.democracy.votingOf",{paramName:"address",propName:"votingOf",skipIf:Fe}])),He={available:!0,bonded:!0,free:!0,locked:!0,reserved:!0,total:!0},Ue=y.z.section`
  .balanceExpander {
...
`,Oe=s.memo((function({address:e,className:t}){const{t:n}=(0,R.$)();return(0,a.jsxs)(Ue,{className:t,children:[(0,a.jsx)("div",{className:"ui--AddressMenu-sectionHeader",children:n("balance")}),(0,a.jsx)(qe,{address:e,className:"balanceExpander",withBalance:He,withLabel:!0},e)]})})),We=(0,we.e)("useRegistrars",(function(e){const{apiIdentity:t}=(0,l.h)(),{allAccounts:n,hasAccounts:a}=(0,fe.x)(),i=(0,be.W7)(!e&&t.query.identity?.registrars);return(0,s.useMemo)((()=>{const e=(i||[]).map(((e,t)=>({address:e.isSome?e.unwrap().account.toString():null,index:t}))).filter((e=>!!e.address));return{isRegistrar:a&&e.some((({address:e})=>n.includes(e))),registrars:e}}),[n,a,i])}));var Qe=n(19008),Ge=n(28097),Je=n(74076),Ke=n(9652),Ye=n(51304),Xe=n(16039),_e=n(47025);function et(e){return!(!e||!e.toHuman)}const tt=s.memo((function({className:e="",forceIconType:t,prefix:n,size:i=24,theme:r,value:o}){const{apiEndpoint:c,isEthereum:d,specName:u,systemName:m}=(0,l.h)(),{t:h}=(0,R.$)(),{queueAction:p}=(0,ve.L)(),g=r||function(e,t,n){return"default"===Xe.X.icon&&(e?.ui?.identityIcon||(0,Ke.t)(t,n))||Xe.X.icon}(c,m,u),f="robohash"===g?_e.Z:void 0,b=(0,s.useCallback)((e=>p({account:e,action:h("clipboard"),message:h("address copied"),status:"queued"})),[p,h]);return(0,a.jsx)(Ye.ZP,{Custom:f,className:`ui--Identicon-React-Base ${e}`,onCopy:b,prefix:n,size:i,theme:t||(d?"ethereum":g),value:et(o)?o.toString():o})}));var nt=n(36609);function at({className:e="",label:t,value:n}){let s;if(Array.isArray(n)){const e=n.filter(((e,t)=>0!==t)),t=e.reduce(((e,t)=>e.add(t)),ie.nw).gtn(0);t&&(s=e.map(((e,t)=>(0,a.jsx)(ne.Z,{value:e},t))))}return(0,a.jsx)(ne.Z,{className:`${e} ui--Balance`,label:t,value:Array.isArray(n)?n[0]:n,children:s&&(0,a.jsxs)("span",{children:[" (+",s,")"]})})}const st=s.memo((function(e){const{balance:t,className:n="",label:s,params:i}=e;return i?t?(0,a.jsx)(a.Fragment,{children:at({className:n,label:s,value:t})}):(0,a.jsx)(nt.Z,{className:`${n} ui--Balance`,label:s,params:i}):null})),it={transform:e=>e.unwrapOr(null)},rt={transform:e=>e.unwrapOr(null)},ot=s.memo((function({children:e,className:t="",label:n,params:s}){const{api:i}=(0,l.h)(),r=(0,be.W7)(i.query.staking?.bonded,[s],it),o=(0,be.W7)(r&&i.query.staking?.ledger,[r],rt);return(0,a.jsx)(ne.Z,{className:t,label:n,value:o?.active,children:e})})),lt=s.memo((function(e){const{bonded:t,className:n="",label:s,params:i}=e;return i?t?(0,a.jsx)(a.Fragment,{children:at({className:n,label:s,value:t})}):(0,a.jsx)(ot,{className:`${n} ui--Bonded`,label:s,params:i}):null})),ct=s.memo((function({children:e,className:t="",label:n,params:s}){const{api:i}=(0,l.h)(),r=(0,be.W7)(i.derive.council.votesOf,[s]);return r?.stake.gtn(0)?(0,a.jsx)(ne.Z,{className:t,label:n,value:r?.stake,children:e}):null})),dt=s.memo((function({className:e="",label:t,params:n}){return n?(0,a.jsx)(ct,{className:`${e} ui--LockedVote`,label:t,params:n}):null})),ut=y.z.div`
  overflow-x: hidden;
...
`,mt=s.memo((function({balance:e,bonded:t,children:n,className:s="",iconInfo:i,isHighlight:r,isPadded:o=!0,label:l,labelBalance:c,nameExtra:d,onNameClick:u,summary:m,value:h,withAddress:p=!0,withBalance:g=!1,withBonded:f=!1,withLockedVote:b=!1,withName:x=!0,withShrink:v=!1,withSidebar:A=!0}){return h?(0,a.jsxs)(ut,{className:`${s} ui--AddressMini ${r?"isHighlight":""} ${o?"padded":""} ${v?"withShrink":""}`,children:[l&&(0,a.jsx)("label",{className:"ui--AddressMini-label",children:l}),(0,a.jsxs)("span",{className:"ui--AddressMini-icon",children:[(0,a.jsx)(tt,{value:h}),i&&(0,a.jsx)("div",{className:"ui--AddressMini-icon-info",children:i})]}),(0,a.jsxs)("span",{className:"ui--AddressMini-info",children:[p&&(0,a.jsx)("span",{className:"ui--AddressMini-address",onClick:u,children:x?(0,a.jsx)(F,{value:h,withSidebar:A,children:d}):(0,a.jsx)("span",{className:"shortAddress",children:h.toString()})}),n]}),(0,a.jsxs)("div",{className:"ui--AddressMini-balances",children:[g&&(0,a.jsx)(st,{balance:e,label:c,params:h}),f&&(0,a.jsx)(lt,{bonded:t,label:"",params:h}),b&&(0,a.jsx)(dt,{params:h}),m&&(0,a.jsx)("div",{className:"ui--AddressMini-summary",children:m})]})]}):null})),ht=y.z.div`
  & {
    display: flex;
    align-items: center;
...
`,pt=s.memo((function({children:e,className:t="",icon:n,isBig:s,subtitle:i,title:r}){return(0,a.jsxs)(ht,{className:["ui--AvatarItem",t,s&&"big"].join(" "),children:[(0,a.jsx)("div",{className:"ui--AvatarItem-icon",children:n}),(0,a.jsxs)("div",{className:"ui--AvatarItem-details",children:[(0,a.jsx)("div",{className:"ui--AvatarItem-title",children:r}),(0,a.jsx)("div",{className:"ui--AvatarItem-subtitle",children:i})]}),e]})})),gt=y.z.a`
  .ui--Icon {
    margin-right: 0.5em;
  }
`,ft=s.memo((function({className:e="",href:t,icon:n,label:s,onClick:i,rel:r,target:o}){return(0,a.jsxs)(gt,{className:e,href:t,onClick:i,rel:r,target:o,children:[n&&(0,a.jsx)(w.Z,{icon:n}),s]})}));const bt=e=>e.filter((([,e])=>!e.isFeePaid)),xt=e=>e.filter((([,e])=>e.isKnownGood)),vt=e=>e.filter((([,e])=>e.isReasonable)),At=e=>e.filter((([,e])=>e.isErroneous)),wt=e=>e.filter((([,e])=>e.isLowQuality));const yt=(0,we.e)("useJudgements",(function(e){const{identity:t}=(0,z.B)(e),{registrars:n}=We(),a=(0,s.useMemo)((()=>function(e){if(!e)return[];const t=function(e){const t=bt(e),n=xt(t),a=vt(t);return{Erroneous:At(t),"Known good":n,"Low quality":wt(t),Reasonable:a}}(e.judgements),n=[];for(const e in t){const s=e;0!==t[s].length&&n.push({judgementName:s,registrarsIndexes:(a=t[s],a.map((e=>e[0])))})}var a;return n}(t)),[t]);return(0,s.useMemo)((()=>function(e,t){return e.map((({judgementName:e,registrarsIndexes:n})=>({judgementName:e,registrars:n.map((e=>(e=>t.find((t=>t.index===e)))(e.toNumber())))})))}(a,n)),[n,a])}));var kt=n(17608);const jt=y.z.div`
  align-items: center;
  color: #8B8B8B;
  var(--font-size-small);
  display: flex;
...
`,Nt=s.memo((function({address:e,className:t}){return(0,a.jsxs)(jt,{className:t,"data-testid":"parent",children:[(0,a.jsx)(w.Z,{className:"parent-icon",icon:"code-branch"}),(0,a.jsx)(F,{value:e,withSidebar:!0})]})})),Ct=y.z.div`
  overflow-x: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
`,It=s.memo((function({className:e=""}){return(0,a.jsx)(Et,{className:`${e} ui--Menu__Divider`})})),Bt=y.z.div`
  color: var(--color-label);
  font-size: var(--font-size-tiny);
  line-height: 0.857rem;
  margin-bottom: 0.3rem;
`,Dt=s.memo((function({children:e,className:t}){return(0,a.jsx)(Bt,{className:t,children:e})})),Lt=y.z.div`
  align-items: center;
  cursor: pointer;
  display: flex;
  flex-direction: row;
...
`,Pt=s.memo((function({children:e,className:t="",icon:n,isDisabled:i,label:r,onClick:o}){const l=(0,s.useCallback)((()=>{!i&&o&&Promise.resolve(o()).catch(console.error)}),[i,o]);return(0,a.jsxs)(Lt,{className:`${t} ui--Menu__Item ${n?"hasIcon":""} ${i?"isDisabled":""}`,onClick:l,children:[n&&(0,a.jsx)(w.Z,{color:"darkGray",icon:n}),r,e]})})),Tt=y.z.div`
  display: flex;
  flex-direction: column;
  min-width: 14.286rem;
  margin: 1rem 0;
...
`,Vt=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Tt,{className:`${t} ui--Menu`,children:e})}));Vt.Divider=It,Vt.Item=Pt,Vt.Header=Dt;const Mt=Vt,Ft=(0,we.e)("useOutsideClick",(function(e,t){const n=(0,s.useCallback)((n=>{e.length&&!function(e,t){return e.some((e=>e.current&&e.current.contains(t.target)))}(e,n)&&t()}),[e,t]);(0,s.useEffect)((()=>(document.addEventListener("click",n,!0),()=>{document.removeEventListener("click",n,!0)})),[n,t])}));var zt=n(28316);const Zt=14*.8;function Rt(e,t){return"left"===t?e-Zt:"right"===t?Zt:e/2}function $t(e,t,n,a,s){const{height:i,y:r}=t;return"bottom"===e?a.height-i-r-14>n:s<56?r-(56-s)>n:r>n}function qt(e,t,n){return"bottom"===t?e/2:-1*(e/2+n+Zt)}function Ht(e,t,n,a){return"bottom"===t?e+n.height-a-14:e<56?56:e}const Ut=(0,we.e)("useScroll",(function(){const[e,t]=(0,s.useState)(window.scrollY),n=(0,s.useCallback)((()=>t(window.scrollY)),[]);return(0,s.useEffect)((()=>(window.addEventListener("scroll",n),()=>{window.removeEventListener("scroll",n)})),[n]),e}));var Ot=n(91012);const Wt=(0,we.e)("useWindowSize",(function(){return(0,s.useContext)(Ot.d)})),Qt=(0,we.e)("useElementPosition",(function(e){const[t,n]=(0,s.useState)(),a=(0,xe.X)(),i=Wt(),r=Ut();return(0,s.useEffect)((()=>{if(a.current&&e?.current){const{height:t,width:a,x:s,y:i}=e.current.getBoundingClientRect();n({height:t,width:a,x:s,y:i})}}),[a,e,r,i]),t})),Gt={x:0,y:0},Jt=(0,we.e)("usePopupWindow",(function(e,t,n){const[a,i]=(0,s.useState)(Gt),[r,o]=(0,s.useState)("top"),l=Qt(e),c=Qt(t),d=Ut(),u=Wt();return(0,s.useEffect)((()=>{u&&c&&o(c.y>u.height/2?"top":"bottom")}),[c,u]),(0,s.useEffect)((()=>{l&&c&&i(function(e,t,n,a,s,i){const r=e.x+e.width/2,o=e.y+s+e.height/2;return{x:r-Rt(a.width,t),y:$t(n,e,a.height,i,s)?o+qt(e.height,n,a.height):Ht(s,n,i,a.height)}}(c,n,r,l,d,u))}),[n,d,c,r,l,u]),(0,s.useMemo)((()=>({pointerStyle:r,renderCoords:a})),[a,r])})),Kt=y.z.div`
...
`,Yt=s.memo((function({children:e,className:t="",position:n,triggerRef:s,windowRef:i}){const{pointerStyle:r,renderCoords:{x:o,y:l}}=Jt(i,s,n);return(0,zt.createPortal)((0,a.jsx)(Kt,{className:`${t} ${r}Pointer ${n}Position`,"data-testid":"popup-window",ref:i,style:o&&l&&{transform:`translate3d(${o}px, ${l}px, 0)`,zIndex:1e3}||void 0,children:e}),document.body)})),Xt=y.z.div`
  display: inline-flex;
  flex-direction: column;
  justify-content: center;
  position: relative;
`,_t=s.memo((function({children:e,className:t="",closeOnScroll:n,isDisabled:i,onCloseAction:r,position:o="left",value:l}){const{themeClassName:c}=(0,A.F)(),[d,u,m]=(0,me.O)(!1),h=(0,s.useRef)(null),p=(0,s.useRef)(null),g=(0,s.useCallback)((()=>m(!1)),[m]),f=(0,s.useMemo)((()=>[h,p]),[h,p]);return Ft(f,g),(0,s.useEffect)((()=>(n&&document.addEventListener("scroll",g,!0),()=>document.removeEventListener("scroll",g,!0))),[n,g,m]),(0,s.useEffect)((()=>{!d&&r&&r()}),[d,r]),(0,a.jsxs)(Xt,{className:`${t} ui--Popup ${c}`,children:[d&&(0,a.jsx)(Yt,{position:o,triggerRef:h,windowRef:p,children:l}),(0,a.jsx)("div",{"data-testid":"popup-open",onClick:u,ref:h,children:e??(0,a.jsx)(K,{className:d?"isOpen":"",icon:"ellipsis-v",isDisabled:i,isReadOnly:!1})})]})})),en=s.memo((function({judgement:{judgementName:e,registrars:t}}){const n=(0,s.useMemo)((()=>{return"Erroneous"===(t=e)||"Low quality"===t?"red":"green";var t}),[e]);return(0,a.jsx)(_t,{closeOnScroll:!0,position:"middle",value:(0,a.jsx)(Mt,{children:t.map((e=>e&&(0,a.jsx)(St,{value:e.address},e.address)))}),children:(0,a.jsx)(kt.Z,{color:n,label:`${t.length} ${e}`,size:"tiny"})})})),tn=y.z.div`
  margin-top: 0.714rem;
...
`,nn=s.memo((function({address:e,className:t=""}){const{t:n}=(0,R.$)(),s=yt(e);return 0===s.length?(0,a.jsx)("div",{className:`${t} no-judgements`,"data-testid":"judgements",children:(0,a.jsx)(kt.Z,{color:"yellow",label:n("No judgements"),size:"tiny"},"NoJudgements")}):(0,a.jsx)(tn,{className:t,"data-testid":"judgements",children:s.map((t=>(0,a.jsx)(en,{judgement:t},`${e}${t.judgementName}`)))})}));var an=n(25294),sn=n(33749),rn=n(23729),on=n.n(rn),ln=n(69187),cn=n(99374),dn=n(1346),un=n(17751),mn=n(61162),hn=n(72282),pn=n.n(hn),gn=n(54371);const fn=()=>{},bn=y.z.div`
  .copySpan {
    white-space: nowrap;
  }
`,xn=s.memo((function({children:e,className:t="",icon:n="copy",label:i,type:r,value:o}){const{t:l}=(0,R.$)(),{queueAction:c}=(0,ve.L)(),d=(0,s.useCallback)((()=>{c&&c({action:l("clipboard"),message:l("{{type}} copied",{replace:{type:r||l("value")}}),status:"queued"})}),[r,c,l]);return(0,gn.H)(o)?(0,a.jsx)(bn,{className:`${t} ui--CopyButton`,children:(0,a.jsx)(pn(),{onCopy:d,text:o,children:(0,a.jsxs)("div",{className:"copyContainer",children:[e,(0,a.jsx)("span",{className:"copySpan",children:(0,a.jsx)(K,{className:"icon-button show-on-hover",icon:n,isDisabled:!o,label:i,onClick:fn})})]})})}):null}));var vn=n(12493);const An=s.memo((function({children:e,className:t="",copyValue:n,defaultValue:s,isFull:i,isHidden:r,isSmall:o,label:l,value:c,withCopy:d,withLabel:u}){return(0,a.jsxs)(vn.Z,{className:t,isFull:i,isHidden:r,isSmall:o,label:l,withLabel:u,children:[(0,a.jsxs)("div",{className:"ui--Static ui dropdown selection disabled",children:[c||s,e]}),d&&(0,a.jsx)(xn,{value:n||c||s})]})})),wn=y.z.div`
  display: flex;
  flex-wrap: nowrap;
...
`,yn=s.memo((function({address:e,className:t=""}){return(0,a.jsxs)(wn,{className:`${t} ui--KeyPair`,children:[(0,a.jsx)(tt,{className:"icon",value:e}),(0,a.jsx)("div",{className:"name",children:(0,a.jsx)(F,{value:e})}),(0,a.jsx)("div",{className:"address",children:e})]})}));function kn(e,t=!0){const n="ethereum"===ln.Nn.keyring.type?20:32;try{if((0,x.m)(e.key).length>=n)return{...e,text:(0,a.jsx)(yn,{address:e.key||"",isUppercase:t,name:e.name})}}catch{}return null}const jn="options:InputAddress",Nn="all",Cn=[];function Sn(e){try{return(0,v.Hc)(e,!1,"ethereum"===ln.Nn.keyring.type?20:32)||null}catch{}return null}function En(e){if(!e)return null;return Sn(e)||null}function In(e){let t;const n=ln.Nn.getAccount(e);let a;if(n)a=n.meta.name;else{const n=ln.Nn.getAddress(e);n?(a=n.meta.name,t=n.meta.isRecent):t=!0}return kn((0,cn.e)(e,a),!t)}function Bn(){return on().get(jn)||{defaults:{}}}function Dn(e=Nn){return Bn().defaults[e]}function Ln(e=Nn,t){const n=Bn();n.defaults[e]=t,on().set(jn,n)}function Pn(e){return e.reduce(((e,t,n)=>(e.some((({key:e},a)=>a!==n&&e===t.key))||e.push(t),e)),[])}class Tn extends s.PureComponent{state={};static getDerivedStateFromProps({type:e,value:t},{lastValue:n}){try{return{lastValue:n||Dn(e),value:Array.isArray(t)?t.map((e=>(0,v.Hc)(e))):(0,v.Hc)(t)||void 0}}catch{return null}}render(){const{className:e="",defaultValue:t,hideAddress:n=!1,isDisabled:s=!1,isError:i,isMultiple:r,label:o,labelExtra:l,options:c,optionsAll:d,placeholder:u,type:m=Nn,withEllipsis:h,withLabel:p}=this.props;if(!(c&&0!==c.length||d&&0!==Object.keys(d[m]).length||s))return(0,a.jsx)(An,{className:e,label:o,children:"No accounts are available for selection."});const{lastValue:g,value:f}=this.state,b=this.getLastOptionValue(),x=Sn(s||t&&"0x"!==t&&(this.hasValue(t)||"allPlus"===m)?t:this.hasValue(g)?g:b?.value),v=c?Pn(c.map((e=>kn(e))).filter((e=>!!e))):s&&x?[In(x)].filter((e=>!!e)):x?this.addActual(x):this.getFiltered(),A=r||!(0,dn.o)(f)?void 0:x;return(0,a.jsx)(Vn,{className:`${e} ui--InputAddress ${n?"hideAddress":""}`,defaultValue:A,isDisabled:s,isError:i,isMultiple:r,label:o,labelExtra:l,onChange:r?this.onChangeMulti:this.onChange,onSearch:this.onSearch,options:v,placeholder:u,renderLabel:r?this.renderLabel:void 0,value:r&&!f?Cn:f,withEllipsis:h,withLabel:p})}addActual(e){const t=this.getFiltered();return this.hasValue(e)?t:t.concat(...[In(e)].filter((e=>!!e)))}renderLabel=({value:e})=>{if(e)return(0,v.s2)(e)};getLastOptionValue(){const e=this.getFiltered();return e.length?e[e.length-1]:void 0}hasValue(e){const t=e?.toString();return this.getFiltered().some((({value:e})=>e===t))}getFiltered(){const{filter:e,optionsAll:t,type:n=Nn,withExclude:a=!1}=this.props;return t?Pn(t[n]).filter((({value:t})=>!e||!!t&&(a?!e.includes(t):e.includes(t)))):[]}onChange=e=>{const{filter:t,onChange:n,type:a}=this.props;!t&&Ln(a,e),n&&n(e&&(this.hasValue(e)||"allPlus"===a&&(0,mn.U)(e))?En(e):null)};onChangeMulti=e=>{const{onChangeMulti:t}=this.props;t&&t(e.map(En).filter((e=>!!e)))};onSearch=(e,t)=>{const{isInput:n=!0}=this.props,a=t.trim(),s=a.toLowerCase(),i=e.filter((e=>!!e.value&&"string"==typeof e.name&&(e.name.toLowerCase?.().includes(s)||e.value.toString().toLowerCase().includes(s))));if(n&&0===i.length){const e=En(a);if(e){const t=ln.Nn.saveRecent(e.toString()).option;i.push({key:t.key,name:t.name,value:t.value||void 0})}}return i.filter(((e,t)=>{const n=t===i.length-1,a=i[t+1],s=a?.value;return!((0,un.F)(e.value)||(0,dn.o)(e.value))||!n&&!!s}))}}const Vn=(0,y.z)(an.Z)`
  .ui.dropdown .text {
    width: 100%;
  }
...
`,Mn=(0,ee.withMulti)(Tn,(0,ee.withObservable)(ln.Nn.keyringOption.optionsSubject,{propName:"optionsAll",transform:e=>Object.entries(e).reduce(((e,[t,n])=>(e[t]=n.map((e=>null===e.value?function(e){return(0,a.jsx)(an.Z.Header,{content:e.name},e.key||e.name)}(e):kn(e))).filter((e=>!!e)),e)),{})}));Mn.createOption=kn,Mn.setLastValue=Ln;const Fn=Mn,zn=y.z.article`
  .ui--Icon {
    color: rgba(255, 12, 12, 1);
    margin-right: 0.5rem;
  }
`,Zn=s.memo((function({children:e,className:t="",content:n}){return(0,a.jsxs)(zn,{className:`${t} mark error`,children:[(0,a.jsx)(w.Z,{icon:"exclamation-triangle"}),n,e]})}));var Rn=n(31383);function $n(e="<unknown>"){return(0,a.jsx)(a.Fragment,{children:e.split("\n").map(((e,t)=>(0,a.jsx)("div",{children:e},t)))})}class qn extends s.Component{state={error:null,prevTrigger:null};static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps({trigger:e},{prevTrigger:t}){const n=JSON.stringify({trigger:e});return t!==n?{error:null,prevTrigger:n}:null}componentDidCatch(e){const{doThrow:t,onError:n}=this.props;if(n&&n(),t)throw e}render(){const{children:e,error:t,t:n}=this.props,{error:s}=this.state,i=t||s;return i?(0,a.jsxs)("article",{className:"error extraMargin",children:[(0,a.jsx)("p",{children:n("Uncaught error. Something went wrong with the query and rendering of this component. Please supply all the details below when logging an issue, it may help in tracing the cause.")}),(0,a.jsx)("p",{children:i.message}),$n(i.stack)]}):e}}const Hn=(0,R.Z)(qn),Un=y.z.div`
...
`,On=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Un,{className:`${t} ui--Modal-Actions`,children:(0,a.jsx)(K.Group,{children:e})})})),Wn=y.z.div`
  align-items: center;
  display: flex;
  justify-content: space-between;
...
`,Qn=s.memo((function({align:e="left",children:t,className:n="",hint:s}){return(0,a.jsxs)(Wn,{className:`${n} ui--Modal-Columns ${e}Align`,children:[(0,a.jsx)("div",{className:"ui--Modal-Columns-content",children:t}),s&&(0,a.jsx)("div",{className:"ui--Modal-Columns-hint",children:s})]})})),Gn=y.z.div`
  padding: 1.5rem;
`,Jn=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Gn,{className:`${t} ui--Modal-Content`,children:e})})),Kn=y.z.div`
  display: flex;
  justify-content: space-between;
  padding: 0.75rem 1.5rem 0;
`,Yn=s.memo((function({className:e="",header:t,onClose:n}){return(0,a.jsxs)(Kn,{className:`${e} ui--Modal-Header`,children:[t&&(0,a.jsx)("h1",{children:t}),(0,a.jsx)(K,{dataTestId:"close-modal",icon:"times",onClick:n})]})})),Xn=Rn.vJ`
  body {
    overflow: hidden;
  }
`,_n=y.z.div`
...
`,ba=s.memo((function({className:e="",isDisabled:t,isRadio:n,label:i,onChange:r,preventDefault:o,value:l}){const c=(0,s.useCallback)((e=>{t||(o&&(e.preventDefault(),e.stopPropagation()),r&&r(!l))}),[t,r,o,l]);return(0,a.jsxs)(fa,{className:`${e} ui--Toggle ${l?"isChecked":""} ${t?"isDisabled":""} ${n?"isRadio":""}`,onClick:c,children:[i&&(0,a.jsx)("label",{children:i}),(0,a.jsx)("div",{className:"ui--Toggle-Slider "+(n?"highlight--before-border":"")})]})}));var xa=n(14081);const va=(0,y.z)(ta)`
  .balance {
    margin-bottom: 0.5rem;
    text-align: right;
    padding-right: 1rem;
...
`,Aa=s.memo((function({className:e="",onClose:t,recipientId:n,senderId:i}){const{t:r}=(0,R.$)(),{api:o}=(0,l.h)(),[c,d]=(0,s.useState)(ie.nw),[u]=(0,s.useState)(!0),[m,h]=(0,s.useState)(!0),[p,g]=(0,s.useState)(!1),[f,x]=(0,s.useState)(),[[v,A],w]=(0,s.useState)([null,!1]),[y,k]=(0,s.useState)(null),[j,N]=(0,s.useState)(null),[[,C],S]=(0,s.useState)([null,null]),E=(0,be.W7)(o.derive.balances?.all,[i||j]),I=(0,be.W7)(o.query.system.account,[i||j]);(0,s.useEffect)((()=>{const e=i||j,t=n||y;e&&x((0,xa.L)(e)),E&&E.accountId?.eq(e)&&e&&t&&o.call.transactionPaymentApi&&o.tx.balances?(0,ua.Y)((async()=>{try{const n=(o.tx.balances.transferAllowDeath||o.tx.balances.transfer)(t,E.transferable||E.availableBalance),{partialFee:a}=await n.paymentInfo(e),s=a.muln(110).div(ie.S8),i=(E.transferable||E.availableBalance).sub(s);w(o.consts.balances&&i.gt(o.consts.balances.existentialDeposit)?[i,!1]:[null,!0])}catch(e){console.error(e)}})):w([null,!1])}),[o,E,n,i,y,j]),(0,s.useEffect)((()=>{(async function(e,t){return[null,t?await(0,ca.fF)(t):null]})(0,n||y).then(S).catch(console.error)}),[n,i,y,j]);const B=!I||(function(e){return!!e.refcount}(I)?I.refcount.isZero():I.consumers.isZero()),D=!m&&E&&E.accountId?.eq(i||j)&&v&&B;return(0,a.jsxs)(va,{className:"app--accounts-Modal",header:r("Send funds"),onClose:t,size:"large",children:[(0,a.jsx)(ta.Content,{children:(0,a.jsxs)("div",{className:e,children:[(0,a.jsx)(ta.Columns,{hint:r("The transferred balance will be subtracted (along with fees) from the sender account."),children:(0,a.jsx)(Fn,{defaultValue:i,isDisabled:!!i,label:r("send from account"),labelExtra:(0,a.jsx)(da.Z,{label:r("transferable"),params:i||j}),onChange:N,type:"account"})}),(0,a.jsxs)(ta.Columns,{hint:r("The beneficiary will have access to the transferred fees when the transaction is included in a block."),children:[(0,a.jsx)(Fn,{defaultValue:n,isDisabled:!!n,label:r("send to address"),labelExtra:(0,a.jsx)(da.Z,{label:r("transferable"),params:n||y}),onChange:k,type:"allPlus"}),C&&(0,a.jsx)(Zn,{content:r("The recipient is associated with a known phishing site on {{url}}",{replace:{url:C}})})]}),(0,a.jsx)(ta.Columns,{hint:r("By selecting this option, the transaction fee will be automatically deducted from the specified asset, ensuring a seamless and efficient payment process."),children:(0,a.jsx)(ga,{})}),(0,a.jsx)(ta.Columns,{hint:r("If the recipient account is new, the balance needs to be more than the existential deposit. Likewise if the sending account balance drops below the same value, the account will be removed from the state."),children:D&&p?(0,a.jsx)(ma.Z,{autoFocus:!0,defaultValue:v,isDisabled:!0,label:r("transferable minus fees")},v?.toString()):(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ma.Z,{autoFocus:!0,isError:!u,isZeroable:!0,label:r("amount"),maxValue:v,onChange:d}),(0,a.jsx)(ma.Z,{defaultValue:o.consts.balances?.existentialDeposit,isDisabled:!0,label:r("existential deposit")})]})}),(0,a.jsxs)(ta.Columns,{hint:r("With the keep-alive option set, the account is protected against removal due to low balances."),children:[(0,b.m)(o.tx.balances?.transferKeepAlive)&&(0,a.jsx)(ba,{className:"typeToggle",label:r(m?"Transfer with account keep-alive checks":"Normal transfer without keep-alive checks"),onChange:h,value:m}),D&&(0,a.jsx)(ba,{className:"typeToggle",label:r("Transfer the full account balance, reap the sender"),onChange:g,value:p}),f&&f.isHardware&&(0,a.jsx)(pa,{content:r(`You are using the Ledger ${Xe.X.ledgerApp.toUpperCase()} App. If you would like to switch it, please go the "manage ledger app" in the settings.`)}),!m&&!B&&(0,a.jsx)(pa,{content:r("There is an existing reference count on the sender account. As such the account cannot be reaped from the state.")}),A&&(0,a.jsx)(pa,{content:r("The transaction, after application of the transfer fees, will drop the available balance below the existential deposit. As such the transfer will fail. The account needs more free funds to cover the transaction fees.")})]})]})}),(0,a.jsx)(ta.Actions,{children:(0,a.jsx)(Ne,{accountId:i||j,icon:"paper-plane",isDisabled:!((p||u&&c)&&(n||y)&&!C),label:r("Make Transfer"),onStart:t,params:D&&p?(0,b.m)(o.tx.balances?.transferAll)?[n||y,!1]:[n||y,v]:[n||y,c],tx:D&&p&&(0,b.m)(o.tx.balances?.transferAll)?o.tx.balances?.transferAll:m?o.tx.balances?.transferKeepAlive:o.tx.balances?.transferAllowDeath||o.tx.balances?.transfer})})]})})),wa=y.z.div`
  width: 100%;
...
`,Na=s.memo((function({className:e="",color:t,label:n}){return(0,a.jsx)(ja,{className:`${e} ${"theme"===t?" highlight--color-bg highlight--bg":""}`,color:t,label:n,size:"tiny"})})),Ca=y.z.div`
  .ui--Tag {
    margin: 0.2rem 1rem 0.2rem 0.571rem;
  }
`,Sa=s.memo((function({className:e="",flags:{isCouncil:t,isDevelopment:n,isExternal:s,isInjected:i,isMultisig:r,isNominator:o,isProxied:l,isSociety:c,isSudo:d,isTechCommittee:u,isValidator:m}}){const{t:h}=(0,R.$)(),p=t||n||s||i||r||l||c||d||u||m||o;return p?(0,a.jsxs)(Ca,{className:`${e} ui--AddressMenu-flags`,children:[p&&(0,a.jsx)("h5",{children:h("Flags")}),(0,a.jsxs)("div",{children:[m&&(0,a.jsx)(Na,{color:"theme",label:h("Validator")}),o&&(0,a.jsx)(Na,{color:"theme",label:h("Nominator")}),s&&(r?(0,a.jsx)(Na,{color:"green",label:h("Multisig")}):l?(0,a.jsx)(Na,{color:"grey",label:h("Proxied")}):(0,a.jsx)(Na,{color:"grey",label:h("External")})),i&&(0,a.jsx)(Na,{color:"grey",label:h("Injected")}),n&&(0,a.jsx)(Na,{color:"grey",label:h("Test account")}),t&&(0,a.jsx)(Na,{color:"blue",label:h("Council")}),c&&(0,a.jsx)(Na,{color:"green",label:h("Society")}),u&&(0,a.jsx)(Na,{color:"orange",label:h("Technical committee")}),d&&(0,a.jsx)(Na,{color:"pink",label:h("Sudo key")})]})]}):null})),Ea=s.memo((function({accountIndex:e,address:t,isBeingEdited:n,onUpdateName:i,sidebarRef:r}){const{flags:o,isEditing:l,isEditingName:c,isEditingTags:d,name:u,onForgetAddress:m,onSaveName:h,onSaveTags:p,setIsEditingName:g,setIsEditingTags:f,setName:b,setTags:x,tags:v,toggleIsEditingName:A,toggleIsEditingTags:w}=(0,z.B)(t),y=(0,s.useMemo)((()=>[r]),[r]);(0,s.useEffect)((()=>{n(l())}),[n,l]);const k=(0,s.useCallback)((()=>{if(l())try{const e=ln.Nn.getAccount(t)||ln.Nn.getAddress(t);b(e?.meta.name||""),x(e?.meta.tags?e.meta.tags.sort():[]),g(!1),f(!1)}catch{}}),[l,b,x,g,f,t]);return Ft(y,k),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ka,{accountIndex:e,defaultValue:u,editingName:c,flags:o,onChange:b,value:t}),(0,a.jsx)("div",{className:"ui--AddressMenu-tags","data-testid":"sidebar-tags",children:(0,a.jsx)(la.Z,{isEditable:!0,isEditing:d,onChange:x,value:v,withEditButton:!1,withTitle:!0})}),(0,a.jsx)(Sa,{flags:o}),(0,a.jsx)(ya,{flags:o,isEditing:l(),isEditingName:c,onCancel:k,onForgetAddress:m,onSaveName:h,onSaveTags:p,onUpdateName:i,recipientId:t,toggleIsEditingName:A,toggleIsEditingTags:w})]})})),Ia=(0,y.z)(X)`
  display: flex;
  flex-direction: column;
...
`,Ba=s.memo((function({address:e,className:t="",dataTestId:n,onClose:i,onUpdateName:r}){const[o,l]=(0,s.useState)(!1),{accountIndex:c,flags:d,identity:u,meta:m}=(0,z.B)(e),h=(0,s.useRef)(null);return(0,a.jsxs)(Ia,{className:`${t}${o?" inEditMode":""}`,dataTestId:n,onClose:i,position:"right",sidebarRef:h,children:[(0,a.jsx)("div",{className:"ui--AddressMenu-header","data-testid":"sidebar-address-menu",children:(0,a.jsx)(Ea,{accountIndex:c,address:e,isBeingEdited:l,onUpdateName:r,sidebarRef:h})}),(0,a.jsxs)("div",{className:"ui--ScrollSection",children:[(0,a.jsx)(Oe,{address:e}),(0,a.jsx)(ra,{address:e,identity:u}),(0,a.jsx)(oa,{isMultisig:d.isMultisig,meta:m})]}),(0,a.jsx)("section",{className:"ui--LinkSection",children:(0,a.jsx)(H,{data:e,isSidebar:!0,type:"address"})})]})})),Da=[null,null],La=s.memo((function({children:e}){const[[t,n],i]=(0,s.useState)(Da),r=(0,s.useCallback)((()=>i([null,null])),[]);return(0,a.jsxs)(c.Provider,{value:i,children:[e,t&&(0,a.jsx)(Ba,{address:t,dataTestId:"account-sidebar",onClose:r,onUpdateName:n})]})}));var Pa=n(16613);const Ta="5".padEnd(48,"x"),Va=(0,y.z)(Pa.Z)`
...
`,Ma=s.memo((function({buttons:e,children:t,className:n,defaultName:s,fullLength:i=!1,isContract:r=!1,isDisabled:o,isEditableName:l,isInline:c,isValid:d,overlay:u,value:m,withTags:h=!1}){const{accountIndex:p,isNull:g,name:f,onSaveName:b,onSaveTags:x,setName:v,setTags:A,tags:w}=(0,z.B)(m?m.toString():null,r),y=!g&&(d||m||p),k=m?tt:Ye.ZP,j=m&&y?m:Ta;return(0,a.jsxs)(Va,{address:j,buttons:e,className:n,defaultName:s,icon:(0,a.jsx)(k,{size:32,value:m?m.toString():null}),isDisabled:o,isEditableName:l,isEditableTags:!0,isInline:c,isShortAddr:!i,name:f,onChangeName:v,onChangeTags:A,onSaveName:b,onSaveTags:x,tags:h?w:void 0,children:[t,u]})})),Fa=y.z.div`
  align-items: flex-start;
...
`,za=s.memo((function({address:e,className:t="",filter:n,isHidden:i,noToggle:o,onChange:c,value:d}){const{apiIdentity:u}=(0,l.h)(),m=(0,r.Y)(e),h=(0,s.useMemo)((()=>!m||(0,v.r7)(u,e,m,n,!1)),[e,n,m,u]),p=(0,s.useCallback)((()=>c&&c(!d)),[c,d]);return(0,a.jsxs)(Fa,{className:`${t} ui--AddressToggle ${d||o?"isAye":"isNay"} ${i||!h?"isHidden":""}`,onClick:p,children:[(0,a.jsx)(mt,{className:"ui--AddressToggle-address",value:e,withSidebar:!1}),!o&&(0,a.jsx)("div",{className:"ui--AddressToggle-toggle",children:(0,a.jsx)(ba,{label:"",value:d})})]})})),Za=s.memo((function({className:e="",label:t,params:n}){return n?(0,a.jsx)(da.Z,{className:`${e} ui--Available`,label:t,params:n}):null})),Ra=s.memo((function(){const{t:e}=(0,R.$)(),{api:t}=(0,l.h)();return(0,b.m)(t.tx.utility.batchAll)?null:(0,a.jsx)(pa,{content:e("This chain does not yet support atomic batch operations. This means that if the transaction gets executed and one of the operations do fail (due to invalid data or lack of available funds) some of the changes made may not be applied.")})}));s.memo((function({className:e="",isDisabled:t,label:n,onClick:s,tabIndex:i}){const{t:r}=(0,R.$)();return(0,a.jsx)(K,{className:e,icon:"times",isDisabled:t,label:n||r("Cancel"),onClick:s,tabIndex:i})}));const $a=y.z.article`
  position: relative;
  flex: 1 1;
  min-width: 24%;
  justify-content: space-around;
...
`,qa=s.memo((function({children:e,className:t="",isError:n,isSuccess:s,withBottomMargin:i}){return(0,a.jsx)($a,{className:`${t} ui--Card ${n&&!s?"error":""} ${!n&&s?"success":""} ${i?"withBottomMargin":""}`,children:e})}));var Ha=n(12372);const Ua=s.memo((function({angle:e,type:t}){return(0,a.jsx)("div",{className:`clip ${t}`,children:(0,a.jsx)("div",{className:"highlight--bg",style:{transform:`rotate(${e}deg)`}})})})),Oa="3.5rem",Wa=y.z.div`
  border-radius: 100%;
  clip-path: circle(50%);
  height: ${Oa};
  position: relative;
...
`,Qa=s.memo((function({className:e="",isBlurred:t,isDisabled:n,total:s,value:i}){const r=(0,Ha.G)(s||0),o=r.gtn(0)?(0,Ha.G)(i||0).muln(36e3).div(r).toNumber()/100:0;if(o<0)return null;const l=360===o?360:o%360;return(0,a.jsxs)(Wa,{className:`${e} ui--Progress ${n?"isDisabled":""} ${t?"--tmp":""}`,children:[(0,a.jsx)("div",{className:"background highlight--bg"}),(0,a.jsx)(Ua,{angle:l<=180?l.toFixed(1):"180",type:"first"}),(0,a.jsx)(Ua,{angle:l<=180?"0":(l-180).toFixed(1),type:"second"}),(0,a.jsx)("div",{className:"inner",children:(0,a.jsxs)("div",{children:[Math.floor(100*o/360),"%"]})})]})})),Ga=y.z.article`
  align-items: center;
...
`,vs=s.memo((function({className:e="",isDisabled:t,label:n,onChange:i,value:r}){const o=(0,s.useCallback)((()=>{!t&&i&&i(!r)}),[t,i,r]);return(0,a.jsxs)(xs,{className:`${e} ui--Checkbox ${t?"isDisabled":""}`,onClick:o,children:[(0,a.jsx)(w.Z,{color:r?"normal":"transparent",icon:"check"}),n&&(0,a.jsx)("label",{children:n})]})})),As="750px",ws="550px",ys="\n  display: flex;\n  flex-wrap: wrap;\n\n  &.is50 {\n    > .ui--Column {\n      max-width: 50%;\n      min-width: 50%;\n    }\n  }\n\n  &.is60 {\n    > .ui--Column:first-child {\n      max-width: 60%;\n      min-width: 60%;\n    }\n\n    > .ui--Column:last-child {\n      max-width: 40%;\n      min-width: 40%;\n    }\n  }\n\n  &.is100 {\n    > .ui--Column {\n      max-width: 100%;\n      min-width: 100%;\n    }\n  }\n",ks=y.z.div`
  &.isReverse {
  ...
  &.smallSize {
    @media only screen and (min-width: ${As}) {
      ${ys}
    }
  ...
  &.defaultSize, &.smallSize {
    @media only screen and (max-width: ${As}) {
      &.isPadded > .ui--Column {
        padding: 0 0.5rem;
      }
    }
...
`,js=s.memo((function({children:e,className:t="",is60:n,is100:s,isPadded:i=!0,isReverse:r,size:o="default"}){return(0,a.jsx)(ks,{className:`${t} ui--Columar ${s?"is100":n?"is60":"is50"} ${i?"isPadded":""} ${r?"isReverse":""} ${o}Size`,children:e})}));js.Column=function({children:e,className:t=""}){return(0,a.jsx)("div",{className:`${t} ui--Column`,children:e})};const Ns=js;var Cs=n(13731),Ss=(n(79472),n(92890));const Es=y.z.div`
  .codeflask {
...
`,Is=s.memo((function({className:e="",code:t,isValid:n,onEdit:i}){const[r]=(0,s.useState)((()=>`flask-${Date.now()}`)),o=(0,s.useRef)(null);return(0,s.useEffect)((()=>{const e=new Ss.Z(`#${r}`,{language:"js",lineNumbers:!0});e.updateCode(t),e.editorRoot.addEventListener("keydown",(()=>{e.onUpdate(i)})),o.current=e}),[]),(0,s.useEffect)((()=>{o.current&&o.current.updateCode(t)}),[t]),(0,a.jsx)(Es,{className:`${e} ui-Editor ${!1===n?"invalid":""}`,id:r})})),Bs=y.z.div`
  ...
  border-radius: 4px;
  cursor: pointer;
`,Ds=s.memo((function({className:e="",expanded:t,onClick:n}){return(0,a.jsx)(Bs,{className:`${e} ui--ExpandButton`,"data-testid":"row-toggle",onClick:n,children:(0,a.jsx)(w.Z,{icon:t?"caret-up":"caret-down"})})}));var Ls=n(27421);const Ps=(0,we.e)("useWindowColumns",(function(e=3){const t=Wt();return(0,Ls.N)(e>=3&&t.width>=1500?3:e>=2&&t.width>=1050?2:1)})),Ts=s.memo((function({children:e,className:t="",colSpan:n,label:s,labelPost:i,rowSpan:r,value:o,withLoading:l}){return(0,a.jsxs)("td",{className:`${t} ui--Table-Column-Balance number`,colSpan:n,rowSpan:r,children:[o?(0,a.jsx)(ne.Z,{label:s,labelPost:i,value:o}):l&&(0,a.jsx)(ne.Z,{className:"--tmp",value:1}),e]})})),Vs=y.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1.7rem;
...
`,Ms=s.memo((function({className:e="",colSpan:t,isExpanded:n,rowSpan:s,toggle:i}){return(0,a.jsx)(Vs,{className:`${e} ui--Table-Column-Expand`,colSpan:t,onClick:i,rowSpan:s,children:(0,a.jsx)("div",{children:(0,a.jsx)(w.Z,{icon:n?"caret-up":"caret-down"})})})})),Fs=y.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1rem;
...
`,zs=s.memo((function({address:e,className:t="",colSpan:n,isFavorite:i,rowSpan:r,toggle:o}){const l=(0,s.useCallback)((()=>o(e)),[e,o]);return(0,a.jsx)(Fs,{className:`${t} ui--Table-Column-Favorite`,colSpan:n,onClick:l,rowSpan:r,children:(0,a.jsx)(w.Z,{color:i?"orange":"gray",icon:"star"})})})),Zs=`${7.15.toFixed(3)}ch`,Rs=y.z.td`
  && {
    box-sizing: content-box;
    min-width: ${Zs};
    text-align: right;
    white-space: nowrap;
    width: ${Zs};
`,$s=s.memo((function({children:e,className:t="",colSpan:n,rowSpan:s,value:i}){return(0,a.jsxs)(Rs,{className:`${t} ui--Table-Column-Id`,colSpan:n,rowSpan:s,children:[(0,a.jsx)("h2",{className:"--digits",children:(0,g.u)(i)}),e]})})),qs=s.memo((function({children:e,className:t=""}){return(0,a.jsx)("td",{className:`${t} ui--Table-Column`,children:e})}));qs.Balance=Ts,qs.Expand=Ms,qs.Favorite=zs,qs.Id=$s;const Hs=qs,Us=s.memo((function({children:e,className:t=""}){return(0,a.jsx)("tr",{className:`${t} ui--Table-Row`,children:e})})),Os=s.memo((function({children:e,className:t="",empty:n,emptySpinner:s,isEmpty:i,noBodyTag:r}){const o=`${t} ui--Table-Body`;return i?(0,a.jsx)("tbody",{className:o,children:(0,a.jsx)("tr",{children:(0,a.jsx)("td",{colSpan:100,children:(0,gn.H)(n)?(0,a.jsx)("div",{className:"empty",children:n}):n||(0,a.jsx)(O,{label:s})})})}):r?(0,a.jsx)(a.Fragment,{children:e}):(0,a.jsx)("tbody",{className:o,children:e})})),Ws=y.z.tfoot`
  td {
...
`,Qs=s.memo((function({className:e="",footer:t,isEmpty:n}){return!t||n?null:(0,a.jsx)(Ws,{className:`${e} ui--Table-Foot`,children:t})})),Gs=y.z.thead`
  z-index: 1;
...
`,ti=s.memo((function({children:e,className:t="",empty:n,emptySpinner:s,filter:i,footer:r,header:o,headerChildren:l,isFixed:c,isInline:d,isSplit:u,legend:m,maxColumns:h,noBodyTag:p}){const g=Ps(h),f=Array.isArray(e),b=!e||f&&0===e.length,x=(0,a.jsx)(Js,{filter:i,header:o,isEmpty:b,children:l});return u&&f&&!b&&1!==g?(0,a.jsxs)(ei,{className:`${t} ui--Table isSplit`,children:[m,(0,a.jsx)("table",{className:"noMargin",children:x}),(0,a.jsx)("div",{className:"ui--Table-Split",children:Ks[g].map((t=>(0,a.jsx)("div",{className:`ui--Table-Split-${g}`,children:(0,a.jsx)("table",{className:"noMargin",children:(0,a.jsx)("tbody",{className:"ui--Table-Body",children:e.filter(((e,n)=>n%g===t))})})},t)))})]}):(0,a.jsxs)(ei,{className:`${t} ui--Table`,children:[m,(0,a.jsxs)("table",{className:`${c&&!b?"isFixed":"isNotFixed"} ${d?"isInline":""}`,children:[x,(0,a.jsx)(Os,{empty:n,emptySpinner:s,isEmpty:b,noBodyTag:p,children:e}),(0,a.jsx)(Qs,{footer:r,isEmpty:b})]})]})}));ti.Column=Hs,ti.Row=Us;const ni=ti;function ai(e,t){return(0,a.jsx)("tr",{children:(0,a.jsx)("td",{children:e})},t)}const si=(0,y.z)(pe)`
  .tableContainer {
    overflow-y: scroll;
    display: block;
    margin: 0 0 0 auto;
...
`,oi=s.memo((function({className:e="",filterOn:t,label:n,setFilter:s}){return(0,a.jsx)(ri,{className:e,children:(0,a.jsx)(sn.ZP,{autoFocus:!0,isFull:!0,label:n,onChange:s,value:t})})})),li=y.z.div`
  display: none;
...
`;s.memo((function({className:e="",md:t}){const[n,s]=(0,me.O)();return(0,a.jsxs)(fi,{className:`${e} ui--HelpOverlay`,children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(w.Z,{icon:"question-circle",onClick:s})}),(0,a.jsxs)("div",{className:"help-slideout "+(n?"open":"closed"),children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(w.Z,{icon:"times",onClick:s})}),(0,a.jsx)(pi.U,{className:"help-content",rehypePlugins:gi,children:t})]})]})}));const bi=(0,y.z)(vn.Z)`
  background: white;
...
`,xi=s.memo((function({children:e,className:t="",type:n="info"}){return(0,a.jsx)(bi,{children:(0,a.jsx)("div",{className:`${t} ${n}`,children:e})})}));var vi=n(47623);const Ai=s.memo((function({address:e,filter:t,isHidden:n,onSelect:i}){const r=(0,s.useCallback)((()=>i(e)),[e,i]);return n?null:(0,a.jsx)(za,{address:e,filter:t,noToggle:!0,onChange:r})})),wi=s.memo((function({address:e,filter:t,isHidden:n,onDeselect:i}){const r=(0,s.useCallback)((()=>i(e)),[e,i]);return n?null:(0,a.jsx)(za,{address:e,filter:t,noToggle:!0,onChange:r})})),yi=y.z.div`
...
`,ki=s.memo((function({available:e,availableLabel:t,className:n="",defaultValue:i,maxCount:r,onChange:o,valueLabel:l}){const{t:c}=(0,R.$)(),[d,u]=(0,s.useState)(""),[m,h]=(0,s.useState)([]),p=(0,Ls.N)(d),g=(0,vi.q)();(0,s.useEffect)((()=>{i&&h(i)}),[i]),(0,s.useEffect)((()=>{m&&o(m)}),[o,m]);const f=(0,s.useCallback)((e=>h((t=>function(e,t,n){return!e.includes(t)&&e.length<n?e.concat(t):e}(t,e,r)))),[r]),b=(0,s.useCallback)((e=>h((t=>function(e,t){return e.includes(t)?e.filter((e=>e!==t)):e}(t,e)))),[]);return(0,a.jsxs)(yi,{className:`${n} ui--InputAddressMulti`,children:[(0,a.jsx)(sn.ZP,{autoFocus:!0,className:"ui--InputAddressMulti-Input",isSmall:!0,onChange:u,placeholder:c("filter by name, address, or account index"),value:d,withLabel:!1}),(0,a.jsxs)("div",{className:"ui--InputAddressMulti-columns",children:[(0,a.jsxs)("div",{className:"ui--InputAddressMulti-column",children:[(0,a.jsx)("label",{children:l}),(0,a.jsx)("div",{className:"ui--InputAddressMulti-items",children:m.map((e=>(0,a.jsx)(wi,{address:e,onDeselect:b},e)))})]}),(0,a.jsxs)("div",{className:"ui--InputAddressMulti-column",children:[(0,a.jsx)("label",{children:t}),(0,a.jsx)("div",{className:"ui--InputAddressMulti-items",children:g?e.map((e=>(0,a.jsx)(Ai,{address:e,filter:p,isHidden:m?.includes(e),onSelect:f},e))):(0,a.jsx)(O,{})})]})]})]})})),ji=y.z.div`
  position: relative;
...
`,Si=s.memo((function({children:e,className:t="",label:n,withLabel:s}){return(0,a.jsx)(Ci,{className:t,children:(0,a.jsx)(vn.Z,{label:n,withLabel:s,children:(0,a.jsx)("div",{className:"ui--DropdownLinked ui--row",children:e})})})}));function Ei(e,t){if(!t)return[];const n=e[t];return n&&0!==Object.keys(e[t]).length?Object.keys(e[t]).filter((e=>!e.startsWith("$"))).sort().map((e=>n[e])).map((({description:e,method:n,params:s})=>{const i=s.map((({name:e})=>e)).join(", ");return{className:"ui--DropdownLinked-Item",key:`${t}_${n}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[n,"(",i,")"]},`${t}_${n}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:e||n},`${t}_${n}:text`)],value:n}})):[]}const Ii=s.memo((function({className:e="",defs:t,isError:n,onChange:i,options:r,value:o}){const l=(0,s.useCallback)((e=>t[o.section][e]),[t,o]);return r.length?(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Items`,isError:n,onChange:i,onSearch:v.xW,options:r,transform:l,value:o.method,withLabel:!1}):null})),Bi=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:r}){return(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,onSearch:v.xW,options:i,value:r.section,withLabel:!1})}));function Di(e){return Object.entries(e).sort((([e],[t])=>e.localeCompare(t)))}const Li=(0,we.e)("useRuntime",(function(){const{api:e}=(0,l.h)();return(0,s.useMemo)((()=>function(e){const t={};let n=null;const a=Di(e.call);for(let e=0,s=a.length;e<s;e++){const[s,i]=a[e],r=Di(i);for(let e=0,a=r.length;e<a;e++){const[a,{meta:i}]=r[e];i&&(t[s]||(t[s]={},null===n&&(n=i)),t[s][a]=i)}}return[t,n]}(e)),[e])})),Pi=s.memo((function({className:e,label:t,onChange:n,withLabel:i}){const[r,o]=Li(),[l]=(0,s.useState)((()=>{return e=r,Object.keys(e).filter((e=>!e.startsWith("$"))).sort().filter((t=>0!==Object.keys(e[t]).length)).map((e=>({text:e,value:e})));var e})),[c,d]=(0,s.useState)((()=>Ei(r,o?.section))),[u,m]=(0,s.useState)((()=>o));(0,s.useEffect)((()=>{u&&n&&n(u)}),[n,u]);const h=(0,s.useCallback)((e=>{u!==e&&m((()=>e))}),[u]),p=(0,s.useCallback)((e=>{if(u&&e!==u.section){const t=Ei(r,e);d(t),h(r[e][t[0].value])}}),[h,r,u]);return u?(0,a.jsxs)(Si,{className:e,label:t,withLabel:i,children:[(0,a.jsx)(Bi,{className:"small",onChange:p,options:l,value:u}),(0,a.jsx)(Ii,{className:"large",defs:r,onChange:h,options:c,value:u})]}):null}));var Ti=n(44055);function Vi(e,t){const n=e.consts[t];return n&&0!==Object.keys(n).length?Object.keys(n).filter((e=>!e.startsWith("$"))).sort().map((s=>{const i=n[s];return{className:"ui--DropdownLinked-Item",key:`${t}_${s}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[s,": ",(0,Ti.I)(e.registry.lookup,i.meta.type)]},`${t}_${s}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(i.meta.docs[0]||i.meta.name).toString()},`${t}_${s}:text`)],value:s}})):[]}function Mi({value:e}){return t=>({method:t,section:e.section})}const Fi=s.memo((function(e){const{className:t="",isError:n,onChange:s,options:i,value:r}=e;return i.length?(0,a.jsx)(an.Z,{className:`${t} ui--DropdownLinked-Items`,isError:n,onChange:s,onSearch:v.xW,options:i,transform:Mi(e),value:r.method,withLabel:!1}):null})),zi=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:{section:r}}){return(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,onSearch:v.xW,options:i,value:r,withLabel:!1})})),Zi=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,l.h)(),[c,d]=(0,s.useState)((()=>Vi(o,t.section))),[u]=(0,s.useState)((()=>function(e){return Object.keys(e.consts).filter((e=>!e.startsWith("$"))).sort().filter((t=>Object.keys(e.consts[t]).length)).map((e=>({text:e,value:e})))}(o))),[m,h]=(0,s.useState)((()=>function(e,{method:t,section:n}){const a=Object.keys(e.consts)[0],s=Object.keys(e.consts[a])[0],i=e.consts[n]?.[t]?{method:t,section:n}:{method:s,section:a};return{...i,meta:e.consts[i.section][i.method].meta}}(o,t))),p=(0,s.useCallback)((e=>{if(m.section!==e.section||m.method!==e.method){const{method:t,section:n}=e,a={meta:o.consts[n][t].meta,method:t,section:n};h(a),i&&i(a)}}),[o,i,m]),g=(0,s.useCallback)((e=>{if(e!==m.section){const t=Vi(o,e);d(t),p({method:t[0].value,section:e})}}),[p,o,m]);return(0,a.jsxs)(Si,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(zi,{className:"small",onChange:g,options:u,value:m}),(0,a.jsx)(Fi,{className:"large",onChange:p,options:c,value:m})]})}));function Ri(e,t,n){const s=e.tx[t],i=!n||n(t);return s&&0!==Object.keys(s).length&&i?Object.keys(s).filter((e=>!e.startsWith("$")&&(!n||n(t,e)))).sort().map((e=>{const n=s[e],i=n.meta.args.map((e=>e.name.toString())).join(", ");return{className:"ui--DropdownLinked-Item",key:`${t}_${e}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[e,"(",i,")"]},`${t}_${e}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(n.meta.docs[0]||e).toString()},`${t}_${e}:text`)],value:e}})):[]}const $i=s.memo((function({api:e,className:t="",defaultValue:n,isDisabled:i,isError:r,onChange:o,options:l,value:c}){const d=(0,s.useCallback)((t=>e.tx[c.section][t]),[e,c]);return l.length?(0,a.jsx)(an.Z,{className:`${t} ui--DropdownLinked-Items`,defaultValue:n,isDisabled:i,isError:r,onChange:o,onSearch:v.xW,options:l,transform:d,value:c.method,withLabel:!1}):null})),qi=s.memo((function({className:e="",defaultValue:t,isDisabled:n,isError:s,onChange:i,options:r,value:o}){return(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isDisabled:n,isError:s,onChange:i,onSearch:v.xW,options:r,value:o.section,withLabel:!1})})),Hi=s.memo((function({className:e="",defaultValue:t,filter:n,isDisabled:i,label:r,onChange:o,withLabel:c}){const{api:d}=(0,l.h)(),[u,m]=(0,s.useState)((()=>Ri(d,t.section,n))),[h]=(0,s.useState)((()=>function(e,t){return Object.keys(e.tx).filter((e=>!e.startsWith("$")&&(!t||t(e)))).sort().filter((t=>Object.keys(e.tx[t]).length)).map((e=>({text:e,value:e})))}(d,n))),[p,g]=(0,s.useState)((()=>t)),[{defaultMethod:f,defaultSection:b}]=(0,s.useState)((()=>({defaultMethod:t.method,defaultSection:t.section}))),x=(0,s.useCallback)((e=>{p!==e&&(g((()=>e)),o&&o(e))}),[o,p]),v=(0,s.useCallback)((e=>{if(e!==p.section){const t=Ri(d,e,n);m(t),x(d.tx[e][t[0].value])}}),[x,d,n,p]);return(0,a.jsxs)(Si,{className:e,label:r,withLabel:c,children:[(0,a.jsx)(qi,{className:"small",defaultValue:b,isDisabled:i,onChange:i?void 0:v,options:h,value:p}),(0,a.jsx)($i,{api:d,className:"large",defaultValue:f,isDisabled:i,onChange:i?void 0:x,options:u,value:p})]})}));var Ui=n(6574),Oi=n(56623),Wi=n(48533);const Qi="0".charCodeAt(0),Gi="x".charCodeAt(0),Ji=()=>{},Ki=y.z.div`
  background: var(--bg-input);
  border: 1px solid var(--border-input);
...
`,Yi=s.memo((function({accept:e,className:t="",clearContent:n,isDisabled:i,isError:r=!1,isFull:o,label:l,labelExtra:c,onChange:d,placeholder:u,withEllipsis:m,withLabel:h}){const{t:p}=(0,R.$)(),f=(0,s.createRef)(),[b,x]=(0,s.useState)(),v=(0,s.useCallback)((e=>{e.forEach((e=>{const t=new FileReader;t.onabort=Ji,t.onerror=Ji,t.onload=({target:t})=>{if(t?.result){const n=e.name,a=function(e){const t=new Uint8Array(e);if(t[0]===Qi&&t[1]===Gi){let e=(0,Oi.z)(t);for(;e.endsWith("\n");)e=e.substring(0,e.length-1);if((0,Je.vq)(e))return(0,Wi.G)(e)}return t}(t.result);d&&d(a,n),f&&x({name:n,size:a.length})}},t.readAsArrayBuffer(e)}))}),[f,d]),{getInputProps:A,getRootProps:w}=(0,Ui.uI)({accept:e?.reduce(((e,t)=>({...e,[t]:[]})),{}),disabled:i,onDrop:v}),y=(0,a.jsxs)(Ki,{...w({className:`${t} ui--InputFile ${r?"error":""}`}),children:[(0,a.jsx)("input",{...A()}),(0,a.jsx)("em",{className:"label",children:!b||n?u||p("click to select or drag and drop the file here"):u||p("{{name}} ({{size}} bytes)",{replace:{name:b.name,size:(0,g.u)(b.size)}})})]});return l?(0,a.jsx)(vn.Z,{isFull:o,label:l,labelExtra:c,withEllipsis:m,withLabel:h,children:y}):y}));var Xi=n(39764);function _i(e,t,n){const s=t[n];return s&&0!==Object.keys(e.rpc[n]).length?Object.keys(e.rpc[n]).filter((e=>!e.startsWith("$"))).sort().map((e=>s[e])).filter((e=>!!e)).filter((({isSubscription:e})=>!e)).map((({description:e,method:t,params:s})=>{const i=s.map((({name:e})=>e)).join(", ");return{className:"ui--DropdownLinked-Item",key:`${n}_${t}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[t,"(",i,")"]},`${n}_${t}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:e||t},`${n}_${t}:text`)],value:t}})):[]}var er=n(13529),tr=n(85617);const nr=(0,we.e)("useRpcs",(function(){const{api:e}=(0,l.h)();return(0,s.useMemo)((()=>function(e,t,{specName:n}){return Object.entries((0,tr.KM)(e,t,n)).reduce(((e,[t,n])=>(e[t]??=function(e,t){return Object.entries(t).reduce(((t,[n,a])=>(t[n]={isSubscription:!1,jsonrpc:`${e}_${n}`,method:n,section:e,...a},t)),{})}(t,n),e)),{...er.Z})}(e.registry,e.runtimeChain,e.runtimeVersion)),[e])})),ar=s.memo((function({className:e="",isError:t,onChange:n,options:i,value:r}){const o=nr(),l=(0,s.useCallback)((e=>o[r.section][e]),[o,r]);return i.length?(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Items`,isError:t,onChange:n,onSearch:v.xW,options:i,transform:l,value:r.method,withLabel:!1}):null})),sr=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:r}){return(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,onSearch:v.xW,options:i,value:r.section,withLabel:!1})})),ir=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,l.h)(),c=nr(),[d,u]=(0,s.useState)((()=>_i(o,c,t.section))),[m]=(0,s.useState)((()=>function(e){return Object.keys(e.rpc).filter((e=>!e.startsWith("$"))).sort().filter((t=>0!==Object.keys(e.rpc[t]).length)).map((e=>({text:e,value:e})))}(o))),[h,p]=(0,s.useState)((()=>t));(0,s.useEffect)((()=>{i&&i(h)}),[i,h]);const g=(0,s.useCallback)((e=>{h!==e&&p((()=>e))}),[h]),f=(0,s.useCallback)((e=>{if(e!==h.section){const t=_i(o,c,e);u(t),g(c[e][t[0].value])}}),[g,o,c,h]);return(0,a.jsxs)(Si,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(sr,{className:"small",onChange:f,options:m,value:h}),(0,a.jsx)(ar,{className:"large",onChange:g,options:d,value:h})]})}));var rr=n(19729);function or(e,t){const n=e.query[t];return n&&0!==Object.keys(n).length?Object.keys(n).filter((e=>!e.startsWith("$"))).sort().map((s=>{const{meta:{docs:i,modifier:r,name:o,type:l}}=n[s],c=(0,rr.P)(e.registry,l,r.isOptional);let d="";if(l.isMap){const{hashers:t,key:n}=l.asMap;if(1===t.length)d=(0,Ti.I)(e.registry.lookup,n);else{const t=e.registry.lookup.getSiType(n).def;d=t.isTuple?t.asTuple.map((t=>(0,Ti.I)(e.registry.lookup,t))).join(", "):t.asHistoricMetaCompat.toString()}}return{className:"ui--DropdownLinked-Item",key:`${t}_${s}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[s,"(",d,"): ",c]},`${t}_${s}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(i[0]||o).toString()},`${t}_${s}:text`)],value:s}})):[]}function lr(e,{value:t}){return function(n){return e.query[t.creator.section]?e.query[t.creator.section][n]:t}}const cr=s.memo((function(e){const{api:t}=(0,l.h)(),{className:n="",isError:s,onChange:i,options:r,value:o}=e;return r.length?(0,a.jsx)(an.Z,{className:`${n} ui--DropdownLinked-Items`,isError:s,onChange:i,onSearch:v.xW,options:r,transform:lr(t,e),value:o.creator.method,withLabel:!1}):null})),dr=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:{creator:{section:r}}}){return(0,a.jsx)(an.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,onSearch:v.xW,options:i,value:r,withLabel:!1})})),ur=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,l.h)(),[c,d]=(0,s.useState)((()=>or(o,t.creator.section))),[u]=(0,s.useState)((()=>function(e){return Object.keys(e.query).filter((e=>!e.startsWith("$"))).sort().filter((t=>Object.keys(e.query[t]).length)).map((e=>({text:e,value:e})))}(o))),[m,h]=(0,s.useState)((()=>t)),p=(0,s.useCallback)((e=>{m!==e&&(h((()=>e)),i&&i(e))}),[i,m]),g=(0,s.useCallback)((e=>{if(e!==m.creator.section){const t=or(o,e);d(t),p(o.query[e][t[0].value])}}),[p,o,m]);return(0,a.jsxs)(Si,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(dr,{className:"small",onChange:g,options:u,value:m}),(0,a.jsx)(cr,{className:"large",onChange:p,options:c,value:m},m.creator.section)]})}));n(35220);var mr=n(6226),hr=n(88311);const pr=["application/wasm"],gr=s.memo((function({onChange:e,...t}){const n=(0,s.useCallback)(((t,n)=>{const a=(0,mr.F)(t);e((0,hr.N)(t),a,n)}),[e]);return(0,a.jsx)(Yi,{...t,accept:pr,onChange:n})}));var fr=n(55858);const br=(0,y.z)(vn.Z)`
...
`,xr=s.memo((function({children:e,className:t="",isDisabled:n,isError:s,isFull:i,isHidden:r,isMonospace:o,isSmall:l,isTrimmed:c,label:d,labelExtra:u,value:m,withCopy:h=!1,withLabel:p}){return(0,a.jsxs)(br,{className:`${t} ui--Output`,isFull:i,isHidden:r,isSmall:l,label:d,labelExtra:u,withLabel:p,children:[(0,a.jsxs)("div",{className:`ui--output ui dropdown selection ${s?" error":""}${o?" monospace":""}${n?"isDisabled":""}`,children:[c&&(0,gn.H)(m)&&m.length>512?`${m.slice(0,256)}…${m.slice(-256)}`:m,e]}),h&&(0,a.jsx)(xn,{value:m})]})}));function vr({inner:e=[],name:t="",outer:n=[]},a=[]){if(n.length){const e=new Array(n.length);for(let t=0;t<n.length;t++)e[t]=(0,fr.c)(n[t],void 0,!1);a.push({name:t,value:e.join(" ")})}for(let t=0,n=e.length;t<n;t++)vr(e[t],a);return a}const Ar=(0,y.z)(xr)`
  table {
    width: 100%;
...
`,wr=s.memo((function({className:e,hex:t,inspect:n,label:i}){const{t:r}=(0,R.$)(),{createLink:o}=(0,l.h)(),c=(0,s.useMemo)((()=>n&&vr(n)),[n]),[d,u]=(0,s.useMemo)((()=>{if(t){const e=`/extrinsics/decode/${t}`;return[o(e),`#${e}`]}return[null,null]}),[o,t]);return c?(0,a.jsx)(Ar,{className:e,isDisabled:!0,label:i,children:(0,a.jsx)("table",{children:(0,a.jsxs)("tbody",{children:[c.map((({name:e,value:t},n)=>(0,a.jsxs)("tr",{children:[(0,a.jsx)("td",{children:(0,a.jsx)("label",{children:e})}),(0,a.jsx)("td",{children:t})]},n))),d&&(0,a.jsxs)("tr",{className:"isLink",children:[(0,a.jsx)("td",{children:(0,a.jsx)("label",{children:r("link")})}),(0,a.jsx)("td",{children:(0,a.jsx)("a",{href:d,rel:"noreferrer",target:"_blank",children:u})})]},"hex")]})})}):null}));let yr=0;const kr=y.z.div`
  cursor: help;
  display: inline-block;
  line-height: 1rem;
  margin: 0 0 0 0.25rem;
`,jr=s.memo((function({className:e="",help:t,icon:n="question-circle"}){const[i]=(0,s.useState)((()=>"label-help-"+ ++yr));return(0,a.jsxs)(kr,{className:`${e} ui--LabelHelp`,tabIndex:-1,children:[(0,a.jsx)(w.Z,{icon:n,tooltip:i}),(0,a.jsx)(k.Z,{text:t,trigger:i})]})})),Nr=s.memo((function({children:e,isActive:t=!0}){const[n,i]=(0,s.useState)((()=>new Array(e.length).fill(!1)));return(0,s.useEffect)((()=>{if(t){const e=n.findIndex((e=>!e));-1!==e&&(0,ua.Y)((()=>i(n.map(((t,n)=>n===e||t)))))}}),[t,n]),(0,a.jsx)(a.Fragment,{children:t?n.map(((t,n)=>t&&e[n])):(0,a.jsx)(O,{})})})),Cr=s.memo((function({children:e,className:t="",label:n,params:s}){const{api:i}=(0,l.h)(),r=(0,be.W7)(i.derive.balances?.all,[s]);return(0,a.jsxs)("div",{className:t,children:[n||"",(0,g.u)(r?.accountNonce),e]})}));s.memo((function({className:e="",label:t,params:n}){return n?(0,a.jsx)(Cr,{className:`${e} ui--Nonce`,label:t,params:n.toString()}):null}));var Sr=n(52244);const Er=s.memo((function({autoFocus:e,children:t,className:n="",defaultValue:s,isDisabled:i,isError:r,isFull:o,label:l,labelExtra:c,name:d,onChange:u,onEnter:m,onEscape:h,tabIndex:p,value:g,withLabel:f}){return(0,a.jsx)(sn.ZP,{autoFocus:e,className:`${n} ui--Password`,defaultValue:s,isDisabled:i,isError:r,isFull:o,label:l,labelExtra:c,name:d,onChange:u,onEnter:m,onEscape:h,tabIndex:p,type:"password",value:g,withLabel:f,children:t})}));var Ir=n(81679),Br=n.n(Ir);Br().config({allowPassphrases:!0,maxLength:128,minLength:8,minPhraseLength:20});const Dr=y.z.div`
  align-items: center;
  margin-top: 0.5rem;
  margin-left: 2rem;
  font-size: var(--font-size-base);
...
`,Lr=s.memo((function({className:e="",value:t}){const{t:n}=(0,R.$)(),s={width:100*function(e){const t=Br().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Dr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})})),Pr=y.z.div`
  width: 100%;
  .progress-container {
    display: flex;
    height: 1rem;
...
`,Mr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:s,onClick:i,options:r,sortDirection:o}){return(0,a.jsxs)(Vr,{className:`${e} ui--Sort`,children:[(0,a.jsx)(an.Z,{defaultValue:t,label:n,onChange:s,options:r}),(0,a.jsxs)("button",{onClick:i,children:[(0,a.jsx)(w.Z,{className:"arrow up"+("ascending"===o?" isActive":""),color:"gray",icon:"sort-up"}),(0,a.jsx)(w.Z,{className:"arrow down"+("descending"===o?" isActive":""),color:"gray",icon:"sort-down"})]})]})})),Fr=s.memo((function({className:e="",stakingInfo:t}){const n=t?.stakingLedger?.active?.unwrap();return n?.gtn(0)?(0,a.jsx)(ne.Z,{className:e,value:n}):null}));var zr=n(56245);function Zr(e){switch(e){case"error":return"ban";case"event":case"eventWarn":return"assistive-listening-systems";case"received":return"telegram-plane";default:return"check"}}function Rr({account:e,action:t,id:n,message:s,removeItem:i,status:r}){return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[(0,a.jsx)(w.Z,{icon:"times",onClick:i}),(0,a.jsx)("div",{className:"short",children:(0,a.jsx)(w.Z,{icon:Zr(r)})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsx)("div",{className:"header",children:Array.isArray(t)?t.map(((e,t)=>(0,a.jsx)("div",{children:e},t))):t}),e&&(0,a.jsx)(mt,{value:e}),(0,a.jsx)("div",{className:"status",children:s})]})]})})},n)}function $r({error:e,extrinsic:t,id:n,removeItem:s,rpc:i,status:r}){let{method:o,section:l}=i;if(t){const e=t.registry.findMetaCall(t.callIndex);"unknown"!==e.section&&(o=e.method,l=e.section)}const c=function(e){switch(e){case"cancelled":return"ban";case"completed":case"inblock":case"finalized":case"sent":return"check";case"dropped":case"invalid":case"usurped":return"arrow-down";case"error":case"finalitytimeout":return"exclamation-triangle";case"queued":return"random";default:return"spinner"}}(r);return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[zr.z.includes(r)&&(0,a.jsx)(w.Z,{icon:"times",onClick:s}),(0,a.jsx)("div",{className:"short",children:"spinner"===c?(0,a.jsx)(O,{variant:"push"}):(0,a.jsx)(w.Z,{icon:c})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsxs)("div",{className:"header",children:[l,".",o]}),(0,a.jsx)("div",{className:"status",children:e?e.message||e.toString():r})]})]})})},n)}const qr=y.z.div`
  display: inline-block;
  overflow: hidden;
  position: fixed;
  right: 0.75rem;
...
`,Or=s.memo((function({children:e,className:t="",isSmall:n}){return(0,a.jsx)(Ur,{className:`${t}${n?" isSmall":""}`,children:e})}));var Wr=n(73557),Qr=n(59149);const Gr=y.z.div`
...
`,Jr=s.memo((function({className:e="",icon:t,text:n}){return(0,a.jsxs)(Gr,{className:`${e} active-tab`,children:[(0,a.jsx)(w.Z,{icon:t}),(0,a.jsx)("span",{children:n})]})}));var Kr=n(39857);const Yr=(0,y.z)(Kr.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,Xr=s.memo((function({basePath:e,className:t="",count:n,hasParams:s,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!s||0===i;return(0,a.jsxs)(Yr,{className:`${t} ui--Tab`,end:u,to:d,children:[(0,a.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,a.jsx)(C,{className:"tabCounter",color:"counter",info:n})]})})),_r=y.z.div`
  height: 100%;
  width: auto;
`,eo=s.memo((function({className:e=""}){return(0,a.jsx)(_r,{className:e,children:(0,a.jsx)("svg",{fill:"none",height:"47",viewBox:"0 0 17 65",width:"17",xmlns:"http://www.w3.org/2000/svg",children:(0,a.jsx)("path",{className:"highlight--stroke",d:"M1 1L16 32.5L1 64",stroke:"#D1D1D1"})})})})),to=y.z.header`
  background: var(--bg-tabs);
...
`,no=s.memo((function({basePath:e,className:t="",hidden:n,items:i}){const r=(0,Wr.TH)(),{icon:o,text:l}=s.useContext(Qr.m),c=(0,s.useMemo)((()=>i.filter((e=>!(!e||n&&n.includes(e.name))))),[n,i]);return(0,s.useEffect)((()=>function(e,t,n,a){if(t.pathname!==e){const[,,s]=t.pathname.split("/"),i=n.find((e=>e&&e.alias===s));i?window.location.hash=i.isRoot?e:`${e}/${i.name}`:!a||!a.includes(s)&&n.some((e=>e&&!e.isRoot&&e.name===s))||(window.location.hash=e)}}(e,r,i,n)),[e,n,i,r]),(0,a.jsx)(to,{className:`${t} ui--Tabs`,children:(0,a.jsxs)("div",{className:"tabs-container",children:[l&&o&&(0,a.jsx)(Jr,{icon:o,text:l}),(0,a.jsx)(eo,{}),(0,a.jsx)("ul",{className:"ui--TabsList",children:c.map(((t,n)=>(0,a.jsx)("li",{className:t.isHidden?"--hidden":"",children:(0,s.createElement)(Xr,{...t,basePath:e,index:n,key:t.name})},n)))})]})})})),ao=(0,y.z)(vn.Z)`
...
`,oo=s.memo((function({className:e="",onChange:t,options:n,value:i}){const r=(0,s.useMemo)((()=>n.filter((e=>!!e))),[n]);return r.length&&r[0].value?(0,a.jsx)(ro,{className:`${e} ui--ToggleGroup`,children:r.map((({isDisabled:e,text:n,value:s},r)=>(0,a.jsx)(io,{index:r,isDisabled:e,isSelected:i===r,onChange:t,text:n,value:s},r)))}):null})),lo=y.z.div`
  display: flex;
  align-items: center;
`,co=y.z.div`
  position: relative;
...
`,r=s.memo((function({children:e,className:t="",withBorder:n,withExpander:s,withPadding:r}){return(0,a.jsx)(i,{className:`${t} ui--Params ${n?"withBorder":""} ${r?"withPadding":""} ${s?"withExpander":""}`,children:e})}))},98988:(e,t,n)=>{n.d(t,{Z:()=>h});var a=n(52322),s=n(2784),i=n(62288),r=n(89176),o=n(58607),l=n(6046),c=n(27113),d=n(48653),u=n(37750);const m=i.zo.div`

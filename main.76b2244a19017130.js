...
`,Dn=u.memo((function({className:e}){const n=(0,Z.TH)(),{t}=zn(),{api:r,isApiConnected:o,isApiReady:s,isDevelopment:a}=(0,S.h)(),{queueAction:l}=(0,Nn.L)(),{Component:c,display:{needsApi:p,needsApiCheck:d,needsApiInstances:m},icon:g,name:h,text:x}=(0,u.useMemo)((()=>{const e=n.pathname.slice(1)||"";return jn(t).find((n=>n&&e.startsWith(n.name)&&(a||!n.display.isDevelopment)))||Pn}),[a,n,t]),v=(0,u.useMemo)((()=>p?s&&o?$n(r,p,m,d):null:[]),[r,o,s,p,d,m]);return(0,i.jsx)(Hn,{className:e,children:v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(u.Suspense,{fallback:"...",children:(0,i.jsx)(An.SV,{trigger:h,children:(0,i.jsx)(An.mO.Provider,{value:{icon:g,text:x},children:v.length?(0,i.jsx)(Rn,{basePath:`/${h}`,location:n,missingApis:v,onStatusChange:l}):(0,i.jsx)(c,{basePath:`/${h}`,location:n,onStatusChange:l})})})}),(0,i.jsx)(On,{})]}):(0,i.jsx)("div",{className:"connecting",children:(0,i.jsx)(An.$j,{label:t("Initializing connection")})})})}));var Bn=t(41411),Fn=t(38894),Ln=t(12176),Xn=t(95689),Jn=t(68058),Vn=t(10072),_n=t(70676);const Gn=(0,An.zo)(An.ZD)`
  padding: 0.25rem;
  text-align: right;
...
`,At=u.memo((function({children:e,className:n="",icon:t,isBottom:r=!1,isFull:o=!1,type:s}){const[a,l]=(0,Fn.O)();return a?null:(0,i.jsx)(jt,{className:`${n} ${"error"===s?"isError":"isInfo"} ${r?"isBottom":"isTop"} ${o?"isFull":"isPartial"}`,children:(0,i.jsxs)("div",{className:"content",children:[(0,i.jsx)(An.JO,{className:"contentIcon",icon:t,size:"2x"}),(0,i.jsx)("div",{className:"contentItem",children:e}),(0,i.jsx)(An.zx,{className:"closeIcon",icon:"times",isBasic:!0,isCircular:!0,onClick:l})]})})})),Nt=c.X.apiType.param,St="json-rpc"===c.X.apiType.type&&"string"==typeof Nt&&Nt.startsWith("ws://"),It="string"==typeof Nt&&Nt.includes("127.0.0.1"),Zt=window.location.protocol.startsWith("https:"),$t=u.memo((function({className:e}){const{t:n}=zn(),{apiError:t,isApiConnected:r,isApiReady:o,isWaitingInjected:s}=(0,S.h)();return t?(0,i.jsx)(At,{className:e,icon:"globe",type:"error",children:(0,i.jsx)("div",{children:t})}):o?s?(0,i.jsx)(At,{className:e,icon:"puzzle-piece",type:"info",children:(0,i.jsx)("div",{children:n("Waiting for authorization from the extension. Please open the installed extension and approve or reject access.")})}):r?null:(0,i.jsxs)(At,{className:e,icon:"globe",type:"error",children:[(0,i.jsx)("div",{children:n("You are not connected to a node. Ensure that your node is running and that the Websocket endpoint is reachable.")}),St&&!It&&Zt?(0,i.jsx)("div",{children:n("You are connecting from a secure location to an insecure WebSocket ({{wsUrl}}). Due to browser mixed-content security policies this connection type is not allowed. Change the RPC service to a secure 'wss' endpoint.",{replace:{wsUrl:Nt}})}):void 0]}):(0,i.jsx)(At,{className:e,icon:"globe",type:"info",children:(0,i.jsx)("div",{children:n(r?"Waiting to complete metadata retrieval from remote endpoint.":"Waiting to establish a connection with the remote endpoint.")})})})),Ut=window.location.host.startsWith("polkadot.js.org"),zt=(0,a.Rf)((()=>"")).map((e=>e.dnslink)).reduce(((e,n)=>(n&&!e.includes(n)&&e.push(n),e)),[]),Rt=u.memo((function({className:e}){const{t:n}=zn(),{systemChain:t}=(0,S.h)(),r=(0,u.useMemo)((()=>{const e=t?.toLowerCase();return e&&zt.includes(e)?`https://${e}.dotapps.io`:"https://dotapps.io"}),[t]);return Ut?(0,i.jsx)(At,{className:e,icon:"link",isBottom:!0,isFull:!0,type:"info",children:(0,i.jsxs)("div",{children:[n("You are connected to the development instance of the UI. For a fully decentralized experience, you are encouraged to use the IPFS deployed version as the canonical URL: "),(0,i.jsx)("a",{href:r,rel:"noreferrer",target:"_blank",children:r.replace("https://","")})]})}):null})),Tt=u.memo((function(){const{api:e,isApiReady:n}=(0,S.h)(),t=(0,Wn.W7)(n&&e.derive.accounts?.indexes),r=(0,Wn.W7)(n&&e.query.identity?.registrars),o=(0,Wn.W7)(n&&e.query.balances?.totalIssuance),[s,a]=(0,u.useState)(!1);return(0,u.useEffect)((()=>{a(!!t||!!o||!!r)}),[]),(0,i.jsx)("div",{className:`apps--api-warm ${s.toString()}`})})),Wt=j.z.div`
  background: var(--bg-page);
  box-sizing: border-box;
  display: flex;

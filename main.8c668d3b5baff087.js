...
`,Dn=u.memo((function({className:e}){const n=(0,Z.TH)(),{t}=zn(),{api:r,isApiConnected:o,isApiReady:s,isDevelopment:a}=(0,S.h)(),{queueAction:l}=(0,Nn.L)(),{Component:c,display:{needsApi:p,needsApiCheck:d,needsApiInstances:m},icon:g,name:h,text:x}=(0,u.useMemo)((()=>{const e=n.pathname.slice(1)||"";return An(t).find((n=>n&&e.startsWith(n.name)&&(a||!n.display.isDevelopment)))||Pn}),[a,n,t]),v=(0,u.useMemo)((()=>p?s&&o?$n(r,p,m,d):null:[]),[r,o,s,p,d,m]);return(0,i.jsx)(Hn,{className:e,children:v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(u.Suspense,{fallback:"...",children:(0,i.jsx)(jn.SV,{trigger:h,children:(0,i.jsx)(jn.mO.Provider,{value:{icon:g,text:x},children:v.length?(0,i.jsx)(Rn,{basePath:`/${h}`,location:n,missingApis:v,onStatusChange:l}):(0,i.jsx)(c,{basePath:`/${h}`,location:n,onStatusChange:l})})})}),(0,i.jsx)(On,{})]}):(0,i.jsx)("div",{className:"connecting",children:(0,i.jsx)(jn.$j,{label:t("Initializing connection")})})})}));var Bn=t(41411),Ln=t(38894),Xn=t(12176),Fn=t(95689),Jn=t(68058),Vn=t(10072),_n=t(70676);const Gn=(0,jn.zo)(jn.ZD)`
  padding: 0.25rem;
  text-align: right;

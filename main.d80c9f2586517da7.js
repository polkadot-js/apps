...
`,Dn=u.memo((function({className:e}){const n=(0,Z.TH)(),{t}=zn(),{api:r,isApiConnected:o,isApiReady:s,isDevelopment:a}=(0,S.h)(),{queueAction:l}=(0,Nn.L)(),{Component:c,display:{needsApi:p,needsApiCheck:d,needsApiInstances:m},icon:g,name:h,text:x}=(0,u.useMemo)((()=>{const e=n.pathname.slice(1)||"";return An(t).find((n=>n&&e.startsWith(n.name)&&(a||!n.display.isDevelopment)))||Pn}),[a,n,t]),v=(0,u.useMemo)((()=>p?s&&o?$n(r,p,m,d):null:[]),[r,o,s,p,d,m]);return(0,i.jsx)(Hn,{className:e,children:v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(u.Suspense,{fallback:"...",children:(0,i.jsx)(jn.SV,{trigger:h,children:(0,i.jsx)(jn.mO.Provider,{value:{icon:g,text:x},children:v.length?(0,i.jsx)(Rn,{basePath:`/${h}`,location:n,missingApis:v,onStatusChange:l}):(0,i.jsx)(c,{basePath:`/${h}`,location:n,onStatusChange:l})})})}),(0,i.jsx)(On,{})]}):(0,i.jsx)("div",{className:"connecting",children:(0,i.jsx)(jn.$j,{label:t("Initializing connection")})})})}));var Bn=t(41411),Fn=t(38894),Ln=t(12176),Xn=t(95689),Jn=t(68058),Vn=t(10072),_n=t(70676);const Gn=(0,jn.zo)(jn.ZD)`
  padding: 0.25rem;
  text-align: right;
...
`,ct=u.memo((function({className:e}){const{api:n,isApiReady:t}=(0,S.h)(),r=(0,Wn.W7)(t&&n.rpc.state.subscribeRuntimeVersion),{ipnsChain:o}=(0,l.g)(),[s,a]=(0,Fn.O)(),c=!o;return(0,i.jsxs)(lt,{className:e,children:[(0,i.jsxs)("div",{className:`apps--SideBar-logo-inner${c?" isClickable":""} highlight--color-contrast`,onClick:a,children:[(0,i.jsx)(jn.Mj,{}),(0,i.jsxs)("div",{className:"info media--1000",children:[(0,i.jsx)(Ln.Z,{className:"chain"}),r&&(0,i.jsxs)("div",{className:"runtimeVersion",children:[r.specName.toString(),"/",r.specVersion.toNumber()]}),(0,i.jsx)(Xn.Z,{className:"bestNumber",label:"#"})]}),c&&(0,i.jsx)(jn.JO,{className:"dropdown",icon:s?"caret-right":"caret-down"})]}),s&&(0,i.jsx)(at,{onClose:a})]})})),pt=()=>0,dt=jn.zo.li`
  cursor: pointer;
  position: relative;
  white-space: nowrap;

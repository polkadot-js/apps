...
**Important** If you are a chain developer and would like to add support for your chain to the UI, all teh local configuration (API types, settings, logos) can be customized in [the apps-config package](../apps-config/README.md), complete with instructions of what goes where.

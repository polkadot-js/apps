...
`,j=s.memo((function({autoFocus:e,bitLength:t=f,children:n,className:o="",defaultValue:p,isDecimal:A,isDisabled:v,isError:j=!1,isFull:k,isLifetime:C,isLoading:N,isSi:E,isSigned:S=!1,isWarning:I,isZeroable:B=!0,label:D,labelExtra:L,maxLength:P,maxValue:V,onChange:T,onEnter:M,onEscape:F,placeholder:z,siDecimals:Z,siDefault:R,siSymbol:$,value:H}){const{t:U}=(0,g.$)(),{api:q}=(0,i.h)(),[Q]=(0,s.useState)((()=>E?R||d.a.findSi("-"):null)),[[O,W,G],J]=(0,s.useState)((()=>function(e,t=r.nw,n,a,s,i,o,m,h){return(0,u.H)(t)?function(e,t,n,a,s){const i=(0,c.o)(s)?d.a.getDefaults().decimals:s;return[t?e.div(r.aP.pow(new(l())(i+t.power))).toString():e.toString(),e,!(!a&&!n)||e.gt(r.nw)]}(t,n,i,o,h):w(e,t,n,a,s,i,o,m,h)}(q,H||p,Q,t,!!C,S,B,V,Z))),[K,Y]=(0,s.useState)(!1);(0,s.useEffect)((()=>{T&&T(G?W:void 0)}),[G,T,W]);const X=(0,s.useCallback)(((e,n)=>J(w(q,e,n,t,!!C,S,B,V,Z))),[q,t,C,S,B,V,Z]),_=(0,s.useCallback)((e=>{X(e,Q)}),[X,Q]);(0,s.useEffect)((()=>{p&&_(p.toString())}),[_,p]);const ee=(0,s.useCallback)((e=>{if(h.nk.includes(e.key))Y(!0);else if(1===e.key.length&&!K){const{selectionEnd:t,selectionStart:n,value:a}=e.target,s=`${a.substring(0,n||0)}${e.key}${a.substring(t||0)}`;x(A||!!Q,S).test(s)||e.preventDefault()}}),[A,K,S,Q]),te=(0,s.useCallback)((e=>{h.nk.includes(e.key)&&Y(!1)}),[]),ne=(0,s.useCallback)((e=>{const{value:t}=e.target;x(A||!!Q,S).test(t)||e.preventDefault()}),[A,S,Q]),ae=b(t).toString().length;return(0,a.jsxs)(y,{autoFocus:e,className:`${o} ui--InputNumber ${v?"isDisabled":""}`,isDisabled:v,isError:!G||j,isFull:k,isLoading:N,isWarning:I,label:D,labelExtra:L,maxLength:P||ae,onChange:_,onEnter:M,onEscape:F,onKeyDown:ee,onKeyUp:te,onPaste:ne,placeholder:z||U(S?"Valid number":"Positive number"),type:"text",value:O,children:[Q&&(0,a.jsx)("div",{className:"siUnit",children:$||m.k.abbr}),n]})}))},35220:(e,t,n)=>{n.d(t,{Z:()=>g});var a=n(52322),s=n(2784),i=n(23729),r=n.n(i),o=n(3663),l=n(25294),c=n(21779);function d(e){return{key:e,text:e,value:e}}const u=(r().get("tags")||["Default"]).sort(),m=u.map(d);function h(e){u.push(e),m.push(d(e)),function(e){r().set("tags",e.sort())}(u)}const p=(0,c.z)(l.Z)`
  && .ui.label {
    border: none;
...
`,Q=s.memo((function({children:e,className:t="",isCentered:n}){return(0,a.jsxs)(q,{className:`${t} ui--Button-Group ${n?"isCentered":""}`,children:[e,(0,a.jsx)("div",{className:"clear"})]})})),O=v.z.button`
  background: transparent;
  border: none;
  color: inherit;
  cursor: pointer;
...
`,Un=s.memo((function({align:e="left",children:t,className:n="",hint:s}){return(0,a.jsxs)(Hn,{className:`${n} ui--Modal-Columns ${e}Align`,children:[(0,a.jsx)("div",{className:"ui--Modal-Columns-content",children:t}),s&&(0,a.jsx)("div",{className:"ui--Modal-Columns-hint",children:s})]})})),qn=v.z.div`
  padding: 1.5rem;
`,Qn=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(qn,{className:`${t} ui--Modal-Content`,children:e})})),On=v.z.div`
  display: flex;
  justify-content: space-between;

...
`,Qe=s.memo((function({address:e,className:t}){return(0,a.jsxs)(We,{className:t,"data-testid":"parent",children:[(0,a.jsx)(x.Z,{className:"parent-icon",icon:"code-branch"}),(0,a.jsx)(V,{value:e,withSidebar:!0})]})})),Ke=v.z.div`
  overflow-x: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
`,$a=s.memo((function({className:e="",color:t,label:n}){return(0,a.jsx)(La,{className:`${e} ${"theme"===t?" highlight--color-bg highlight--bg":""}`,color:t,label:n,size:"tiny"})}));var Va=n(28316),Pa=n(82740);const Za=v.z.div`
...
`,Ua=s.memo((function({className:e="",header:t,onClose:n}){return(0,a.jsxs)(Ra,{className:`${e} ui--Modal-Header`,children:[t&&(0,a.jsx)("h1",{children:t}),(0,a.jsx)(se.Z,{dataTestId:"close-modal",icon:"times",onClick:n})]})})),qa=Pa.vJ`
  body {
    overflow: hidden;
  }
`,Oa=v.z.div`
...
`,Lr=s.memo((function({className:e="",icon:t,text:n}){return(0,a.jsxs)(Br,{className:`${e} active-tab`,children:[(0,a.jsx)(x.Z,{icon:t}),(0,a.jsx)("span",{children:n})]})}));var $r=n(39857);const Vr=(0,v.z)($r.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,Pr=s.memo((function({basePath:e,className:t="",count:n,hasParams:s,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!s||0===i;return(0,a.jsxs)(Vr,{className:`${t} ui--Tab`,end:u,to:d,children:[(0,a.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,a.jsx)(j,{className:"tabCounter",color:"counter",info:n})]})})),Zr=v.z.div`
  height: 100%;
  width: auto;
...
`,Fr=s.memo((function({basePath:e,className:t="",hidden:n,items:i}){const r=(0,Dr.TH)(),{icon:o,text:l}=s.useContext(zr),c=(0,s.useMemo)((()=>i.filter((e=>!(!e||n&&n.includes(e.name))))),[n,i]);return(0,s.useEffect)((()=>function(e,t,n,a){if(t.pathname!==e){const[,,s]=t.pathname.split("/"),i=n.find((e=>e&&e.alias===s));i?window.location.hash=i.isRoot?e:`${e}/${i.name}`:!a||!a.includes(s)&&n.some((e=>e&&!e.isRoot&&e.name===s))||(window.location.hash=e)}}(e,r,i,n)),[e,n,i,r]),(0,a.jsx)(Mr,{className:`${t} ui--Tabs`,children:(0,a.jsxs)("div",{className:"tabs-container",children:[l&&o&&(0,a.jsx)(Lr,{icon:o,text:l}),(0,a.jsx)(Tr,{}),(0,a.jsx)("ul",{className:"ui--TabsList",children:c.map(((t,n)=>(0,a.jsx)("li",{className:t.isHidden?"--hidden":"",children:(0,s.createElement)(Pr,{...t,basePath:e,index:n,key:t.name})},n)))})]})})}));var Hr=n(53657);const Rr=(0,v.z)(wt.Z)`

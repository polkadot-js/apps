...
export const prodParasKusama: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    ...
    paraId: 2088,
    providers: {
      // Centrifuge: 'wss://fullnode.altair.centrifuge.io', // https://github.com/polkadot-js/apps/issues/9366
  ...
  },
  {
    ...
    paraId: 2121,
    providers: {
      // 'Imbue Network': 'wss://imbue-kusama.imbue.network' // https://github.com/polkadot-js/apps/issues/9300
    },
    text: 'Imbue Network',
    ui: {
      color: '#baff36',

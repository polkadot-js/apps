...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'xsocial',
    providers: {
      DappForce: 'wss://xsocial.subsocial.network' // https://github.com/polkadot-js/apps/issues/8315
    },
    text: 'xSocial',
    ui: {
      logo: nodesXSocialPNG
    }
  },
  {
    info: 'zCloak',

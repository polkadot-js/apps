...
import { chains3dpassSVG, chainsAcalaSVG, chainsAlephSVG, chainsAllfeatSVG, chainsAnalogSVG, chainsArgonSVG, chainsBrainstormPNG, chainsChainflipPNG, chainsCreditcoinTestPNG, chainsDebioSVG, chainsEquilibriumSVG, chainsFerrumPNG, chainsFragnovaPNG, chainsJurPNG, chainsKintsugiPNG, chainsLiberlandPNG, chainsLogionPNG, chainsMyriadPNG, chainsProductiveMinerTestnetSVG, chainsQuantumFusionPNG, chainsShidenPNG, chainsSkyekiwiPNG, chainsTanglePNG, chainsVaraTestnetPNG } from '../ui/logos/chains/index.js';
...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    ...
    ui: {
      color: '#667eea',
      logo: chainsProductiveMinerTestnetSVG
    }
  },
  {

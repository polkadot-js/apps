...
function expandEndpoint (t: TFunction, { dnslink, genesisHash, homepage, info, isChild, isDisabled, isUnreachable, linked, paraId, providers, teleport, teleportXcmVersion, text, ui }: EndpointOption, firstOnly: boolean, withSort: boolean): LinkOption[] {

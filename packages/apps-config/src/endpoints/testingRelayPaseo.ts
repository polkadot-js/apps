...
import { nodesAssetHubSVG, nodesBifrostSVG, nodesHyperbridgeSVG, nodesIntegriteeSVG, nodesKiltPNG, nodesNodleSVG, nodesBajunPNG } from '@polkadot/apps-config/ui/logos/nodes';

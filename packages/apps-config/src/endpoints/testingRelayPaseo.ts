...
import { nodesAjunaPNG, nodesAssetHubSVG, nodesAventusSVG, nodesBajunPNG, nodesBifrostSVG, nodesBridgeHubSVG, nodesCollectivesSVG, nodesDarwiniaKoiSVG, nodesDepowSVG, nodesFintraSVG, nodesHeimaPaseoPNG, nodesHyperbridgePNG, nodesIdealNetworkSVG, nodesIdncSVG, nodesIntegriteeSVG, nodesKiltIconSVG, nodesMandalaPNG, nodesMusePNG, nodesMyriadPaseoSVG, nodesNodleSVG, nodesOpalLogoPNG, nodesRegionxPNG, nodesRexSVG, nodesXodePNG, nodesZeitgeistPNG } from '@polkadot/apps-config/ui/logos/nodes';
...
export const testParasPaseo: Omit<EndpointOption, 'teleport'>[] = [
  ...
  {
    homepage: 'https://depow.lat',
    info: 'DePow',
    paraId: 5139,
    providers: {
      DePow: 'wss://rpc.depow.lat'
    },
    text: 'DePow (Paseo)',
    ui: {
      color: '#FF6B35',

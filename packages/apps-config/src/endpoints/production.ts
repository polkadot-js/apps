...
import { chains3dpassSVG, chainsAnalogSVG, chainsBittensorPNG, chainsChainflipPNG, chainsCommuneaiPNG, chainsCreditcoinPNG, chainsDebioSVG, chainsFragnovaPNG, chainsJurPNG, chainsLiberlandPNG, chainsLogionPNG, chainsMyriadPNG, chainsPolkadotCircleSVG, chainsSelendraLogoPNG, chainsSpannerPNG, chainsTanglePNG, chainsTorusPNG, chainsVaraPNG, chainsVtbPNG } from '../ui/logos/chains/index.js';
...
export const prodChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    ...
    providers: {
      ...
      'Selendra Archive': 'wss://rpcx.selendra.org'
    },
    text: 'Selendra',
    ui: {
      color: '#0db0a4',

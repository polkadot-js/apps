...
export const testParasRococo: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    ...
    paraId: 4304,
    providers: {
      // 'Phyken Network': 'wss://rpc.rococo-testnet.metaquity.xyz' // https://github.com/polkadot-js/apps/issues/10178
    },

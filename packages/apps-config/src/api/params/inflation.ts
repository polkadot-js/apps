...
import { CERE_NETWORK_GENESIS, CERE_NETWORK_TESTNET_GENESIS, DOCK_POS_TESTNET_GENESIS, KUSAMA_GENESIS, MAINNET_NETWORK_TESTNET_GENESIS, NEATCOIN_GENESIS, NFTMART_GENESIS, POLKADOT_GENESIS, TURING_NETWORK_TESTNET_GENESIS, VARA_NETWORK_GENESIS, VARA_NETWORK_TESTNET_GENESIS } from '../constants.js';
...
const KNOWN_PARAMS: Record<string, InflationParams> = {
  ...
  [MAINNET_NETWORK_TESTNET_GENESIS]: AVAIL_NETWORK_INFLATION_PARAMS,
  ...
  [TURING_NETWORK_TESTNET_GENESIS]: AVAIL_NETWORK_INFLATION_PARAMS,

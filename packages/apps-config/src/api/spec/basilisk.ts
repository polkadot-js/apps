  ...
  types: [
    {
      ...
      types: {
        ...
        Pool: {
          ...
          assets: { asset_a: 'AssetId', asset_b: 'AssetId' },
          initial_weights: { weight_a: 'LBPWeight', weight_b: 'LBPWeight' },
          final_weights: { weight_a: 'LBPWeight', weight_b: 'LBPWeight' },
          last_weight_update: 'BlockNumber',
          last_weights: { weight_a: 'LBPWeight', weight_b: 'LBPWeight' },

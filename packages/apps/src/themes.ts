...
export const darkTheme: ThemeDef = {
  ...
  bgMenu: '#26272c',
  bgMenuItemHover: 'rgba(255, 255, 255, 0.05)',
  bgMenuTabHover: 'rgba(33, 34, 39, 0.9)',
  bgPage: '#26272c',
  bgTable: '#38393f',
  bgTabs: '#38393f',
  bgToggle: '#58595f',
  borderMenuItems: '#2F313B',
  borderMenuTabs: 'transparent',
...
export const lightTheme: ThemeDef = {
  ...
  bgMenu: '#fff',
  bgMenuItemHover: 'rgba(255, 255, 255, 0.5)',
  bgMenuTabHover: 'rgba(250, 250, 250, 0.9)',
  bgPage: '#f5f3f1',
  bgTable: '#fff',
  bgTabs: '#fff',
  bgToggle: '#e4e5e6',
  borderMenuItems: '#E7E7E7',
  borderMenuTabs: '#eeecea',
  borderTable: '#eeecea',
  color: '#4e4e4e',

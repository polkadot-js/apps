      ...
      splitChunks: {
        cacheGroups: {
          ...mapChunks('polkadot', [
            ...
            /* 02 */ /node_modules\/(@polkadot\/(extension|keyring|react|rpc|ui|util|vanitygen)|@edgeware|@ledgerhq|@zondax|edgeware)/
          ]),
          ...mapChunks('react', [
            /* 00 */ /node_modules\/(@fortawesome)/,
            /* 01 */ /node_modules\/(@emotion|@semantic-ui-react|@stardust|classnames|chart\.js|codeflask|copy-to-clipboard|file-selector|file-saver|hoist-non-react|i18next|jdenticon|keyboard-key|mini-create-react|popper\.js|prop-types|qrcode-generator|react|react-|remark-parse|semantic-ui-react|semantic-ui-css|styled-components)/
          ]),
          ...mapChunks('other', [

      ...
      splitChunks: {
        cacheGroups: {
          ...
          ...mapChunks('polkadot', [
            ...
            /* 01 */ /node_modules\/(@polkadot\/(api|metadata|rpc|types|x-fetch|x-ws))/,
            /* 02 */ /node_modules\/(@polkadot\/(extension|keyring|networks|react|ui|util|vanitygen|x-textdecoder|x-textencoder)|@acala-network|@edgeware|@laminar|@ledgerhq|@open-web3|@subsocial|@zondax|edgeware)/
          ]),
          ...mapChunks('react', [
          ...
          ...mapChunks('other', [
            ...
            /* 03 */ /node_modules\/(base-x|base64-js|blakejs|bip|bn\.js|cipher-base|crypto|des\.js|diffie-hellman|elliptic|hash|hmac|js-sha3|md5|miller-rabin|ripemd160|scryptsy|secp256k1|sha\.js|xxhashjs)/
          ])
        }
      }
    },

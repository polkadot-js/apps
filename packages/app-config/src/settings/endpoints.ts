  ...
  return [
    {
      dnslink: 'local',
      info: 'local',
      shortText: t<string>('rpc.local.short', 'Local Node', { ns: 'app-config' }),
      text: t<string>('rpc.local', 'Local Node (Own, 127.0.0.1:9944)', { ns: 'app-config' }),
...
//     // {
//     //   info: 'substrate',
//     //   shortText: t<string>('rpc.flamingfir.short', 'Flaming Fir', { ns: 'app-config' }),
//     //   text: t<string>('rpc.flamingfir', 'Flaming Fir (Substrate Testnet, hosted by Parity)', { ns: 'app-config' }),
...
export default function create (t: TFunction): LinkOption[] {
  ...
  let endpoints = [
    // {
    //   isHeader: true,
    //   text: t<string>('rpc.header.live', 'Live networks', { ns: 'app-config' }),
    //   value: ''
    // },
    ...createLive(t),
    // {
    //   isHeader: true,
    //   text: t<string>('rpc.header.test', 'Test networks', { ns: 'app-config' }),
    //   value: ''
    // },
    // ...createTest(t),
    // {
    //   isHeader: true,
    //   text: t<string>('rpc.header.dev', 'Development', { ns: 'app-config' }),
    //   value: ''
    // },
    ...createDev(t)
  ];
  ...
  if (ENV.length > 0) {
    endpoints = [
      {
        isHeader: true,
        text: t<string>('rpc.custom', 'Custom environment', { ns: 'app-config' }),
        value: ''
      },
      ...ENV
    ].concat(endpoints);

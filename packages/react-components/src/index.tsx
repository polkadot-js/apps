...
export { default as Motions } from './Progress';
export { default as ProposedAction } from './ProposedAction';
export { default as Proposals } from './Collective';
...
export { default as TxActions } from './TxActions';
export { default as TxAccount } from './TxAccount';

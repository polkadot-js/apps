...
function Row ({ address, buttons, children, className, details, icon, iconInfo, isDisabled, isEditableName, isEditableTags, isInline, name,onChangeName, onChangeTags, onSaveName, onSaveTags, style, tags }: RowPropsNew): React.ReactElement<RowPropsNew> {
...
// class Row2<P extends RowProps, S extends RowState> extends React.PureComponent<P, S> {
//   public state: S = {
//     isEditingName: false,
//     isEditingTags: false
//   } as unknown as S;

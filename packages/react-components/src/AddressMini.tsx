...
function AddressMini ({ balance, bonded, children, className, iconInfo, isPadded = true, label, labelBalance, noName, summary, value, withAddress = true, withBalance = false, withBonded = false, withLockedVote = false, withMenu = false, withName = true, withShrink = false }: Props): React.ReactElement<Props> | null {
  if (!value) {
    return null;
  }

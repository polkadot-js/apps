...
declare module '@polkadot/types/lookup' {
  ...
  /** @name CumulusPalletXcmpQueueEvent (38) */
  ...
  /** @name StagingXcmV3MultiLocation (43) */
  interface StagingXcmV3MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV3Junctions;
  }

  /** @name XcmV3Junctions (44) */
  ...
  /** @name XcmV3JunctionNetworkId (48) */
  ...
  /** @name XcmV3MultiassetMultiAssets (56) */
  interface XcmV3MultiassetMultiAssets extends Vec<XcmV3MultiAsset> {}

  /** @name XcmV3MultiAsset (58) */
  interface XcmV3MultiAsset extends Struct {
    readonly id: XcmV3MultiassetAssetId;
    readonly fun: XcmV3MultiassetFungibility;
  }

  /** @name XcmV3MultiassetAssetId (59) */
  ...
  /** @name XcmV3MultiassetFungibility (60) */
  ...
  /** @name XcmV3MultiassetAssetInstance (61) */
  ...
  /** @name XcmV3QueryResponseInfo (76) */
  ...
  /** @name XcmV3MultiassetMultiAssetFilter (77) */
  ...
  /** @name XcmV3MultiassetWildMultiAsset (78) */
  ...
  /** @name XcmV3MultiassetWildFungibility (79) */
  ...
  /** @name XcmV2MultiassetMultiAssets (83) */
  interface XcmV2MultiassetMultiAssets extends Vec<XcmV2MultiAsset> {}

  /** @name XcmV2MultiAsset (85) */
  interface XcmV2MultiAsset extends Struct {
    readonly id: XcmV2MultiassetAssetId;
    readonly fun: XcmV2MultiassetFungibility;
  }

  /** @name XcmV2MultiassetAssetId (86) */
  ...
  /** @name XcmV2MultiLocation (87) */
  interface XcmV2MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV2MultilocationJunctions;
  }

  /** @name XcmV2MultilocationJunctions (88) */
  ...
  /** @name XcmV2MultiassetFungibility (94) */
  ...
  /** @name XcmV2MultiassetAssetInstance (95) */
  ...
  /** @name XcmVersionedMultiLocation (96) */
  ...
  /** @name CumulusPalletDmpQueueEvent (98) */
  ...
  interface PalletProxyEvent extends Enum {
    ...
    readonly asPureCreated: {
      ...
      readonly who: AccountId32;
      readonly proxyType: CollectivesPolkadotRuntimeProxyType;
  ...
  /** @name CollectivesPolkadotRuntimeProxyType (105) */
  interface CollectivesPolkadotRuntimeProxyType extends Enum {
    readonly isAny: boolean;
    readonly isNonTransfer: boolean;
    readonly isCancelProxy: boolean;
    readonly isCollator: boolean;
    readonly isAlliance: boolean;
    readonly isFellowship: boolean;
    readonly type: 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Alliance' | 'Fellowship';
  }

  /** @name PalletPreimageEvent (107) */
  ...
  /** @name PolkadotRuntimeCommonImplsVersionedLocatableAsset (111) */
  ...
  /** @name PalletAllianceVersion (115) */
  ...
  /** @name PalletAllianceMultihash (116) */
  interface PalletAllianceMultihash extends Struct {
    readonly code: u64;
    readonly digest: Bytes;
  }

  /** @name PalletAllianceUnscrupulousItem (121) */
  ...
  /** @name PalletCollectiveEvent (123) */
  ...
  /** @name PalletRankedCollectiveEvent (124) */
  ...
  /** @name PalletRankedCollectiveVoteRecord (125) */
  ...
  /** @name PalletRankedCollectiveTally (126) */
  ...
  /** @name FrameSupportPreimagesBounded (128) */
  ...
  /** @name PolkadotPrimitivesV6PersistedValidationData (136) */
  ...
  /** @name PalletCollatorSelectionCall (151) */
  ...
  interface PalletSessionCall extends Enum {
    ...
    readonly asSetKeys: {
      readonly keys_: CollectivesPolkadotRuntimeSessionKeys;
  ...
  /** @name CollectivesPolkadotRuntimeSessionKeys (153) */
  interface CollectivesPolkadotRuntimeSessionKeys extends Struct {
  ...
  /** @name CumulusPalletXcmpQueueCall (156) */
  ...
  /** @name XcmV2MultiassetMultiAssetFilter (166) */
  ...
  /** @name XcmV2MultiassetWildMultiAsset (167) */
  ...
  /** @name XcmV2MultiassetWildFungibility (168) */
  ...
  /** @name CumulusPalletDmpQueueCall (179) */
  ...
  interface PalletUtilityCall extends Enum {
    ...
    readonly asDispatchAs: {
      readonly asOrigin: CollectivesPolkadotRuntimeOriginCaller;
      readonly call: Call;
    } & Struct;
  ...
  /** @name CollectivesPolkadotRuntimeOriginCaller (182) */
  interface CollectivesPolkadotRuntimeOriginCaller extends Enum {
    ...
    readonly isFellowshipOrigins: boolean;
    readonly asFellowshipOrigins: CollectivesPolkadotRuntimeFellowshipOriginsPalletOriginsOrigin;
    readonly type: 'System' | 'Void' | 'PolkadotXcm' | 'CumulusXcm' | 'AllianceMotion' | 'FellowshipOrigins';
  }

  /** @name FrameSupportDispatchRawOrigin (183) */
  ...
  /** @name CumulusPalletXcmOrigin (185) */
  ...
  /** @name CollectivesPolkadotRuntimeFellowshipOriginsPalletOriginsOrigin (187) */
  interface CollectivesPolkadotRuntimeFellowshipOriginsPalletOriginsOrigin extends Enum {
    readonly isMembers: boolean;
    readonly isFellowship2Dan: boolean;
    readonly isFellows: boolean;
    readonly isArchitects: boolean;
    readonly isFellowship5Dan: boolean;
    readonly isFellowship6Dan: boolean;
    readonly isMasters: boolean;
    readonly isFellowship8Dan: boolean;
    readonly isFellowship9Dan: boolean;
    readonly isRetainAt1Dan: boolean;
    readonly isRetainAt2Dan: boolean;
    readonly isRetainAt3Dan: boolean;
    readonly isRetainAt4Dan: boolean;
    readonly isRetainAt5Dan: boolean;
    readonly isRetainAt6Dan: boolean;
    readonly isPromoteTo1Dan: boolean;
    readonly isPromoteTo2Dan: boolean;
    readonly isPromoteTo3Dan: boolean;
    readonly isPromoteTo4Dan: boolean;
    readonly isPromoteTo5Dan: boolean;
    readonly isPromoteTo6Dan: boolean;
    readonly type: 'Members' | 'Fellowship2Dan' | 'Fellows' | 'Architects' | 'Fellowship5Dan' | 'Fellowship6Dan' | 'Masters' | 'Fellowship8Dan' | 'Fellowship9Dan' | 'RetainAt1Dan' | 'RetainAt2Dan' | 'RetainAt3Dan' | 'RetainAt4Dan' | 'RetainAt5Dan' | 'RetainAt6Dan' | 'PromoteTo1Dan' | 'PromoteTo2Dan' | 'PromoteTo3Dan' | 'PromoteTo4Dan' | 'PromoteTo5Dan' | 'PromoteTo6Dan';
  }
  ...
  interface PalletProxyCall extends Enum {
    ...
    readonly asProxy: {
      ...
      readonly forceProxyType: Option<CollectivesPolkadotRuntimeProxyType>;
      readonly call: Call;
    } & Struct;
  ...
  /** @name PalletAllianceDisbandWitness (199) */
  ...
  /** @name PalletRankedCollectiveCall (201) */
  ...
  /** @name PalletReferendaCall (202) */
  interface PalletReferendaCall extends Enum {
    readonly isSubmit: boolean;
    readonly asSubmit: {
      readonly proposalOrigin: CollectivesPolkadotRuntimeOriginCaller;
      readonly proposal: FrameSupportPreimagesBounded;
  ...
  /** @name FrameSupportScheduleDispatchTime (203) */
  ...
  /** @name PalletCoreFellowshipCall (205) */
  ...
  /** @name PalletCoreFellowshipParamsType (206) */
  ...
  /** @name PalletCoreFellowshipWish (209) */
  ...
  /** @name SpRuntimeBlakeTwo256 (213) */
  type SpRuntimeBlakeTwo256 = Null;

  /** @name PalletCoreFellowshipEvent (215) */
  ...
  /** @name FrameSystemLimitsBlockWeights (223) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (224) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (225) */
  ...
  /** @name FrameSystemLimitsBlockLength (227) */
  interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportDispatchPerDispatchClassU32;
  }

  /** @name FrameSupportDispatchPerDispatchClassU32 (228) */
  ...
  /** @name SpWeightsRuntimeDbWeight (229) */
  interface SpWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (230) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentAncestor (236) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentUsedBandwidth (237) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate (239) */
  interface CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate extends Struct {
    readonly msgCount: u32;
    readonly totalBytes: u32;
  }

  /** @name PolkadotPrimitivesV6UpgradeGoAhead (243) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentSegmentTracker (244) */
  ...
  /** @name PolkadotPrimitivesV6UpgradeRestriction (246) */
  interface PolkadotPrimitivesV6UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
    readonly type: 'Present';
  }

  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (247) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispatchQueueRemainingCapacity (248) */
  interface CumulusPalletParachainSystemRelayStateSnapshotRelayDispatchQueueRemainingCapacity extends Struct {
    readonly remainingCount: u32;
    readonly remainingSize: u32;
  }

  /** @name PolkadotPrimitivesV6AbridgedHrmpChannel (251) */
  ...
  /** @name PolkadotPrimitivesV6AbridgedHostConfiguration (252) */
  ...
  /** @name PolkadotPrimitivesV6AsyncBackingAsyncBackingParams (253) */
  interface PolkadotPrimitivesV6AsyncBackingAsyncBackingParams extends Struct {
    readonly maxCandidateDepth: u32;
    readonly allowedAncestryLen: u32;
  }

  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (259) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemCodeUpgradeAuthorization (260) */
  interface CumulusPalletParachainSystemCodeUpgradeAuthorization extends Struct {
    readonly codeHash: H256;
    readonly checkVersion: bool;
  }

  /** @name CumulusPalletParachainSystemError (261) */
  ...
  /** @name PalletBalancesBalanceLock (263) */
  ...
  /** @name PalletBalancesReasons (264) */
  ...
  /** @name PalletBalancesReserveData (267) */
  interface PalletBalancesReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name CollectivesPolkadotRuntimeRuntimeHoldReason (271) */
  interface CollectivesPolkadotRuntimeRuntimeHoldReason extends Enum {
    readonly isPreimage: boolean;
    readonly asPreimage: PalletPreimageHoldReason;
    readonly type: 'Preimage';
  }

  /** @name PalletPreimageHoldReason (272) */
  interface PalletPreimageHoldReason extends Enum {
    readonly isPreimage: boolean;
    readonly type: 'Preimage';
  }

  /** @name PalletBalancesIdAmount (275) */
  interface PalletBalancesIdAmount extends Struct {
    readonly id: Null;
    readonly amount: u128;
  }

  /** @name PalletBalancesError (277) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (281) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (283) */
  ...
  /** @name CumulusPalletXcmpQueueInboundChannelDetails (295) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (296) */
  ...
  /** @name PolkadotParachainPrimitivesPrimitivesXcmpMessageFormat (299) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (302) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (303) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (305) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (322) */
  ...
  /** @name PalletPreimageOldRequestStatus (350) */
  ...
  /** @name PalletSchedulerScheduled (362) */
  interface PalletSchedulerScheduled extends Struct {
    readonly maybeId: Option<U8aFixed>;
    readonly priority: u8;
    readonly call: FrameSupportPreimagesBounded;
    readonly maybePeriodic: Option<ITuple<[u32, u32]>>;
    readonly origin: CollectivesPolkadotRuntimeOriginCaller;
  }
  ...
  /** @name PalletAllianceMemberRole (368) */
  ...
  /** @name PalletRankedCollectiveMemberRecord (375) */
  interface PalletRankedCollectiveMemberRecord extends Struct {
    readonly rank: u16;
  }

  /** @name PalletRankedCollectiveError (380) */
  ...
  /** @name PalletReferendaReferendumInfo (381) */
  ...
  /** @name PalletReferendaReferendumStatus (382) */
  ...
  /** @name PalletCoreFellowshipMemberStatus (398) */
  ...
  /** @name PalletCoreFellowshipError (400) */
  ...
  /** @name PalletSalaryStatusType (401) */
  ...
  /** @name PalletTreasuryProposal (405) */
  ...
  /** @name PalletTreasurySpendStatus (407) */
  ...
  /** @name PalletTreasuryPaymentState (408) */
  ...
  /** @name FrameSupportPalletId (410) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletTreasuryError (411) */
  ...
  /** @name FrameSystemExtensionsCheckNonZeroSender (419) */
  ...
  /** @name CollectivesPolkadotRuntimeRuntime (427) */
  type CollectivesPolkadotRuntimeRuntime = Null;

  /** @name SpRuntimeBlock (429) */
  interface SpRuntimeBlock extends Struct {
    readonly header: SpRuntimeHeader;
    readonly extrinsics: Vec<Bytes>;
  }

  /** @name SpRuntimeHeader (430) */
  ...
  /** @name SpRuntimeTransactionValidityTransactionValidityError (436) */
  ...
  /** @name SpRuntimeTransactionValidityInvalidTransaction (437) */
  ...
  /** @name SpRuntimeTransactionValidityUnknownTransaction (438) */
  ...
  /** @name SpRuntimeTransactionValidityTransactionSource (444) */
  ...
  /** @name SpRuntimeTransactionValidityValidTransaction (446) */
  ...
  /** @name PalletTransactionPaymentRuntimeDispatchInfo (450) */
  ...
  /** @name PalletTransactionPaymentFeeDetails (451) */
  ...
  /** @name PalletTransactionPaymentInclusionFee (453) */
  ...
  /** @name CumulusPrimitivesCoreCollationInfo (454) */
  ...
  /** @name CollectivesPolkadotRuntimeRuntimeError (458) */
  interface CollectivesPolkadotRuntimeRuntimeError extends Enum {
    readonly isSystem: boolean;
    ...
    readonly isCumulusXcm: boolean;
    readonly isDmpQueue: boolean;
    readonly asDmpQueue: CumulusPalletDmpQueueError;
    ...
    readonly isFellowshipCore: boolean;
    readonly asFellowshipCore: PalletCoreFellowshipError;
    readonly isFellowshipSalary: boolean;
    readonly asFellowshipSalary: PalletSalaryError;
    readonly isFellowshipTreasury: boolean;
    readonly asFellowshipTreasury: PalletTreasuryError;
    readonly type: 'System' | 'ParachainSystem' | 'Balances' | 'CollatorSelection' | 'Session' | 'XcmpQueue' | 'PolkadotXcm' | 'CumulusXcm' | 'DmpQueue' | 'Utility' | 'Multisig' | 'Proxy' | 'Preimage' | 'Scheduler' | 'AssetRate' | 'Alliance' | 'AllianceMotion' | 'FellowshipCollective' | 'FellowshipReferenda' | 'FellowshipCore' | 'FellowshipSalary' | 'FellowshipTreasury';
  }

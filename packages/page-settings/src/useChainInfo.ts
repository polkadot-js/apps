...
function createInfo (api: ApiPromise, systemChain: string, systemName: string): ChainInfo {
  return {
    ...
    tokenDecimals: api.registry.chainDecimals ? api.registry.chainDecimals[0] : DEFAULT_DECIMALS.toNumber(),
    tokenSymbol: api.registry.chainTokens ? api.registry.chainTokens[0] : 'Unit',

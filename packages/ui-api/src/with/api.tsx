...
export default function withApi <P extends ApiProps> (Inner: React.ComponentType<P>, ApiConsumerWrapper: React.Consumer<P> = ApiConsumer, defaultProps: DefaultProps = {}): React.ComponentType<any> {

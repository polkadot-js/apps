...
function SignatureDIDs ({ onClose, onUnlock, pair }: Props): React.ReactElement<Props> | null {
    ...
    >
      <Modal.Content>
        <Modal.Columns>
          <Modal.Column>
            <InputAddress
              help={t<string>('The selected account will be used to execute the master method.')}
              isDisabled
          ...
          <Modal.Column>
            <p>{t<string>('This account will be used to execute the master method.')}</p>
          </Modal.Column>
        </Modal.Columns>

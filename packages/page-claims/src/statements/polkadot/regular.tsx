...
function RegularStatement (): React.ReactElement {
  return (
    <>
      <p className='bold_text'>Statement</p>

      <p className='bold_text'>Please read these terms and conditions carefully.</p>
      <p className='bold_text'>By submitting this statement, you are deemed to have accepted these Terms
...
“Certification” and, collectively, the “Certifications”) that:</p>
    ...
    (iii) to be consummated by it;</li>
    ...
    (y) any applicable law of the Contributor’s jurisdiction of organization;</li>
    ...
    full force and effect on and as of the date hereof;</li>
          </ul>
        </li>

        <li>the Contributor is the original purchaser of DOT allocations under the DOT
Allocation Agreement;</li>
...
address and the Polkadot address used to create the Polkadot address;</li>
        ...
        <li>the Contributor is a party to and is legally bound by the DOT Allocation
...
the Contributor;</li>
        ...
        <li>the Contributor is neither a citizen, resident nor tax resident of the United States
...
present or located in the U.S. on the date hereof;</li>

        <li>the Contributor understands that neither the DOT Allocation Agreement nor any
...
Act;</li>
        ...
        <li>the Contributor purchased DOT allocations pursuant to the DOT Allocation
...
accurate and complete on and as of the date hereof;</li>
...
Foundation and the Polkadot Network; and</li>

        <li>each of the representations and warranties made by it in or otherwise pursuant
...
(CISG) shall not apply.</li>
        ...
        <li>Any disputes arising out of or in connection with these terms and conditions
        and contracts entered into thereunder shall be submitted to the sole and
exclusive jurisdiction of the courts of the city of Zug, Switzerland.</li>
      </ul>
    </>
  );
}

export default React.memo(RegularStatement);

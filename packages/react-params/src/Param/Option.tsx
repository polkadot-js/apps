...
function Option ({ className = '', defaultValue, isDisabled, isInOption, name, onChange, onEnter, onEscape, registry, type: { sub, withOptionActive } }: Props): React.ReactElement<Props> {

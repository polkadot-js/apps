...
export default class ChartDoughnut extends React.PureComponent<Props> {
  render () {
    ...
    // when stuff are not used. This waseplaced by the HorizBar as the only Chart
    // in actual used (Referendum). However the below is not optimal, if put back
    // in use, look at getDerivedStateFromProps in HorizBar (the logic is ths same
    // for the actual chartData)

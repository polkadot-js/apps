...
const KEYS_ALLOWED: Array<any> = [KEYS.ESCAPE, KEYS.ENTER, KEYS.BACKSPACE, KEYS.DEL, KEYS.TAB, KEYS.CTRL, KEYS.CMD, KEYS.ALT, KEYS.E, KEYS.ARROW_LEFT, KEYS.ARROW_RIGHT, KEYS.DECIMAL_POINT];

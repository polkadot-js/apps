...
class SubmitCandidacy extends TxModal<Props, State> {
  headerText = () => this.props.t('Submit your collective candidacy');

  accountLabel = () => this.props.t('Candidate account');
  accountHelp = () => this.props.t('This account will be nominated to fill the collective slot you specify.');

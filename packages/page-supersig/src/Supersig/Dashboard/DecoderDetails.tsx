...
import Decoded from '../../Extrinsics/Decoded';
import { useTranslation } from '../../Extrinsics/translate';
...
function DecoderDetails ({ className, defaultValue, setLast }: Props): React.ReactElement<Props> {
...
export default React.memo(styled(DecoderDetails)`

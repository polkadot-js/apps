...
import { Input, InputAddress, InputBalance, Modal, TxButton, Button } from '@polkadot/react-components';
...
function NewSupersig ({ className = '', onClose }: Props): React.ReactElement<Props> {
...
export default React.memo(NewSupersig);

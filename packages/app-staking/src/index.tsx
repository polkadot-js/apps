...
class StakingApp extends React.PureComponent<Props, State> {
  state: State = {
    queue: []
  };
  ...
  render () {
    ...
    return (
      <div className={classes('storage--App', className)} style={style}>
        <Selection onAdd={this.onAdd} />
        <Queries onRemove={this.onRemove} value={queue} />
      </div>
    );
  }
...
export default translate(StakingApp);

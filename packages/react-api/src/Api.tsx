...
import { ethereumNetworks } from '@polkadot/apps-config';
import { POLKADOT_DENOM_BLOCK, POLKADOT_GENESIS, typesChain, typesSpec, typesBundle, typesRpc } from '@polkadot/known-types';

...
`,j=s.memo((function({autoFocus:e,bitLength:t=f,children:n,className:o="",defaultValue:p,isDecimal:A,isDisabled:v,isError:j=!1,isFull:k,isLoading:C,isSi:N,isSigned:E=!1,isWarning:S,isZeroable:I=!0,label:B,labelExtra:D,maxLength:L,maxValue:P,onChange:V,onEnter:T,onEscape:M,placeholder:F,siDecimals:z,siDefault:Z,siSymbol:R,value:$}){const{t:H}=(0,g.$)(),{api:U}=(0,i.h)(),[q]=(0,s.useState)((()=>N?Z||d.a.findSi("-"):null)),[[Q,O,W],G]=(0,s.useState)((()=>function(e,t=r.nw,n,a,s,i,o,m){return(0,u.H)(t)?function(e,t,n,a,s){const i=(0,c.o)(s)?d.a.getDefaults().decimals:s;return[t?e.div(r.aP.pow(new(l())(i+t.power))).toString():e.toString(),e,!(!a&&!n)||e.gt(r.nw)]}(t,n,s,i,m):w(e,t,n,a,s,i,o,m)}(U,$||p,q,t,E,I,P,z))),[J,K]=(0,s.useState)(!1);(0,s.useEffect)((()=>{V&&V(W?O:void 0)}),[W,V,O]);const Y=(0,s.useCallback)(((e,n)=>G(w(U,e,n,t,E,I,P,z))),[U,t,E,I,P,z]),X=(0,s.useCallback)((e=>Y(e,q)),[Y,q]);(0,s.useEffect)((()=>{p&&X(p.toString())}),[X,p]);const _=(0,s.useCallback)((e=>{if(h.nk.includes(e.key))K(!0);else if(1===e.key.length&&!J){const{selectionEnd:t,selectionStart:n,value:a}=e.target,s=`${a.substring(0,n||0)}${e.key}${a.substring(t||0)}`;x(A||!!q,E).test(s)||e.preventDefault()}}),[A,J,E,q]),ee=(0,s.useCallback)((e=>{h.nk.includes(e.key)&&K(!1)}),[]),te=(0,s.useCallback)((e=>{const{value:t}=e.target;x(A||!!q,E).test(t)||e.preventDefault()}),[A,E,q]),ne=b(t).toString().length;return(0,a.jsxs)(y,{autoFocus:e,className:`${o} ui--InputNumber ${v?"isDisabled":""}`,isDisabled:v,isError:!W||j,isFull:k,isLoading:C,isWarning:S,label:B,labelExtra:D,maxLength:L||ne,onChange:X,onEnter:T,onEscape:M,onKeyDown:_,onKeyUp:ee,onPaste:te,placeholder:F||H(E?"Valid number":"Positive number"),type:"text",value:Q,children:[q&&(0,a.jsx)("div",{className:"siUnit",children:R||m.k.abbr}),n]})}))},35220:(e,t,n)=>{n.d(t,{Z:()=>g});var a=n(52322),s=n(2784),i=n(23729),r=n.n(i),o=n(3663),l=n(25294),c=n(21779);function d(e){return{key:e,text:e,value:e}}const u=(r().get("tags")||["Default"]).sort(),m=u.map(d);function h(e){u.push(e),m.push(d(e)),function(e){r().set("tags",e.sort())}(u)}const p=(0,c.z)(l.Z)`
  && .ui.label {
    border: none;

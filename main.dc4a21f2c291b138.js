...
`,Ut=g.memo((function({className:e="",offset:n,onClose:t}){const{t:i}=R(),o=(0,c.Rf)(i),{apiEndpoint:a,isLocalFork:s}=(0,z.h)(),[d,u]=(0,g.useState)((()=>Ct())),[m,h]=(0,g.useState)((()=>St(o))),[{apiUrl:f,groupIndex:x,hasUrlChanged:v,isUrlValid:y},k]=(0,g.useState)((()=>Rt(p.X.get().apiUrl,m))),[b,w]=(0,g.useState)((()=>$t())),[C,j]=(0,g.useState)((()=>function(e){return Object.entries(l().get(Nt)||{}).filter((([n,t])=>e.some((({networks:e})=>e.some((({name:e,providers:r})=>e===n&&r.some((({url:e})=>e===t)))))))).reduce(((e,[n,t])=>({...e,[n]:t})),{})}(m))),A=(0,g.useRef)(null),S=(0,g.useMemo)((()=>{let e=!1;return o.some((n=>n.value===f&&(e=!0,!0))),e}),[f,o]),$=(0,g.useMemo)((()=>{let e=!1;return b.some((n=>n===f&&(e=!0,!0))),e}),[f,b]),Z=(0,g.useCallback)((e=>k((n=>({...n,groupIndex:e})))),[]),U=(0,g.useCallback)((e=>{(e=>{try{const n=e.chainName,t={paraId:e.paraId??-1,relay:e.relay??"Unknown"},r=Ct(),i=r[n]??[];let o;o=i.some((e=>e.relay===t.relay&&e.paraId===t.paraId))?i.filter((e=>e.relay!==t.relay||e.paraId!==t.paraId)):[...i,t];const a={...r};0===o.length?delete a[n]:a[n]=o,localStorage.setItem(wt,JSON.stringify(a))}catch{}})(e),u(Ct()),h(St((0,c.Rf)(i)))}),[i]),F=(0,g.useCallback)((()=>{if(!$)return;const e=b.filter((e=>e!==f));try{localStorage.setItem(vt.ie,JSON.stringify(e)),h(St((0,c.Rf)(i))),w($t())}catch(e){console.error(e)}}),[f,$,b,i]),T=(0,g.useCallback)(((e,n)=>{j((t=>{const r={...t,[e]:n};return l().set(Nt,r),r})),k((e=>({...Rt(n,m),groupIndex:e.groupIndex})))}),[m]),q=(0,g.useCallback)((e=>{(0,yt._)(e)||(e=xt.ZP.toASCII(e)),k((n=>({...Rt(e,m),groupIndex:n.groupIndex})))}),[m]),E=(0,g.useCallback)((()=>{l().set("localFork",""),p.X.set({...p.X.get(),apiUrl:f}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(f)}${window.location.hash}`),v||window.location.reload(),t()}),[f,t,v]),W=(0,g.useCallback)((()=>{l().set("localFork",f),p.X.set({...p.X.get(),apiUrl:f}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(f)}${window.location.hash}`),v||window.location.reload(),t()}),[f,t,v]),O=(0,g.useCallback)((()=>{try{localStorage.setItem(vt.ie,JSON.stringify([...b,f])),E()}catch(e){console.error(e)}}),[E,f,b]),M=(0,g.useMemo)((()=>function(e,n,t,r){return e?!n.startsWith("light://")&&!t:!r}(v,f,y,s)),[v,f,y,s]),P=(0,g.useMemo)((()=>function(e,n,t,r){return e?!!n.startsWith("light://")||!t:!!r}(v,f,y,s)),[v,f,y,s]);return(0,r.jsx)(Zt,{buttons:(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(I.zx,{icon:"code-fork",isDisabled:P,label:i("Fork Locally"),onClick:W,tooltip:"fork-locally-btn"}),(0,r.jsx)(I.zx,{icon:"sync",isDisabled:M,label:i("Switch"),onClick:E})]}),className:e,offset:n,onClose:t,position:"left",sidebarRef:A,children:m.map(((e,n)=>(0,r.jsx)(It,{affinities:C,apiUrl:f,favoriteChains:d,highlightColor:a?.ui.color||N.B,index:n,isSelected:x===n,setApiUrl:T,setGroup:Z,toggleFavoriteChain:U,value:e,children:e.isDevelopment&&(0,r.jsxs)("div",{className:"endpointCustomWrapper",children:[(0,r.jsx)(I.II,{className:"endpointCustom",isError:!y,isFull:!0,label:i("custom endpoint"),onChange:q,value:f}),$?(0,r.jsx)(I.zx,{className:"customButton",icon:"trash-alt",onClick:F}):(0,r.jsx)(I.zx,{className:"customButton",icon:"save",isDisabled:!y||S,onClick:O})]})},n)))})})),Ft=I.zo.div`
  box-sizing: border-box;
...
`,Tt=g.memo((function({className:e}){const{api:n,isApiReady:t}=(0,z.h)(),i=(0,at.W7)(t&&n.rpc.state.subscribeRuntimeVersion),{ipnsChain:o}=(0,d.g)(),[a,s]=(0,Z.O)(),l=!o;return(0,r.jsxs)(Ft,{className:e,children:[(0,r.jsxs)("div",{className:`apps--SideBar-logo-inner${l?" isClickable":""} highlight--color-contrast`,onClick:s,children:[(0,r.jsx)(I.Mj,{}),(0,r.jsxs)("div",{className:"info media--1000",children:[(0,r.jsx)(ht.Z,{className:"chain"}),i&&(0,r.jsxs)("div",{className:"runtimeVersion",children:[i.specName.toString(),"/",i.specVersion.toNumber()]}),(0,r.jsx)(ft.Z,{className:"bestNumber",label:"#"})]}),l&&(0,r.jsx)(I.JO,{className:"dropdown",icon:a?"caret-right":"caret-down"})]}),a&&(0,r.jsx)(Ut,{onClose:s})]})})),qt=()=>0,zt=I.zo.li`
  cursor: pointer;
  position: relative;
  white-space: nowrap;
...
`,Et=g.memo((function({className:e="",classNameText:n,isLink:t,isToplevel:i,route:{Modal:o,href:a,icon:s,name:l,text:c,useCounter:d=qt}}){const[p,u]=(0,Z.O)(),m=d();return(0,r.jsxs)(zt,{className:`${e} ui--MenuItem ${m?"withCounter":""} ${t?"isLink":""} ${i?"topLevel highlight--color-contrast":""}`,children:[(0,r.jsxs)("a",{href:o?void 0:a||`#/${l}`,onClick:o?u:void 0,rel:"noopener noreferrer",target:a?"_blank":void 0,children:[(0,r.jsx)(I.JO,{icon:s}),(0,r.jsx)("span",{className:n,children:c}),!!m&&(0,r.jsx)(I.Ct,{color:"white",info:m})]}),o&&p&&(0,r.jsx)(o,{onClose:u})]})})),Wt="rgba(34, 36, 38, 0.12)",Ot="5px",Mt=I.zo.li`
  ...
  .groupMenu {
    border-radius: 0.25rem;
    box-shadow: 0 ${Ot} ${Ot} -${Ot} ${Wt}, ${Ot} 0 ${Ot} -${Ot} ${Wt}, -${Ot} 0 ${Ot} -${Ot} ${Wt};
    display: none;
    margin: 0;
    overflow: hidden;
    padding: 0;
...
`,Pt=g.memo((function({className:e="",isActive:n,name:t,routes:i}){return 1===i.length&&"settings"===i[0].group?(0,r.jsx)(Et,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:i[0]}):(0,r.jsxs)(Mt,{className:`${e} ${n?"isActive":""}`,children:[(0,r.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,r.jsx)("span",{className:"smallHide",children:t}),(0,r.jsx)(I.JO,{className:"smallShow",icon:i[0].icon}),(0,r.jsx)(I.JO,{icon:"caret-down"})]}),(0,r.jsx)("ul",{className:"groupMenu",children:i.map((e=>(0,r.jsx)(Et,{route:e},e.name)))})]})}));var Bt=t(54194),Dt=t(39082),Ht=t(52727);const Lt=`apps v${Bt.b.version.replace("-x","")}`,Jt=I.zo.div`
...
`,Xt=g.memo((function({className:e=""}){const{api:n,isApiReady:t}=(0,z.h)();return(0,r.jsxs)(Jt,{className:`${e} media--1400 highlight--color-contrast ui--NodeInfo`,children:[t&&(0,r.jsxs)("div",{className:"node",children:[(0,r.jsx)(Dt.Z,{})," ",(0,r.jsx)(Ht.Z,{label:"v"})]}),(0,r.jsx)("div",{children:n.libraryInfo.replace("@polkadot/","")}),(0,r.jsx)("div",{children:Lt})]})}));const Vt=I.zo.div`
  width: 100%;
  padding: 0;
  z-index: 220;
  position: relative;
...
`,_t=g.memo((function({className:e=""}){const{t:n}=R(),{allAccounts:t,hasAccounts:i}=(0,ot.x)(),o=(0,z.h)(),{allowTeleport:a}=(0,gt.M)(),s=(0,at.W7)(o.isApiReady&&o.api.query.sudo?.key),l=(0,W.TH)(),c=(0,g.useRef)(function(e){return[{href:"https://github.com/polkadot-js/apps",icon:"code-branch",name:"github",text:e("nav.github","GitHub",{ns:"apps-routing"})},{href:"https://wiki.polkadot.network",icon:"book",name:"wiki",text:e("nav.wiki","Wiki",{ns:"apps-routing"})}]}(n)),d=(0,g.useRef)(Kn(n)),p=(0,g.useRef)({accounts:n("Accounts"),developer:n("Developer"),files:n("Files"),governance:n("Governance"),network:n("Network"),settings:n("Settings")}),u=(0,g.useMemo)((()=>!!s&&t.some((e=>s.eq(e)))),[t,s]),m=(0,g.useMemo)((()=>function(e,n,t,r,i,o){return Object.values(e.reduce(((e,t)=>(e[t.group]?e[t.group].routes.push(t):e[t.group]={name:n[t.group],routes:[t]},e)),{})).map((({name:e,routes:n})=>({name:e,routes:n.filter((({display:e})=>function({api:e,isApiConnected:n,isApiReady:t,isDevelopment:r},i,o,a,{isDevelopment:s,isHidden:l,needsAccounts:c,needsApi:d,needsApiCheck:p,needsApiInstances:u,needsSudo:m,needsTeleport:g}){return!(l||c&&!o||d&&(!t||!n||m&&!a||g&&!i||!r&&s||0!==rt(e,d,u,p).length))}(t,r,i,o,e)))}))).filter((({routes:e})=>e.length))}(d.current,p.current,o,a,i,u)),[a,o,i,u]),h=(0,g.useMemo)((()=>d.current.find((({name:e})=>l.pathname.startsWith(`/${e}`)))||null),[l]);return(0,r.jsx)(Vt,{className:`${e}${o.isApiReady&&o.isApiConnected?"":" isLoading"} highlight--bg`,children:(0,r.jsxs)("div",{className:"menuContainer",children:[(0,r.jsxs)("div",{className:"menuSection",children:[(0,r.jsx)(Tt,{}),(0,r.jsx)("ul",{className:"menuItems",children:m.map((({name:e,routes:n})=>(0,r.jsx)(Pt,{isActive:!!h&&h.group===e.toLowerCase(),name:e,routes:n},e)))})]}),(0,r.jsx)("div",{className:"menuSection media--1200",children:(0,r.jsx)("ul",{className:"menuItems",children:c.current.map((e=>(0,r.jsx)(Et,{isLink:!0,isToplevel:!0,route:e},e.name)))})}),(0,r.jsx)(Xt,{className:"media--1400"})]})})})),Gt=window.location.host.startsWith("polkadot.js.org"),Kt=(0,c.Rf)((()=>"")).map((e=>e.dnslink)).reduce(((e,n)=>(n&&!e.includes(n)&&e.push(n),e)),[]),Yt=g.memo((function({className:e}){const{t:n}=R(),{systemChain:t}=(0,z.h)(),i=(0,g.useMemo)((()=>{const e=t?.toLowerCase();return e&&Kt.includes(e)?`https://${e}.dotapps.io`:"https://dotapps.io"}),[t]);return Gt?(0,r.jsx)(F,{className:e,icon:"link",isBottom:!0,isDev:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("You are connected to the development instance of the UI. For a fully decentralized experience, you are encouraged to use the IPFS deployed version as the canonical URL: "),(0,r.jsx)("a",{href:i,rel:"noreferrer",target:"_blank",children:i.replace("https://","")})]})}):null})),Qt=g.memo((function({className:e}){const{t:n}=R(),{isLocalFork:t}=(0,z.h)();return t?(0,r.jsx)(F,{className:e,icon:"link",isBottom:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("Local fork powered by "),(0,r.jsx)("a",{href:"https://github.com/AcalaNetwork/chopsticks",rel:"noreferrer",target:"_blank",children:"Chopsticks"}),"."]})}):null})),er=I.zo.div`
  position: fixed;
  bottom: 0.75rem;
  right: 0.75rem;
  left: 0.75rem;
...
`,nr=g.memo((function({className:e}){return(0,r.jsxs)(er,{className:e,children:[(0,r.jsx)(Qt,{}),(0,r.jsx)(Yt,{})]})})),tr=p.X.apiType.param,rr="json-rpc"===p.X.apiType.type&&"string"==typeof tr&&tr.startsWith("ws://"),ir="string"==typeof tr&&tr.includes("127.0.0.1"),or=window.location.protocol.startsWith("https:"),ar=g.memo((function({className:e}){const{t:n}=R(),{apiError:t,isApiConnected:i,isApiReady:o,isWaitingInjected:a}=(0,z.h)();return t?(0,r.jsx)(F,{className:e,icon:"globe",type:"error",children:(0,r.jsx)("div",{children:t})}):o?a?(0,r.jsx)(F,{className:e,icon:"puzzle-piece",type:"info",children:(0,r.jsx)("div",{children:n("Waiting for authorization from the extension. Please open the installed extension and approve or reject access.")})}):i?null:(0,r.jsxs)(F,{className:e,icon:"globe",type:"error",children:[(0,r.jsx)("div",{children:n("You are not connected to a node. Ensure that your node is running and that the Websocket endpoint is reachable.")}),rr&&!ir&&or?(0,r.jsx)("div",{children:n("You are connecting from a secure location to an insecure WebSocket ({{wsUrl}}). Due to browser mixed-content security policies this connection type is not allowed. Change the RPC service to a secure 'wss' endpoint.",{replace:{wsUrl:tr}})}):void 0]}):(0,r.jsx)(F,{className:e,icon:"globe",type:"info",children:(0,r.jsx)("div",{children:n(i?"Waiting to complete metadata retrieval from remote endpoint.":"Waiting to establish a connection with the remote endpoint.")})})})),sr=g.memo((function(){const{api:e,apiIdentity:n,isApiReady:t}=(0,z.h)(),i=(0,at.W7)(t&&e.derive.accounts?.indexes),o=(0,at.W7)(t&&n.query.identity?.registrars),a=(0,at.W7)(t&&e.query.balances?.totalIssuance),[s,l]=(0,g.useState)(!1);return(0,g.useEffect)((()=>{l(!!i||!!a||!!o)}),[]),(0,r.jsx)("div",{className:`apps--api-warm ${s.toString()}`})})),lr=I.zo.div`
  background: var(--bg-page);
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
